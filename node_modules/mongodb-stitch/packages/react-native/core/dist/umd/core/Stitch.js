...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "mongodb-stitch-core-sdk", "./internal/common/RNAsyncStorage", "./internal/StitchAppClientImpl"], factory);
    }
})(function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var mongodb_stitch_core_sdk_1 = require("mongodb-stitch-core-sdk");
    var RNAsyncStorage_1 = __importDefault(require("./internal/common/RNAsyncStorage"));
    ...
    var Stitch = (function () {
        ...
        Stitch.initializeAppClient = function (clientAppId, config) {
            ...
            if (builder.storage === undefined) {
                builder.withStorage(new RNAsyncStorage_1.default(clientAppId));
            }
            ...
            if (builder.storage instanceof RNAsyncStorage_1.default) {
