...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "bson", "fetch-everywhere", "mongodb-stitch-core-admin-client", "mongodb-stitch-core-sdk"], factory);
    }
    ...
    var mongodb_stitch_core_admin_client_1 = require("mongodb-stitch-core-admin-client");
    ...
    var BaseStitchIntTestHarness = (function () {
        function BaseStitchIntTestHarness() {
            ...
            this.adminClient = new mongodb_stitch_core_admin_client_1.StitchAdminClient(this.stitchBaseUrl);
        }
        BaseStitchIntTestHarness.prototype.setup = function () {
            var _this = this;
            return fetch_everywhere_1.default(this.stitchBaseUrl)
                .then(function (result) {
                return _this.adminClient.loginWithCredential(new mongodb_stitch_core_sdk_1.UserPasswordCredential("unique_user@domain.com", "password"));
            })
        ...
        BaseStitchIntTestHarness.prototype.createApp = function (appName) {
            if (appName === void 0) { appName = "test-" + new bson_1.default.ObjectID().toHexString(); }
            ...
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2, app.authProviders.list().then(function (responses) {
                            var apiKeyProvider = responses.find(function (it) { return it.name === mongodb_stitch_core_sdk_1.UserApiKeyAuthProvider.DEFAULT_NAME; });
    ...
    exports.default = BaseStitchIntTestHarness;
});
