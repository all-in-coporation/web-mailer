...
<head>
	...
	<title>StitchUser | MongoDB Stitch Browser SDK</title>
...
<nav class="tsd-navigation secondary">
	<ul>
		<li class="current tsd-kind-interface tsd-is-external">
			<a href="stitchuser.html" class="tsd-kind-icon">Stitch<wbr>User</a>
			<ul>
				<li class=" tsd-kind-property tsd-parent-kind-interface tsd-is-overwrite tsd-is-external">
					<a href="stitchuser.html#id" class="tsd-kind-icon">id</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-interface tsd-is-overwrite tsd-is-external">
					<a href="stitchuser.html#identities" class="tsd-kind-icon">identities</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-interface tsd-is-overwrite tsd-is-external">
					<a href="stitchuser.html#loggedinprovidername" class="tsd-kind-icon">logged<wbr>InProvider<wbr>Name</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-interface tsd-is-overwrite tsd-is-external">
					<a href="stitchuser.html#loggedinprovidertype" class="tsd-kind-icon">logged<wbr>InProvider<wbr>Type</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-interface tsd-is-overwrite tsd-is-external">
					<a href="stitchuser.html#profile" class="tsd-kind-icon">profile</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-interface tsd-is-overwrite tsd-is-external">
					<a href="stitchuser.html#usertype" class="tsd-kind-icon">user<wbr>Type</a>
				</li>
				<li class=" tsd-kind-method tsd-parent-kind-interface tsd-is-external">
					<a href="stitchuser.html#linkuserwithredirect" class="tsd-kind-icon">link<wbr>User<wbr>With<wbr>Redirect</a>
				</li>
				<li class=" tsd-kind-method tsd-parent-kind-interface tsd-is-external">
					<a href="stitchuser.html#linkwithcredential" class="tsd-kind-icon">link<wbr>With<wbr>Credential</a>
				</li>
			</ul>
		</li>
	</ul>
	...
	<div class="content-wrap">
		<section class="tsd-panel tsd-comment">
			<div class="tsd-comment tsd-typography">
				<div class="lead">
					<p>A user that a <a href="stitchappclient.html">StitchAppClient</a> is currently authenticated as.
						Can be retrieved from a <a href="stitchauth.html">StitchAuth</a> or from the result of certain
					methods.</p>
				</div>
			</div>
		</section>
		<section class="tsd-panel tsd-hierarchy">
			...
			<ul class="tsd-hierarchy">
				<li>
					<span class="tsd-signature-type">CoreStitchUser</span>
					<ul class="tsd-hierarchy">
						<li>
							<span class="target">StitchUser</span>
						</li>
					</ul>
				</li>
			</ul>
				...
				<div class="tsd-index-content">
					<section class="tsd-index-section tsd-is-external">
						...
						<ul class="tsd-index-list">
							<li class="tsd-kind-property tsd-parent-kind-interface tsd-is-overwrite tsd-is-external"><a href="stitchuser.html#id" class="tsd-kind-icon">id</a></li>
							<li class="tsd-kind-property tsd-parent-kind-interface tsd-is-overwrite tsd-is-external"><a href="stitchuser.html#identities" class="tsd-kind-icon">identities</a></li>
							<li class="tsd-kind-property tsd-parent-kind-interface tsd-is-overwrite tsd-is-external"><a href="stitchuser.html#loggedinprovidername" class="tsd-kind-icon">logged<wbr>InProvider<wbr>Name</a></li>
							<li class="tsd-kind-property tsd-parent-kind-interface tsd-is-overwrite tsd-is-external"><a href="stitchuser.html#loggedinprovidertype" class="tsd-kind-icon">logged<wbr>InProvider<wbr>Type</a></li>
							<li class="tsd-kind-property tsd-parent-kind-interface tsd-is-overwrite tsd-is-external"><a href="stitchuser.html#profile" class="tsd-kind-icon">profile</a></li>
							<li class="tsd-kind-property tsd-parent-kind-interface tsd-is-overwrite tsd-is-external"><a href="stitchuser.html#usertype" class="tsd-kind-icon">user<wbr>Type</a></li>
						</ul>
					</section>
					<section class="tsd-index-section tsd-is-external">
						<h3>Methods</h3>
						<ul class="tsd-index-list">
							<li class="tsd-kind-method tsd-parent-kind-interface tsd-is-external"><a href="stitchuser.html#linkuserwithredirect" class="tsd-kind-icon">link<wbr>User<wbr>With<wbr>Redirect</a></li>
							<li class="tsd-kind-method tsd-parent-kind-interface tsd-is-external"><a href="stitchuser.html#linkwithcredential" class="tsd-kind-icon">link<wbr>With<wbr>Credential</a></li>
						</ul>
					</section>
				</div>
			</section>
		...
		<section class="tsd-panel-group tsd-member-group tsd-is-external">
			...
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface tsd-is-overwrite tsd-is-external">
				...
				<aside class="tsd-sources">
					<p>Overrides CoreStitchUser.id</p>
					<ul>
						<li>Defined in <a href="https://github.com/mongodb/stitch-js-sdk/blob/131d8fe/packages/browser/core/src/core/auth/StitchUser.ts#L34">browser/core/src/core/auth/StitchUser.ts:34</a></li>
					</ul>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>The String representation of the ID of this Stitch user.</p>
					</div>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface tsd-is-overwrite tsd-is-external">
				...
				<h3>identities</h3>
				<div class="tsd-signature tsd-kind-icon">identities<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">StitchUserIdentity</span><span class="tsd-signature-symbol">[]</span></div>
				<aside class="tsd-sources">
					<p>Overrides CoreStitchUser.identities</p>
					<ul>
						<li>Defined in <a href="https://github.com/mongodb/stitch-js-sdk/blob/131d8fe/packages/browser/core/src/core/auth/StitchUser.ts#L60">browser/core/src/core/auth/StitchUser.ts:60</a></li>
					</ul>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>An array of <a href="../classes/stitchuseridentity.html">StitchUserIdentity</a> objects representing the identities
						linked to this user which can be used to log in as this user.</p>
					</div>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface tsd-is-overwrite tsd-is-external">
				<a name="loggedinprovidername" class="tsd-anchor"></a>
				<h3>logged<wbr>InProvider<wbr>Name</h3>
				<div class="tsd-signature tsd-kind-icon">logged<wbr>InProvider<wbr>Name<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">string</span></div>
				<aside class="tsd-sources">
					<p>Overrides CoreStitchUser.loggedInProviderName</p>
					<ul>
						<li>Defined in <a href="https://github.com/mongodb/stitch-js-sdk/blob/131d8fe/packages/browser/core/src/core/auth/StitchUser.ts#L44">browser/core/src/core/auth/StitchUser.ts:44</a></li>
					</ul>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>The name of the authentication provider used to log in as this user.</p>
					</div>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface tsd-is-overwrite tsd-is-external">
				<a name="loggedinprovidertype" class="tsd-anchor"></a>
				<h3>logged<wbr>InProvider<wbr>Type</h3>
				<div class="tsd-signature tsd-kind-icon">logged<wbr>InProvider<wbr>Type<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">string</span></div>
				<aside class="tsd-sources">
					<p>Overrides CoreStitchUser.loggedInProviderType</p>
					<ul>
						<li>Defined in <a href="https://github.com/mongodb/stitch-js-sdk/blob/131d8fe/packages/browser/core/src/core/auth/StitchUser.ts#L39">browser/core/src/core/auth/StitchUser.ts:39</a></li>
					</ul>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>The type of authentication provider used to log in as this user.</p>
					</div>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface tsd-is-overwrite tsd-is-external">
				...
				<h3>profile</h3>
				<div class="tsd-signature tsd-kind-icon">profile<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">StitchUserProfile</span></div>
				<aside class="tsd-sources">
					<p>Overrides CoreStitchUser.profile</p>
					<ul>
						<li>Defined in <a href="https://github.com/mongodb/stitch-js-sdk/blob/131d8fe/packages/browser/core/src/core/auth/StitchUser.ts#L54">browser/core/src/core/auth/StitchUser.ts:54</a></li>
					</ul>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>A <a href="stitchuserprofile.html">StitchUserProfile</a> object describing this user.</p>
					</div>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface tsd-is-overwrite tsd-is-external">
				<a name="usertype" class="tsd-anchor"></a>
				<h3><span class="tsd-flag ts-flagOptional">Optional</span> user<wbr>Type</h3>
				<div class="tsd-signature tsd-kind-icon">user<wbr>Type<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">undefined</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">string</span></div>
				<aside class="tsd-sources">
					<p>Overrides CoreStitchUser.userType</p>
					<ul>
						<li>Defined in <a href="https://github.com/mongodb/stitch-js-sdk/blob/131d8fe/packages/browser/core/src/core/auth/StitchUser.ts#L49">browser/core/src/core/auth/StitchUser.ts:49</a></li>
					</ul>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>A string describing the type of this user. (Either <code>server</code> or <code>normal</code>)</p>
					</div>
				</div>
			</section>
		</section>
		<section class="tsd-panel-group tsd-member-group tsd-is-external">
			...
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-interface tsd-is-external">
				<a name="linkuserwithredirect" class="tsd-anchor"></a>
				<h3>link<wbr>User<wbr>With<wbr>Redirect</h3>
				<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-interface tsd-is-external">
					<li class="tsd-signature tsd-kind-icon">link<wbr>User<wbr>With<wbr>Redirect<span class="tsd-signature-symbol">(</span>credential<span class="tsd-signature-symbol">: </span><a href="stitchredirectcredential.html" class="tsd-signature-type">StitchRedirectCredential</a><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">Promise</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">void</span><span class="tsd-signature-symbol">&gt;</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/mongodb/stitch-js-sdk/blob/131d8fe/packages/browser/core/src/core/auth/StitchUser.ts#L72">browser/core/src/core/auth/StitchUser.ts:72</a></li>
							</ul>
						</aside>
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>Links this <a href="stitchuser.html">StitchUser</a> with a new identity, where the identity is
								...
								the redirect by calling {@link StitchAuth.handleRedirectResult()}.</p>
							</div>
						</div>
						...
						<ul class="tsd-parameters">
							<li>
								...
								<div class="tsd-comment tsd-typography">
									<p>The redirect credential to use to link this user to a new identity.</p>
								</div>
							</li>
						</ul>
			...
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-interface tsd-is-external">
				<a name="linkwithcredential" class="tsd-anchor"></a>
				<h3>link<wbr>With<wbr>Credential</h3>
				<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-interface tsd-is-external">
					<li class="tsd-signature tsd-kind-icon">link<wbr>With<wbr>Credential<span class="tsd-signature-symbol">(</span>credential<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">StitchCredential</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">Promise</span><span class="tsd-signature-symbol">&lt;</span><a href="stitchuser.html" class="tsd-signature-type">StitchUser</a><span class="tsd-signature-symbol">&gt;</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/mongodb/stitch-js-sdk/blob/131d8fe/packages/browser/core/src/core/auth/StitchUser.ts#L82">browser/core/src/core/auth/StitchUser.ts:82</a></li>
							</ul>
						</aside>
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>Links this <a href="stitchuser.html">StitchUser</a> with a new identity, where the identity is
									...
									successful if this <a href="stitchuser.html">StitchUser</a> is the currently authenticated
								<a href="stitchuser.html">StitchUser</a> for the client from which it was created.</p>
							</div>
						</div>
						<h4 class="tsd-parameters-title">Parameters</h4>
						<ul class="tsd-parameters">
							<li>
								...
								<div class="tsd-comment tsd-typography">
									<p>The credential to use to link this user to a new identity.</p>
								</div>
							</li>
						</ul>
