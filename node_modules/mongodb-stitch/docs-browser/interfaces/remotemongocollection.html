...
<head>
	...
	<title>RemoteMongoCollection | MongoDB Stitch Browser SDK</title>
...
<nav class="tsd-navigation secondary">
	<ul>
		<li class="current tsd-kind-interface tsd-has-type-parameter tsd-is-external">
			<a href="remotemongocollection.html" class="tsd-kind-icon">Remote<wbr>Mongo<wbr>Collection</a>
			<ul>
				<li class=" tsd-kind-property tsd-parent-kind-interface tsd-is-external">
					<a href="remotemongocollection.html#namespace" class="tsd-kind-icon">namespace</a>
				</li>
				<li class=" tsd-kind-method tsd-parent-kind-interface tsd-is-external">
					<a href="remotemongocollection.html#aggregate" class="tsd-kind-icon">aggregate</a>
				</li>
				<li class=" tsd-kind-method tsd-parent-kind-interface tsd-is-external">
					<a href="remotemongocollection.html#count" class="tsd-kind-icon">count</a>
				</li>
				<li class=" tsd-kind-method tsd-parent-kind-interface tsd-is-external">
					<a href="remotemongocollection.html#deletemany" class="tsd-kind-icon">delete<wbr>Many</a>
				</li>
				<li class=" tsd-kind-method tsd-parent-kind-interface tsd-is-external">
					<a href="remotemongocollection.html#deleteone" class="tsd-kind-icon">delete<wbr>One</a>
				</li>
				<li class=" tsd-kind-method tsd-parent-kind-interface tsd-is-external">
					<a href="remotemongocollection.html#find" class="tsd-kind-icon">find</a>
				</li>
				<li class=" tsd-kind-method tsd-parent-kind-interface tsd-is-external">
					<a href="remotemongocollection.html#insertmany" class="tsd-kind-icon">insert<wbr>Many</a>
				</li>
				<li class=" tsd-kind-method tsd-parent-kind-interface tsd-is-external">
					<a href="remotemongocollection.html#insertone" class="tsd-kind-icon">insert<wbr>One</a>
				</li>
				<li class=" tsd-kind-method tsd-parent-kind-interface tsd-is-external">
					<a href="remotemongocollection.html#updatemany" class="tsd-kind-icon">update<wbr>Many</a>
				</li>
				<li class=" tsd-kind-method tsd-parent-kind-interface tsd-is-external">
					<a href="remotemongocollection.html#updateone" class="tsd-kind-icon">update<wbr>One</a>
				</li>
				<li class=" tsd-kind-method tsd-parent-kind-interface tsd-is-external">
					<a href="remotemongocollection.html#watch" class="tsd-kind-icon">watch</a>
				</li>
				<li class=" tsd-kind-method tsd-parent-kind-interface tsd-has-type-parameter tsd-is-external">
					<a href="remotemongocollection.html#withcollectiontype" class="tsd-kind-icon">with<wbr>Collection<wbr>Type</a>
				</li>
			</ul>
		</li>
	</ul>
	...
	<div class="content-wrap">
		<section class="tsd-panel tsd-comment">
			<div class="tsd-comment tsd-typography">
				<div class="lead">
					<p>An interface representing a MongoDB collection accesible via the Stitch
					MongoDB service.</p>
				</div>
			</div>
		</section>
		...
		<section class="tsd-panel tsd-hierarchy">
			...
			<ul class="tsd-hierarchy">
				<li>
					<span class="target">RemoteMongoCollection</span>
				</li>
			</ul>
		</section>
				...
				<div class="tsd-index-content">
					<section class="tsd-index-section tsd-is-external">
						...
						<ul class="tsd-index-list">
							<li class="tsd-kind-property tsd-parent-kind-interface tsd-is-external"><a href="remotemongocollection.html#namespace" class="tsd-kind-icon">namespace</a></li>
						</ul>
					</section>
					<section class="tsd-index-section tsd-is-external">
						<h3>Methods</h3>
						<ul class="tsd-index-list">
							<li class="tsd-kind-method tsd-parent-kind-interface tsd-is-external"><a href="remotemongocollection.html#aggregate" class="tsd-kind-icon">aggregate</a></li>
							<li class="tsd-kind-method tsd-parent-kind-interface tsd-is-external"><a href="remotemongocollection.html#count" class="tsd-kind-icon">count</a></li>
							<li class="tsd-kind-method tsd-parent-kind-interface tsd-is-external"><a href="remotemongocollection.html#deletemany" class="tsd-kind-icon">delete<wbr>Many</a></li>
							<li class="tsd-kind-method tsd-parent-kind-interface tsd-is-external"><a href="remotemongocollection.html#deleteone" class="tsd-kind-icon">delete<wbr>One</a></li>
							<li class="tsd-kind-method tsd-parent-kind-interface tsd-is-external"><a href="remotemongocollection.html#find" class="tsd-kind-icon">find</a></li>
							<li class="tsd-kind-method tsd-parent-kind-interface tsd-is-external"><a href="remotemongocollection.html#insertmany" class="tsd-kind-icon">insert<wbr>Many</a></li>
							<li class="tsd-kind-method tsd-parent-kind-interface tsd-is-external"><a href="remotemongocollection.html#insertone" class="tsd-kind-icon">insert<wbr>One</a></li>
							<li class="tsd-kind-method tsd-parent-kind-interface tsd-is-external"><a href="remotemongocollection.html#updatemany" class="tsd-kind-icon">update<wbr>Many</a></li>
							<li class="tsd-kind-method tsd-parent-kind-interface tsd-is-external"><a href="remotemongocollection.html#updateone" class="tsd-kind-icon">update<wbr>One</a></li>
							<li class="tsd-kind-method tsd-parent-kind-interface tsd-is-external"><a href="remotemongocollection.html#watch" class="tsd-kind-icon">watch</a></li>
							<li class="tsd-kind-method tsd-parent-kind-interface tsd-has-type-parameter tsd-is-external"><a href="remotemongocollection.html#withcollectiontype" class="tsd-kind-icon">with<wbr>Collection<wbr>Type</a></li>
						</ul>
					</section>
				</div>
			</section>
		...
		<section class="tsd-panel-group tsd-member-group tsd-is-external">
			...
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface tsd-is-external">
				...
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/mongodb/stitch-js-sdk/blob/131d8fe/packages/browser/services/mongodb-remote/src/RemoteMongoCollection.ts#L40">browser/services/mongodb-remote/src/RemoteMongoCollection.ts:40</a></li>
					</ul>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>Gets the namespace of this collection.</p>
					</div>
					<dl class="tsd-comment-tags">
						<dt>returns</dt>
						<dd><p>the namespace</p>
						</dd>
					</dl>
				</div>
			</section>
		...
		<section class="tsd-panel-group tsd-member-group tsd-is-external">
			...
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-interface tsd-is-external">
				...
				<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-interface tsd-is-external">
					<li class="tsd-signature tsd-kind-icon">aggregate<span class="tsd-signature-symbol">(</span>pipeline<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">any</span><span class="tsd-signature-symbol">[]</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><a href="../classes/remotemongoreadoperation.html" class="tsd-signature-type">RemoteMongoReadOperation</a><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">DocumentT</span><span class="tsd-signature-symbol">&gt;</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/mongodb/stitch-js-sdk/blob/131d8fe/packages/browser/services/mongodb-remote/src/RemoteMongoCollection.ts#L79">browser/services/mongodb-remote/src/RemoteMongoCollection.ts:79</a></li>
							</ul>
						</aside>
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>Aggregates documents according to the specified aggregation pipeline.</p>
							</div>
						</div>
						<h4 class="tsd-parameters-title">Parameters</h4>
						<ul class="tsd-parameters">
							<li>
								<h5>pipeline: <span class="tsd-signature-type">any</span><span class="tsd-signature-symbol">[]</span></h5>
								<div class="tsd-comment tsd-typography">
									<p>the aggregation pipeline</p>
								</div>
							</li>
						</ul>
						<h4 class="tsd-returns-title">Returns <a href="../classes/remotemongoreadoperation.html" class="tsd-signature-type">RemoteMongoReadOperation</a><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">DocumentT</span><span class="tsd-signature-symbol">&gt;</span></h4>
						<p>a read operation which can be used to execute the aggregation</p>
					</li>
				</ul>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-interface tsd-is-external">
				...
				<h3>count</h3>
				<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-interface tsd-is-external">
					<li class="tsd-signature tsd-kind-icon">count<span class="tsd-signature-symbol">(</span>query<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">undefined</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">object</span>, options<span class="tsd-signature-symbol">?: </span><a href="remotecountoptions.html" class="tsd-signature-type">RemoteCountOptions</a><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">Promise</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">number</span><span class="tsd-signature-symbol">&gt;</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/mongodb/stitch-js-sdk/blob/131d8fe/packages/browser/services/mongodb-remote/src/RemoteMongoCollection.ts#L60">browser/services/mongodb-remote/src/RemoteMongoCollection.ts:60</a></li>
							</ul>
						</aside>
						<div class="tsd-comment tsd-typography">
							<div class="lead">
						...
						<ul class="tsd-parameters">
							<li>
								<h5><span class="tsd-flag ts-flagOptional">Optional</span> query: <span class="tsd-signature-type">undefined</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">object</span></h5>
								<div class="tsd-comment tsd-typography">
									<p>the query filter</p>
								</div>
							</li>
							<li>
								<h5><span class="tsd-flag ts-flagOptional">Optional</span> options: <a href="remotecountoptions.html" class="tsd-signature-type">RemoteCountOptions</a></h5>
								<div class="tsd-comment tsd-typography">
									<p>the options describing the count</p>
								</div>
							</li>
						</ul>
						...
						<p>a Promise containing the number of documents in the collection</p>
					</li>
				</ul>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-interface tsd-is-external">
				...
				<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-interface tsd-is-external">
					<li class="tsd-signature tsd-kind-icon">delete<wbr>Many<span class="tsd-signature-symbol">(</span>query<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">object</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">Promise</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">RemoteDeleteResult</span><span class="tsd-signature-symbol">&gt;</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/mongodb/stitch-js-sdk/blob/131d8fe/packages/browser/services/mongodb-remote/src/RemoteMongoCollection.ts#L115">browser/services/mongodb-remote/src/RemoteMongoCollection.ts:115</a></li>
							</ul>
						</aside>
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>Removes all documents from the collection that match the given query filter.  If no documents
								match, the collection is not modified.</p>
							</div>
						</div>
						<h4 class="tsd-parameters-title">Parameters</h4>
						<ul class="tsd-parameters">
							<li>
								...
								<div class="tsd-comment tsd-typography">
									<p>the query filter to apply the the delete operation</p>
								</div>
							</li>
						</ul>
						<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">Promise</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">RemoteDeleteResult</span><span class="tsd-signature-symbol">&gt;</span></h4>
						<p>a Promise containing the result of the remove many operation</p>
					</li>
				</ul>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-interface tsd-is-external">
				...
				<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-interface tsd-is-external">
					<li class="tsd-signature tsd-kind-icon">delete<wbr>One<span class="tsd-signature-symbol">(</span>query<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">object</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">Promise</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">RemoteDeleteResult</span><span class="tsd-signature-symbol">&gt;</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/mongodb/stitch-js-sdk/blob/131d8fe/packages/browser/services/mongodb-remote/src/RemoteMongoCollection.ts#L106">browser/services/mongodb-remote/src/RemoteMongoCollection.ts:106</a></li>
							</ul>
						</aside>
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>Removes at most one document from the collection that matches the given filter.  If no
						...
						<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">Promise</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">RemoteDeleteResult</span><span class="tsd-signature-symbol">&gt;</span></h4>
						<p>a Promise containing the result of the remove one operation</p>
					</li>
				</ul>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-interface tsd-is-external">
				...
				<h3>find</h3>
				<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-interface tsd-is-external">
					<li class="tsd-signature tsd-kind-icon">find<span class="tsd-signature-symbol">(</span>query<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">undefined</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">object</span>, options<span class="tsd-signature-symbol">?: </span><a href="remotefindoptions.html" class="tsd-signature-type">RemoteFindOptions</a><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><a href="../classes/remotemongoreadoperation.html" class="tsd-signature-type">RemoteMongoReadOperation</a><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">DocumentT</span><span class="tsd-signature-symbol">&gt;</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/mongodb/stitch-js-sdk/blob/131d8fe/packages/browser/services/mongodb-remote/src/RemoteMongoCollection.ts#L68">browser/services/mongodb-remote/src/RemoteMongoCollection.ts:68</a></li>
							</ul>
						</aside>
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>Finds all documents in the collection.</p>
							</div>
						</div>
						<h4 class="tsd-parameters-title">Parameters</h4>
						<ul class="tsd-parameters">
							...
							<li>
								<h5><span class="tsd-flag ts-flagOptional">Optional</span> options: <a href="remotefindoptions.html" class="tsd-signature-type">RemoteFindOptions</a></h5>
							</li>
						</ul>
						<h4 class="tsd-returns-title">Returns <a href="../classes/remotemongoreadoperation.html" class="tsd-signature-type">RemoteMongoReadOperation</a><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">DocumentT</span><span class="tsd-signature-symbol">&gt;</span></h4>
						<p>a read operation which can be used to execute the query</p>
					</li>
				</ul>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-interface tsd-is-external">
				...
				<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-interface tsd-is-external">
					<li class="tsd-signature tsd-kind-icon">insert<wbr>Many<span class="tsd-signature-symbol">(</span>documents<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">DocumentT</span><span class="tsd-signature-symbol">[]</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">Promise</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">RemoteInsertManyResult</span><span class="tsd-signature-symbol">&gt;</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/mongodb/stitch-js-sdk/blob/131d8fe/packages/browser/services/mongodb-remote/src/RemoteMongoCollection.ts#L96">browser/services/mongodb-remote/src/RemoteMongoCollection.ts:96</a></li>
							</ul>
						</aside>
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>Inserts one or more documents.</p>
							</div>
						</div>
						<h4 class="tsd-parameters-title">Parameters</h4>
						<ul class="tsd-parameters">
							<li>
								<h5>documents: <span class="tsd-signature-type">DocumentT</span><span class="tsd-signature-symbol">[]</span></h5>
								<div class="tsd-comment tsd-typography">
									<p>the documents to insert</p>
								</div>
							</li>
						</ul>
						<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">Promise</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">RemoteInsertManyResult</span><span class="tsd-signature-symbol">&gt;</span></h4>
						<p>a Promise containing the result of the insert many operation</p>
					</li>
				</ul>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-interface tsd-is-external">
				...
				<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-interface tsd-is-external">
					<li class="tsd-signature tsd-kind-icon">insert<wbr>One<span class="tsd-signature-symbol">(</span>document<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">DocumentT</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">Promise</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">RemoteInsertOneResult</span><span class="tsd-signature-symbol">&gt;</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/mongodb/stitch-js-sdk/blob/131d8fe/packages/browser/services/mongodb-remote/src/RemoteMongoCollection.ts#L88">browser/services/mongodb-remote/src/RemoteMongoCollection.ts:88</a></li>
							</ul>
						</aside>
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>Inserts the provided document. If the document is missing an identifier, the client should
								generate one.</p>
							</div>
						</div>
						<h4 class="tsd-parameters-title">Parameters</h4>
						<ul class="tsd-parameters">
							<li>
								<h5>document: <span class="tsd-signature-type">DocumentT</span></h5>
								<div class="tsd-comment tsd-typography">
									<p>the document to insert</p>
								</div>
							</li>
						</ul>
						<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">Promise</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">RemoteInsertOneResult</span><span class="tsd-signature-symbol">&gt;</span></h4>
						<p>a Promise containing the result of the insert one operation</p>
					</li>
				</ul>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-interface tsd-is-external">
				...
				<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-interface tsd-is-external">
					<li class="tsd-signature tsd-kind-icon">update<wbr>Many<span class="tsd-signature-symbol">(</span>query<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">object</span>, update<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">object</span>, updateOptions<span class="tsd-signature-symbol">?: </span><a href="remoteupdateoptions.html" class="tsd-signature-type">RemoteUpdateOptions</a><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">Promise</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">RemoteUpdateResult</span><span class="tsd-signature-symbol">&gt;</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/mongodb/stitch-js-sdk/blob/131d8fe/packages/browser/services/mongodb-remote/src/RemoteMongoCollection.ts#L141">browser/services/mongodb-remote/src/RemoteMongoCollection.ts:141</a></li>
							</ul>
						</aside>
						<div class="tsd-comment tsd-typography">
							<div class="lead">
						...
						<ul class="tsd-parameters">
							<li>
								<h5>query: <span class="tsd-signature-type">object</span></h5>
								<div class="tsd-comment tsd-typography">
									<p>a document describing the query filter, which may not be null.</p>
								</div>
							</li>
							<li>
								<h5>update: <span class="tsd-signature-type">object</span></h5>
								<div class="tsd-comment tsd-typography">
									<p>a document describing the update, which may not be null. The update to
									apply must include only update operators.</p>
								</div>
							</li>
							<li>
								<h5><span class="tsd-flag ts-flagOptional">Optional</span> updateOptions: <a href="remoteupdateoptions.html" class="tsd-signature-type">RemoteUpdateOptions</a></h5>
								<div class="tsd-comment tsd-typography">
									<p>the options to apply to the update operation</p>
								</div>
							</li>
						</ul>
						<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">Promise</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">RemoteUpdateResult</span><span class="tsd-signature-symbol">&gt;</span></h4>
						<p>a Promise containing the result of the update many operation</p>
					</li>
				</ul>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-interface tsd-is-external">
				...
				<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-interface tsd-is-external">
					<li class="tsd-signature tsd-kind-icon">update<wbr>One<span class="tsd-signature-symbol">(</span>query<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">object</span>, update<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">object</span>, updateOptions<span class="tsd-signature-symbol">?: </span><a href="remoteupdateoptions.html" class="tsd-signature-type">RemoteUpdateOptions</a><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">Promise</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">RemoteUpdateResult</span><span class="tsd-signature-symbol">&gt;</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/mongodb/stitch-js-sdk/blob/131d8fe/packages/browser/services/mongodb-remote/src/RemoteMongoCollection.ts#L126">browser/services/mongodb-remote/src/RemoteMongoCollection.ts:126</a></li>
							</ul>
						</aside>
						<div class="tsd-comment tsd-typography">
							<div class="lead">
						...
						<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">Promise</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">RemoteUpdateResult</span><span class="tsd-signature-symbol">&gt;</span></h4>
						<p>a Promise containing the result of the update one operation</p>
					</li>
				</ul>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-interface tsd-is-external">
				...
				<h3>watch</h3>
				<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-interface tsd-is-external">
					<li class="tsd-signature tsd-kind-icon">watch<span class="tsd-signature-symbol">(</span>ids<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">Array</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">any</span><span class="tsd-signature-symbol">&gt;</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">Promise</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">Stream</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">ChangeEvent</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">DocumentT</span><span class="tsd-signature-symbol">&gt;</span><span class="tsd-signature-symbol">&gt;</span><span class="tsd-signature-symbol">&gt;</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/mongodb/stitch-js-sdk/blob/131d8fe/packages/browser/services/mongodb-remote/src/RemoteMongoCollection.ts#L147">browser/services/mongodb-remote/src/RemoteMongoCollection.ts:147</a></li>
							</ul>
						</aside>
						<h4 class="tsd-parameters-title">Parameters</h4>
						<ul class="tsd-parameters">
							<li>
								<h5>ids: <span class="tsd-signature-type">Array</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">any</span><span class="tsd-signature-symbol">&gt;</span></h5>
							</li>
						</ul>
						<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">Promise</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">Stream</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">ChangeEvent</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">DocumentT</span><span class="tsd-signature-symbol">&gt;</span><span class="tsd-signature-symbol">&gt;</span><span class="tsd-signature-symbol">&gt;</span></h4>
					</li>
				</ul>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-interface tsd-has-type-parameter tsd-is-external">
				<a name="withcollectiontype" class="tsd-anchor"></a>
				<h3>with<wbr>Collection<wbr>Type</h3>
				<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-interface tsd-has-type-parameter tsd-is-external">
					<li class="tsd-signature tsd-kind-icon">with<wbr>Collection<wbr>Type&lt;U&gt;<span class="tsd-signature-symbol">(</span>codec<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">Codec</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">U</span><span class="tsd-signature-symbol">&gt;</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><a href="remotemongocollection.html" class="tsd-signature-type">RemoteMongoCollection</a><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">U</span><span class="tsd-signature-symbol">&gt;</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/mongodb/stitch-js-sdk/blob/131d8fe/packages/browser/services/mongodb-remote/src/RemoteMongoCollection.ts#L51">browser/services/mongodb-remote/src/RemoteMongoCollection.ts:51</a></li>
							</ul>
						</aside>
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>Create a new emoteMongoCollection instance with a different default class to cast any
								documents returned from the database into.</p>
							</div>
						</div>
						...
						<ul class="tsd-parameters">
							<li>
								<h5>codec: <span class="tsd-signature-type">Codec</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">U</span><span class="tsd-signature-symbol">&gt;</span></h5>
								<div class="tsd-comment tsd-typography">
									<p>the default class to cast any documents returned from the database into.</p>
								</div>
							</li>
						</ul>
						<h4 class="tsd-returns-title">Returns <a href="remotemongocollection.html" class="tsd-signature-type">RemoteMongoCollection</a><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">U</span><span class="tsd-signature-symbol">&gt;</span></h4>
						<p>a new CoreRemoteMongoCollection instance with the different default class</p>
					</li>
				</ul>
			</section>
		</section>
