...
<head>
	...
	<title>StitchAuth | MongoDB Stitch Browser SDK</title>
...
<nav class="tsd-navigation secondary">
	<ul>
		<li class="current tsd-kind-interface tsd-is-external">
			<a href="stitchauth.html" class="tsd-kind-icon">Stitch<wbr>Auth</a>
			<ul>
				<li class=" tsd-kind-property tsd-parent-kind-interface tsd-is-external">
					<a href="stitchauth.html#isloggedin" class="tsd-kind-icon">is<wbr>Logged<wbr>In</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-interface tsd-is-external">
					<a href="stitchauth.html#user" class="tsd-kind-icon">user</a>
				</li>
				<li class=" tsd-kind-method tsd-parent-kind-interface tsd-is-external">
					<a href="stitchauth.html#addauthlistener" class="tsd-kind-icon">add<wbr>Auth<wbr>Listener</a>
				</li>
				<li class=" tsd-kind-method tsd-parent-kind-interface tsd-has-type-parameter tsd-is-external">
					<a href="stitchauth.html#getproviderclient" class="tsd-kind-icon">get<wbr>Provider<wbr>Client</a>
				</li>
				<li class=" tsd-kind-method tsd-parent-kind-interface tsd-is-external">
					<a href="stitchauth.html#handleredirectresult" class="tsd-kind-icon">handle<wbr>Redirect<wbr>Result</a>
				</li>
				<li class=" tsd-kind-method tsd-parent-kind-interface tsd-is-external">
					<a href="stitchauth.html#hasredirectresult" class="tsd-kind-icon">has<wbr>Redirect<wbr>Result</a>
				</li>
				<li class=" tsd-kind-method tsd-parent-kind-interface tsd-is-external">
					<a href="stitchauth.html#loginwithcredential" class="tsd-kind-icon">login<wbr>With<wbr>Credential</a>
				</li>
				<li class=" tsd-kind-method tsd-parent-kind-interface tsd-is-external">
					<a href="stitchauth.html#loginwithredirect" class="tsd-kind-icon">login<wbr>With<wbr>Redirect</a>
				</li>
				<li class=" tsd-kind-method tsd-parent-kind-interface tsd-is-external">
					<a href="stitchauth.html#logout" class="tsd-kind-icon">logout</a>
				</li>
				<li class=" tsd-kind-method tsd-parent-kind-interface tsd-is-external">
					<a href="stitchauth.html#removeauthlistener" class="tsd-kind-icon">remove<wbr>Auth<wbr>Listener</a>
				</li>
			</ul>
		</li>
	</ul>
	...
	<div class="content-wrap">
		<section class="tsd-panel tsd-comment">
			<div class="tsd-comment tsd-typography">
				<div class="lead">
					<p>A set of methods for retrieving or modifying the authentication state of a
						<a href="stitchappclient.html">StitchAppClient</a>. An implementation can be instantiated with a
					<a href="stitchappclient.html">StitchAppClient</a> instance.</p>
				</div>
			</div>
		</section>
		<section class="tsd-panel tsd-hierarchy">
			...
			<ul class="tsd-hierarchy">
				<li>
					<span class="target">StitchAuth</span>
				</li>
			</ul>
		</section>
				...
				<div class="tsd-index-content">
					<section class="tsd-index-section tsd-is-external">
						...
						<ul class="tsd-index-list">
							<li class="tsd-kind-property tsd-parent-kind-interface tsd-is-external"><a href="stitchauth.html#isloggedin" class="tsd-kind-icon">is<wbr>Logged<wbr>In</a></li>
							<li class="tsd-kind-property tsd-parent-kind-interface tsd-is-external"><a href="stitchauth.html#user" class="tsd-kind-icon">user</a></li>
						</ul>
					</section>
					<section class="tsd-index-section tsd-is-external">
						<h3>Methods</h3>
						<ul class="tsd-index-list">
							<li class="tsd-kind-method tsd-parent-kind-interface tsd-is-external"><a href="stitchauth.html#addauthlistener" class="tsd-kind-icon">add<wbr>Auth<wbr>Listener</a></li>
							<li class="tsd-kind-method tsd-parent-kind-interface tsd-has-type-parameter tsd-is-external"><a href="stitchauth.html#getproviderclient" class="tsd-kind-icon">get<wbr>Provider<wbr>Client</a></li>
							<li class="tsd-kind-method tsd-parent-kind-interface tsd-is-external"><a href="stitchauth.html#handleredirectresult" class="tsd-kind-icon">handle<wbr>Redirect<wbr>Result</a></li>
							<li class="tsd-kind-method tsd-parent-kind-interface tsd-is-external"><a href="stitchauth.html#hasredirectresult" class="tsd-kind-icon">has<wbr>Redirect<wbr>Result</a></li>
							<li class="tsd-kind-method tsd-parent-kind-interface tsd-is-external"><a href="stitchauth.html#loginwithcredential" class="tsd-kind-icon">login<wbr>With<wbr>Credential</a></li>
							<li class="tsd-kind-method tsd-parent-kind-interface tsd-is-external"><a href="stitchauth.html#loginwithredirect" class="tsd-kind-icon">login<wbr>With<wbr>Redirect</a></li>
							<li class="tsd-kind-method tsd-parent-kind-interface tsd-is-external"><a href="stitchauth.html#logout" class="tsd-kind-icon">logout</a></li>
							<li class="tsd-kind-method tsd-parent-kind-interface tsd-is-external"><a href="stitchauth.html#removeauthlistener" class="tsd-kind-icon">remove<wbr>Auth<wbr>Listener</a></li>
						</ul>
					</section>
				</div>
			</section>
		...
		<section class="tsd-panel-group tsd-member-group tsd-is-external">
			...
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface tsd-is-external">
				...
				<div class="tsd-signature tsd-kind-icon">is<wbr>Logged<wbr>In<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">boolean</span></div>
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/mongodb/stitch-js-sdk/blob/131d8fe/packages/browser/core/src/core/auth/StitchAuth.ts#L34">browser/core/src/core/auth/StitchAuth.ts:34</a></li>
					</ul>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>Whether or not the client containing this <code>StitchAuth</code> object is currently
						authenticated.</p>
					</div>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface tsd-is-external">
				...
				<div class="tsd-signature tsd-kind-icon">user<span class="tsd-signature-symbol">:</span> <a href="stitchuser.html" class="tsd-signature-type">StitchUser</a></div>
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/mongodb/stitch-js-sdk/blob/131d8fe/packages/browser/core/src/core/auth/StitchAuth.ts#L41">browser/core/src/core/auth/StitchAuth.ts:41</a></li>
					</ul>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>A <a href="stitchuser.html">StitchUser</a> object representing the user that the client is
							currently authenticated as. <code>undefined</code> if the client is not currently
						authenticated.</p>
					</div>
				</div>
			</section>
		...
		<section class="tsd-panel-group tsd-member-group tsd-is-external">
			...
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-interface tsd-is-external">
				<a name="addauthlistener" class="tsd-anchor"></a>
				<h3>add<wbr>Auth<wbr>Listener</h3>
				<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-interface tsd-is-external">
					<li class="tsd-signature tsd-kind-icon">add<wbr>Auth<wbr>Listener<span class="tsd-signature-symbol">(</span>listener<span class="tsd-signature-symbol">: </span><a href="stitchauthlistener.html" class="tsd-signature-type">StitchAuthListener</a><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">any</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/mongodb/stitch-js-sdk/blob/131d8fe/packages/browser/core/src/core/auth/StitchAuth.ts#L109">browser/core/src/core/auth/StitchAuth.ts:109</a></li>
							</ul>
						</aside>
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>Registers a <a href="stitchauthlistener.html">StitchAuthListener</a> with the client.</p>
							</div>
						</div>
						<h4 class="tsd-parameters-title">Parameters</h4>
						<ul class="tsd-parameters">
							<li>
								<h5>listener: <a href="stitchauthlistener.html" class="tsd-signature-type">StitchAuthListener</a></h5>
								<div class="tsd-comment tsd-typography">
									<p>The listener to be triggered when an authentication event
									occurs on this auth object.</p>
								</div>
							</li>
						</ul>
			...
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-interface tsd-has-type-parameter tsd-is-external">
				<a name="getproviderclient" class="tsd-anchor"></a>
				<h3>get<wbr>Provider<wbr>Client</h3>
				<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-interface tsd-has-type-parameter tsd-is-external">
					<li class="tsd-signature tsd-kind-icon">get<wbr>Provider<wbr>Client&lt;ClientT&gt;<span class="tsd-signature-symbol">(</span>factory<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">AuthProviderClientFactory</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">ClientT</span><span class="tsd-signature-symbol">&gt;</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">ClientT</span></li>
					<li class="tsd-signature tsd-kind-icon">get<wbr>Provider<wbr>Client&lt;T&gt;<span class="tsd-signature-symbol">(</span>factory<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">NamedAuthProviderClientFactory</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">T</span><span class="tsd-signature-symbol">&gt;</span>, providerName<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">T</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/mongodb/stitch-js-sdk/blob/131d8fe/packages/browser/core/src/core/auth/StitchAuth.ts#L49">browser/core/src/core/auth/StitchAuth.ts:49</a></li>
							</ul>
						</aside>
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>Retrieves the authentication provider client for the authentication
								provider associated with the specified factory.</p>
							</div>
						</div>
						...
						<ul class="tsd-parameters">
							<li>
								<h5>factory: <span class="tsd-signature-type">AuthProviderClientFactory</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">ClientT</span><span class="tsd-signature-symbol">&gt;</span></h5>
								<div class="tsd-comment tsd-typography">
									<p>The factory that produces the desired client.</p>
								</div>
							</li>
						</ul>
						<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">ClientT</span></h4>
					</li>
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/mongodb/stitch-js-sdk/blob/131d8fe/packages/browser/core/src/core/auth/StitchAuth.ts#L59">browser/core/src/core/auth/StitchAuth.ts:59</a></li>
							</ul>
						</aside>
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>Retrieves the authentication provider client for the authentication
								provider associated with the specified factory and auth provider name.</p>
							</div>
						</div>
						<h4 class="tsd-type-parameters-title">Type parameters</h4>
						<ul class="tsd-type-parameters">
						...
						<ul class="tsd-parameters">
							<li>
								<h5>factory: <span class="tsd-signature-type">NamedAuthProviderClientFactory</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">T</span><span class="tsd-signature-symbol">&gt;</span></h5>
								<div class="tsd-comment tsd-typography">
									<p>The factory that produces the desired client.</p>
								</div>
							</li>
			...
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-interface tsd-is-external">
				<a name="handleredirectresult" class="tsd-anchor"></a>
				<h3>handle<wbr>Redirect<wbr>Result</h3>
				<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-interface tsd-is-external">
					<li class="tsd-signature tsd-kind-icon">handle<wbr>Redirect<wbr>Result<span class="tsd-signature-symbol">(</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">Promise</span><span class="tsd-signature-symbol">&lt;</span><a href="stitchuser.html" class="tsd-signature-type">StitchUser</a><span class="tsd-signature-symbol">&gt;</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/mongodb/stitch-js-sdk/blob/131d8fe/packages/browser/core/src/core/auth/StitchAuth.ts#L96">browser/core/src/core/auth/StitchAuth.ts:96</a></li>
							</ul>
						</aside>
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>Handles a redirect by completing the login response and authenticating the
									client. Should be called by the redirect handling page that
								{@link loginWithRedirect()} redirects to.</p>
							</div>
						</div>
						<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">Promise</span><span class="tsd-signature-symbol">&lt;</span><a href="stitchuser.html" class="tsd-signature-type">StitchUser</a><span class="tsd-signature-symbol">&gt;</span></h4>
					</li>
				</ul>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-interface tsd-is-external">
				<a name="hasredirectresult" class="tsd-anchor"></a>
				<h3>has<wbr>Redirect<wbr>Result</h3>
				<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-interface tsd-is-external">
					<li class="tsd-signature tsd-kind-icon">has<wbr>Redirect<wbr>Result<span class="tsd-signature-symbol">(</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">boolean</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/mongodb/stitch-js-sdk/blob/131d8fe/packages/browser/core/src/core/auth/StitchAuth.ts#L89">browser/core/src/core/auth/StitchAuth.ts:89</a></li>
							</ul>
						</aside>
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>Checks whether or not the page was just redirected to from a login process
									initiated by {@link loginWithRedirect()}. Call this method before calling
								<a href="stitchauth.html#handleredirectresult">handleRedirectResult</a> if you want to avoid errors.</p>
							</div>
						</div>
			...
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-interface tsd-is-external">
				<a name="loginwithcredential" class="tsd-anchor"></a>
				<h3>login<wbr>With<wbr>Credential</h3>
				<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-interface tsd-is-external">
					<li class="tsd-signature tsd-kind-icon">login<wbr>With<wbr>Credential<span class="tsd-signature-symbol">(</span>credential<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">StitchCredential</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">Promise</span><span class="tsd-signature-symbol">&lt;</span><a href="stitchuser.html" class="tsd-signature-type">StitchUser</a><span class="tsd-signature-symbol">&gt;</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/mongodb/stitch-js-sdk/blob/131d8fe/packages/browser/core/src/core/auth/StitchAuth.ts#L70">browser/core/src/core/auth/StitchAuth.ts:70</a></li>
							</ul>
						</aside>
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>Authenticates the client as a MongoDB Stitch user using the provided
								<a href="stitchcredential.html">StitchCredential</a>.</p>
							</div>
						</div>
						<h4 class="tsd-parameters-title">Parameters</h4>
						<ul class="tsd-parameters">
							<li>
								<h5>credential: <span class="tsd-signature-type">StitchCredential</span></h5>
								<div class="tsd-comment tsd-typography">
									<p>The credential to use when logging in.</p>
								</div>
							</li>
						</ul>
						<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">Promise</span><span class="tsd-signature-symbol">&lt;</span><a href="stitchuser.html" class="tsd-signature-type">StitchUser</a><span class="tsd-signature-symbol">&gt;</span></h4>
			...
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-interface tsd-is-external">
				...
				<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-interface tsd-is-external">
					<li class="tsd-signature tsd-kind-icon">login<wbr>With<wbr>Redirect<span class="tsd-signature-symbol">(</span>credential<span class="tsd-signature-symbol">: </span><a href="stitchredirectcredential.html" class="tsd-signature-type">StitchRedirectCredential</a><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">void</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/mongodb/stitch-js-sdk/blob/131d8fe/packages/browser/core/src/core/auth/StitchAuth.ts#L82">browser/core/src/core/auth/StitchAuth.ts:82</a></li>
							</ul>
						</aside>
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>Authenticates the client as a MongoDB Stitch user using the provided
									<a href="stitchredirectcredential.html">StitchRedirectCredential</a>. This method will redirect the user to
								...
								redirect by calling {@link handleRedirectResult()}.</p>
							</div>
						</div>
						<h4 class="tsd-parameters-title">Parameters</h4>
						<ul class="tsd-parameters">
							<li>
								<h5>credential: <a href="stitchredirectcredential.html" class="tsd-signature-type">StitchRedirectCredential</a></h5>
								<div class="tsd-comment tsd-typography">
									<p>The credential to use when logging in.</p>
								</div>
							</li>
			...
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-interface tsd-is-external">
				...
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/mongodb/stitch-js-sdk/blob/131d8fe/packages/browser/core/src/core/auth/StitchAuth.ts#L102">browser/core/src/core/auth/StitchAuth.ts:102</a></li>
							</ul>
						</aside>
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>Logs out the currently authenticated user, and clears any persisted
			...
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-interface tsd-is-external">
				<a name="removeauthlistener" class="tsd-anchor"></a>
				<h3>remove<wbr>Auth<wbr>Listener</h3>
				<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-interface tsd-is-external">
					<li class="tsd-signature tsd-kind-icon">remove<wbr>Auth<wbr>Listener<span class="tsd-signature-symbol">(</span>listener<span class="tsd-signature-symbol">: </span><a href="stitchauthlistener.html" class="tsd-signature-type">StitchAuthListener</a><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">any</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/mongodb/stitch-js-sdk/blob/131d8fe/packages/browser/core/src/core/auth/StitchAuth.ts#L115">browser/core/src/core/auth/StitchAuth.ts:115</a></li>
							</ul>
						</aside>
						<div class="tsd-comment tsd-typography">
							<div class="lead">
