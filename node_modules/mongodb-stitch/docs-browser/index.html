...
<head>
	...
	<title>MongoDB Stitch Browser SDK | MongoDB Stitch Browser SDK</title>
...
<nav class="tsd-navigation secondary">
	<ul>
		...
		<li class=" tsd-kind-enum tsd-is-external">
			<a href="enums/stitchclienterrorcode.html" class="tsd-kind-icon">Stitch<wbr>Client<wbr>Error<wbr>Code</a>
		</li>
		<li class=" tsd-kind-enum tsd-is-external">
			<a href="enums/stitchrequesterrorcode.html" class="tsd-kind-icon">Stitch<wbr>Request<wbr>Error<wbr>Code</a>
		</li>
		<li class=" tsd-kind-enum tsd-is-external">
			<a href="enums/stitchserviceerrorcode.html" class="tsd-kind-icon">Stitch<wbr>Service<wbr>Error<wbr>Code</a>
		</li>
		<li class=" tsd-kind-class tsd-is-external">
			<a href="classes/anonymouscredential.html" class="tsd-kind-icon">Anonymous<wbr>Credential</a>
		</li>
		<li class=" tsd-kind-class tsd-is-external">
			<a href="classes/awsrequest.html" class="tsd-kind-icon">Aws<wbr>Request</a>
		</li>
		<li class=" tsd-kind-class tsd-is-external">
			<a href="classes/awss3putobjectresult.html" class="tsd-kind-icon">Aws<wbr>S3Put<wbr>Object<wbr>Result</a>
		</li>
		<li class=" tsd-kind-class tsd-is-external">
			<a href="classes/awss3signpolicyresult.html" class="tsd-kind-icon">Aws<wbr>S3Sign<wbr>Policy<wbr>Result</a>
		</li>
		<li class=" tsd-kind-class tsd-is-external">
			<a href="classes/awsserviceclientimpl.html" class="tsd-kind-icon">Aws<wbr>Service<wbr>Client<wbr>Impl</a>
		</li>
		<li class=" tsd-kind-class tsd-is-external">
			<a href="classes/awssessendresult.html" class="tsd-kind-icon">Aws<wbr>Ses<wbr>Send<wbr>Result</a>
		</li>
		<li class=" tsd-kind-class tsd-is-external">
			<a href="classes/coreawsserviceclient.html" class="tsd-kind-icon">Core<wbr>Aws<wbr>Service<wbr>Client</a>
		</li>
		<li class=" tsd-kind-class tsd-is-external">
			<a href="classes/customcredential.html" class="tsd-kind-icon">Custom<wbr>Credential</a>
		</li>
		<li class=" tsd-kind-class tsd-is-external">
			<a href="classes/eventsourceeventstream.html" class="tsd-kind-icon">Event<wbr>Source<wbr>Event<wbr>Stream</a>
		</li>
		<li class=" tsd-kind-class tsd-is-external">
			<a href="classes/facebookcredential.html" class="tsd-kind-icon">Facebook<wbr>Credential</a>
		</li>
		<li class=" tsd-kind-class tsd-is-external">
			<a href="classes/facebookredirectcredential.html" class="tsd-kind-icon">Facebook<wbr>Redirect<wbr>Credential</a>
		</li>
		<li class=" tsd-kind-class tsd-is-external">
			<a href="classes/googlecredential.html" class="tsd-kind-icon">Google<wbr>Credential</a>
		</li>
		<li class=" tsd-kind-class tsd-is-external">
			<a href="classes/googleredirectcredential.html" class="tsd-kind-icon">Google<wbr>Redirect<wbr>Credential</a>
		</li>
		<li class=" tsd-kind-class tsd-is-external">
			<a href="classes/httpcookie.html" class="tsd-kind-icon">Http<wbr>Cookie</a>
		</li>
		<li class=" tsd-kind-class tsd-is-external">
			<a href="classes/httprequest.html" class="tsd-kind-icon">Http<wbr>Request</a>
		</li>
		<li class=" tsd-kind-class tsd-is-external">
			<a href="classes/httpresponse.html" class="tsd-kind-icon">Http<wbr>Response</a>
		</li>
		<li class=" tsd-kind-class tsd-is-external">
			<a href="classes/providercapabilities.html" class="tsd-kind-icon">Provider<wbr>Capabilities</a>
		</li>
		<li class=" tsd-kind-class tsd-is-external">
			<a href="classes/remoteinsertmanyresult.html" class="tsd-kind-icon">Remote<wbr>Insert<wbr>Many<wbr>Result</a>
		</li>
		<li class=" tsd-kind-class tsd-has-type-parameter tsd-is-external">
			<a href="classes/remotemongocursor.html" class="tsd-kind-icon">Remote<wbr>Mongo<wbr>Cursor</a>
		</li>
		<li class=" tsd-kind-class tsd-has-type-parameter tsd-is-external">
			<a href="classes/remotemongoreadoperation.html" class="tsd-kind-icon">Remote<wbr>Mongo<wbr>Read<wbr>Operation</a>
		</li>
		<li class=" tsd-kind-class tsd-is-external">
			<a href="classes/serverapikeycredential.html" class="tsd-kind-icon">Server<wbr>Api<wbr>Key<wbr>Credential</a>
		</li>
		<li class=" tsd-kind-class tsd-is-external">
			<a href="classes/stitch.html" class="tsd-kind-icon">Stitch</a>
		</li>
		<li class=" tsd-kind-class tsd-is-external">
			<a href="classes/stitchappclientconfiguration.html" class="tsd-kind-icon">Stitch<wbr>App<wbr>Client<wbr>Configuration</a>
		</li>
		<li class=" tsd-kind-class tsd-is-external">
			<a href="classes/stitchauthresponsecredential.html" class="tsd-kind-icon">Stitch<wbr>Auth<wbr>Response<wbr>Credential</a>
		</li>
		<li class=" tsd-kind-class tsd-is-external">
			<a href="classes/stitchbrowserappauthroutes.html" class="tsd-kind-icon">Stitch<wbr>Browser<wbr>App<wbr>Auth<wbr>Routes</a>
		</li>
		<li class=" tsd-kind-class tsd-is-external">
			<a href="classes/stitchbrowserapproutes.html" class="tsd-kind-icon">Stitch<wbr>Browser<wbr>App<wbr>Routes</a>
		</li>
		<li class=" tsd-kind-class tsd-is-external">
			<a href="classes/stitchclienterror.html" class="tsd-kind-icon">Stitch<wbr>Client<wbr>Error</a>
		</li>
		<li class=" tsd-kind-class tsd-is-external">
			<a href="classes/stitcherror.html" class="tsd-kind-icon">Stitch<wbr>Error</a>
		</li>
		<li class=" tsd-kind-class tsd-is-external">
			<a href="classes/stitchredirecterror.html" class="tsd-kind-icon">Stitch<wbr>Redirect<wbr>Error</a>
		</li>
		<li class=" tsd-kind-class tsd-is-external">
			<a href="classes/stitchrequesterror.html" class="tsd-kind-icon">Stitch<wbr>Request<wbr>Error</a>
		</li>
		<li class=" tsd-kind-class tsd-is-external">
			<a href="classes/stitchserviceerror.html" class="tsd-kind-icon">Stitch<wbr>Service<wbr>Error</a>
		</li>
		<li class=" tsd-kind-class tsd-is-external">
			<a href="classes/stitchuseridentity.html" class="tsd-kind-icon">Stitch<wbr>User<wbr>Identity</a>
		</li>
		<li class=" tsd-kind-class tsd-is-external">
			<a href="classes/userapikey.html" class="tsd-kind-icon">User<wbr>Api<wbr>Key</a>
		</li>
		<li class=" tsd-kind-class tsd-is-external">
			<a href="classes/userapikeycredential.html" class="tsd-kind-icon">User<wbr>Api<wbr>Key<wbr>Credential</a>
		</li>
		<li class=" tsd-kind-class tsd-is-external">
			<a href="classes/userpasswordcredential.html" class="tsd-kind-icon">User<wbr>Password<wbr>Credential</a>
		</li>
		...
		<li class=" tsd-kind-interface tsd-is-external">
			<a href="interfaces/mongonamespace.html" class="tsd-kind-icon">Mongo<wbr>Namespace</a>
		</li>
		<li class=" tsd-kind-interface tsd-has-type-parameter tsd-is-external">
			<a href="interfaces/namedserviceclientfactory.html" class="tsd-kind-icon">Named<wbr>Service<wbr>Client<wbr>Factory</a>
		</li>
		<li class=" tsd-kind-interface tsd-is-external">
			<a href="interfaces/remotecountoptions.html" class="tsd-kind-icon">Remote<wbr>Count<wbr>Options</a>
		</li>
		<li class=" tsd-kind-interface tsd-is-external">
			<a href="interfaces/remotedeleteresult.html" class="tsd-kind-icon">Remote<wbr>Delete<wbr>Result</a>
		</li>
		<li class=" tsd-kind-interface tsd-is-external">
			<a href="interfaces/remotefindoptions.html" class="tsd-kind-icon">Remote<wbr>Find<wbr>Options</a>
		</li>
		<li class=" tsd-kind-interface tsd-is-external">
			<a href="interfaces/remoteinsertoneresult.html" class="tsd-kind-icon">Remote<wbr>Insert<wbr>One<wbr>Result</a>
		</li>
		<li class=" tsd-kind-interface tsd-has-type-parameter tsd-is-external">
			<a href="interfaces/remotemongocollection.html" class="tsd-kind-icon">Remote<wbr>Mongo<wbr>Collection</a>
		</li>
		<li class=" tsd-kind-interface tsd-is-external">
			<a href="interfaces/remotemongodatabase.html" class="tsd-kind-icon">Remote<wbr>Mongo<wbr>Database</a>
		</li>
		<li class=" tsd-kind-interface tsd-is-external">
			<a href="interfaces/remoteupdateoptions.html" class="tsd-kind-icon">Remote<wbr>Update<wbr>Options</a>
		</li>
		<li class=" tsd-kind-interface tsd-is-external">
			<a href="interfaces/remoteupdateresult.html" class="tsd-kind-icon">Remote<wbr>Update<wbr>Result</a>
		</li>
		<li class=" tsd-kind-interface tsd-has-type-parameter tsd-is-external">
			<a href="interfaces/serviceclientfactory.html" class="tsd-kind-icon">Service<wbr>Client<wbr>Factory</a>
		</li>
		<li class=" tsd-kind-interface tsd-is-external">
			<a href="interfaces/stitchappclient.html" class="tsd-kind-icon">Stitch<wbr>App<wbr>Client</a>
		</li>
		<li class=" tsd-kind-interface tsd-is-external">
			<a href="interfaces/stitchauth.html" class="tsd-kind-icon">Stitch<wbr>Auth</a>
		</li>
		<li class=" tsd-kind-interface tsd-is-external">
			<a href="interfaces/stitchauthlistener.html" class="tsd-kind-icon">Stitch<wbr>Auth<wbr>Listener</a>
		</li>
		<li class=" tsd-kind-interface tsd-is-external">
			<a href="interfaces/stitchcredential.html" class="tsd-kind-icon">Stitch<wbr>Credential</a>
		</li>
		<li class=" tsd-kind-interface tsd-is-external">
			<a href="interfaces/stitchredirectcredential.html" class="tsd-kind-icon">Stitch<wbr>Redirect<wbr>Credential</a>
		</li>
		<li class=" tsd-kind-interface tsd-is-external">
			<a href="interfaces/stitchserviceclient.html" class="tsd-kind-icon">Stitch<wbr>Service<wbr>Client</a>
		</li>
		<li class=" tsd-kind-interface tsd-is-external">
			<a href="interfaces/stitchuser.html" class="tsd-kind-icon">Stitch<wbr>User</a>
		</li>
		<li class=" tsd-kind-interface tsd-is-external">
			<a href="interfaces/stitchuserprofile.html" class="tsd-kind-icon">Stitch<wbr>User<wbr>Profile</a>
		</li>
		<li class=" tsd-kind-interface tsd-is-external">
			<a href="interfaces/updatedescription.html" class="tsd-kind-icon">Update<wbr>Description</a>
		</li>
		<li class=" tsd-kind-function tsd-is-external">
			<a href="globals.html#operationtypefromremote" class="tsd-kind-icon">operation<wbr>Type<wbr>From<wbr>Remote</a>
		</li>
		<li class=" tsd-kind-function tsd-is-external">
			<a href="globals.html#utf8slice" class="tsd-kind-icon">utf8<wbr>Slice</a>
		</li>
	</ul>
</nav>
<div class="container container-main">
	<div class="content-wrap">
		<div class="tsd-panel tsd-typography">
			<p><a href="https://gitter.im/mongodb/stitch?utm_source=badge&amp;utm_medium=badge&amp;utm_campaign=pr-badge&amp;utm_content=badge"><img src="https://badges.gitter.im/mongodb/stitch.svg" alt="Join the chat at https://gitter.im/mongodb/stitch"></a></p>
			<h1 id="mongodb-stitch-browser-sdk">MongoDB Stitch Browser SDK</h1>
			<p>The official <a href="https://stitch.mongodb.com/">MongoDB Stitch</a> Browser SDK for JavaScript/TypeScript.</p>
			...
			<ul>
				<li><a href="https://s3.amazonaws.com/stitch-sdks/js/docs/4.0.14/index.html">API/Typedoc Documentation</a></li>
				<li><a href="https://docs.mongodb.com/stitch/">MongoDB Stitch Documentation</a></li>
			</ul>
			<h2 id="discussion">Discussion</h2>
			<ul>
				<li><a href="https://groups.google.com/d/forum/mongodb-stitch-users">MongoDB Stitch Users - Google Group</a></li>
				<li><a href="https://groups.google.com/d/forum/mongodb-stitch-announce">MongoDB Stitch Announcements - Google Group</a></li>
			</ul>
			<h2 id="installation">Installation</h2>
			<h3 id="npm">NPM</h3>
			<p>Run the following in the root directory of your NPM project.</p>
			<pre><code class="lang-bash">npm install mongodb-stitch-browser-sdk
</code></pre>
			<p>This will start you off with the core SDK functionality as well as the remote MongoDB service.</p>
			<p>For customized dependencies use the following:</p>
			<pre><code class="lang-bash">npm install mongodb-stitch-browser-core
...
npm install mongodb-stitch-browser-services-twilio
			...
			<h3 id="html-script-tags">HTML Script Tags</h3>
			<p>You can also include the SDK directly in your HTML code using script tags. For core SDK functionality and the remote MongoDB service, use the following:</p>
			<pre><code class="lang-html"><span class="hljs-tag">&lt;<span class="hljs-name">script</span> <span class="hljs-attr">src</span>=<span class="hljs-string">"https://s3.amazonaws.com/stitch-sdks/js/bundles/4.0.14/stitch.js"</span>&gt;</span><span class="undefined"></span><span class="hljs-tag">&lt;/<span class="hljs-name">script</span>&gt;</span>
</code></pre>
			<p>For customized dependencies use the following:</p>
			<pre><code class="lang-html"><span class="hljs-tag">&lt;<span class="hljs-name">script</span> <span class="hljs-attr">src</span>=<span class="hljs-string">"https://s3.amazonaws.com/stitch-sdks/js/bundles/4.0.14/stitch-core.js"</span>&gt;</span><span class="undefined"></span><span class="hljs-tag">&lt;/<span class="hljs-name">script</span>&gt;</span>
<span class="hljs-tag">&lt;<span class="hljs-name">script</span> <span class="hljs-attr">src</span>=<span class="hljs-string">"https://s3.amazonaws.com/stitch-sdks/js/bundles/4.0.14/stitch-services-aws.js"</span>&gt;</span><span class="undefined"></span><span class="hljs-tag">&lt;/<span class="hljs-name">script</span>&gt;</span>
<span class="hljs-tag">&lt;<span class="hljs-name">script</span> <span class="hljs-attr">src</span>=<span class="hljs-string">"https://s3.amazonaws.com/stitch-sdks/js/bundles/4.0.14/stitch-services-http.js"</span>&gt;</span><span class="undefined"></span><span class="hljs-tag">&lt;/<span class="hljs-name">script</span>&gt;</span>
<span class="hljs-tag">&lt;<span class="hljs-name">script</span> <span class="hljs-attr">src</span>=<span class="hljs-string">"https://s3.amazonaws.com/stitch-sdks/js/bundles/4.0.14/stitch-services-mongodb-remote.js"</span>&gt;</span><span class="undefined"></span><span class="hljs-tag">&lt;/<span class="hljs-name">script</span>&gt;</span>
<span class="hljs-tag">&lt;<span class="hljs-name">script</span> <span class="hljs-attr">src</span>=<span class="hljs-string">"https://s3.amazonaws.com/stitch-sdks/js/bundles/4.0.14/stitch-services-twilio.js"</span>&gt;</span><span class="undefined"></span><span class="hljs-tag">&lt;/<span class="hljs-name">script</span>&gt;</span>
</code></pre>
			<h2 id="example-usage">Example Usage</h2>
			<h3 id="creating-a-new-app-with-the-sdk-npm-">Creating a new app with the SDK (NPM)</h3>
			<h4 id="set-up-an-application-on-stitch">Set up an application on Stitch</h4>
			<ol>
				<li>Go to <a href="https://stitch.mongodb.com/">https://stitch.mongodb.com/</a> and log in to MongoDB Atlas.</li>
				<li>Create a new app in your project with your desired name.</li>
				<li>Go to your app in Stitch via Atlas by clicking Stitch Apps in the left side pane and clicking your app.</li>
				<li>Copy your app&#39;s client app id by going to Clients on the left side pane and clicking copy on the App ID section.</li>
				<li>Go to Providers from Users in the left side pane and edit and enable &quot;Allow users to log in anonymously&quot;.</li>
			</ol>
			<h4 id="set-up-an-npm-project">Set up an NPM project</h4>
			<ol>
				<li>Ensure that you have <code>npm</code> installed. See <a href="https://www.npmjs.com">npmjs.com</a>.</li>
				<li>Initialize a new NPM project with <code>npm init</code>.</li>
				<li>Add the MongoDB Stitch Browser SDK by running <code>npm install mongodb-stitch-browser-sdk</code>.</li>
				<li>Install <code>webpack.js</code> by running <code>npm install --save-dev webpack webpack-cli</code>.</li>
				<li>Add the following field to the <code>&quot;scripts&quot;</code> field of your <code>package.json</code>:</li>
			</ol>
    ...
    &quot;pack&quot;: &quot;webpack&quot;
			...
			<ol start="6">
				<li>Create directories for your source files, and your distributed files:</li>
			</ol>
			<pre><code class="lang-bash">mkdir src dist
</code></pre>
			<ol start="7">
				<li>Create the file <code>src/index.js</code> and add the following code, replacing <code>&lt;your-client-app-id&gt;</code> with the id you retrieved when setting up the application in MongoDB Stitch:</li>
			</ol>
			<pre><code class="lang-javascript"><span class="hljs-keyword">import</span> { Stitch, AnonymousCredential } <span class="hljs-keyword">from</span> <span class="hljs-string">'mongodb-stitch-browser-sdk'</span>

<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">initializeAndLogin</span>(<span class="hljs-params"></span>) </span>{
  <span class="hljs-keyword">const</span> client = Stitch.initializeDefaultAppClient(<span class="hljs-string">'&lt;your-client-app-id&gt;'</span>);
  client.auth.loginWithCredential(<span class="hljs-keyword">new</span> AnonymousCredential()).then(<span class="hljs-function"><span class="hljs-params">user</span> =&gt;</span> {
    <span class="hljs-built_in">document</span>.getElementById(<span class="hljs-string">'auth-status'</span>).innerHTML = 
      <span class="hljs-string">`Logged in as anonymous user with id <span class="hljs-subst">${user.id}</span>`</span>;
  });
}

<span class="hljs-built_in">window</span>.onload = initializeAndLogin;
</code></pre>
			<ol start="8">
				<li>Create the file <code>dist/index.html</code> and add the following code:</li>
			</ol>
			<pre><code class="lang-html"><span class="hljs-meta">&lt;!doctype html&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">html</span>&gt;</span>
   <span class="hljs-tag">&lt;<span class="hljs-name">head</span>&gt;</span>
     <span class="hljs-tag">&lt;<span class="hljs-name">title</span>&gt;</span>MongoDB Stitch Sample<span class="hljs-tag">&lt;/<span class="hljs-name">title</span>&gt;</span>
   <span class="hljs-tag">&lt;/<span class="hljs-name">head</span>&gt;</span>
   <span class="hljs-tag">&lt;<span class="hljs-name">body</span>&gt;</span>
     ...
     <span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">id</span>=<span class="hljs-string">"auth-status"</span>&gt;</span>Logged Out<span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span>
   <span class="hljs-tag">&lt;/<span class="hljs-name">body</span>&gt;</span>
  <span class="hljs-tag">&lt;/<span class="hljs-name">html</span>&gt;</span>
</code></pre>
			<ol start="9">
				<li>Run the webpack bundler by running <code>npm run pack</code>.</li>
				<li>Open <code>dist/index.html</code> in your web browser. If everything was configured correctly, you should see a message in the browser window that you are logged in as an anonymous user.</li>
			</ol>
			<p>See the <a href="https://webpack.js.org/guides/getting-started/">Getting Started</a> guide on <code>webpack</code>&#39;s website for more information on how to use webpack to bundle your JavaScript or TypeScript code that uses the Stitch SDK.</p>
			<p>Additionally, the JavaScript code above utilizes ES6 features. If you&#39;d like your code to run in older browsers, you&#39;ll need to use a transpiler like <a href="https://babeljs.io/">Babel</a> as part of your bundling process. See <a href="https://github.com/babel/babel-loader">babel-loader</a>.</p>
			<h3 id="using-the-sdk">Using the SDK</h3>
			<h4 id="initialize-the-sdk">Initialize the SDK</h4>
			<ol>
				<li>When your app or webpage is initialized, run the following code to initialize the Stitch SDK, replacing <code>&lt;your-client-app-id&gt;</code> with your Stitch application&#39;s client app ID:</li>
			</ol>
			<pre><code class="lang-javascript"><span class="hljs-keyword">import</span> { Stitch, AnonymousCredential } <span class="hljs-keyword">from</span> <span class="hljs-string">'mongodb-stitch-browser-sdk'</span>

Stitch.initializeDefaultAppClient(<span class="hljs-string">'&lt;your-client-app-id&gt;'</span>);
</code></pre>
			<ol start="2">
				<li>To get a client to use for logging in and communicating with Stitch, use <code>Stitch.defaultAppClient</code></li>
			</ol>
			<pre><code class="lang-javascript"><span class="hljs-keyword">const</span> stitchClient = Stitch.defaultAppClient;
</code></pre>
			<h4 id="logging-in">Logging In</h4>
			<ol>
				<li>We enabled anonymous log in, so let&#39;s log in with it; add the following anywhere in your code:</li>
			</ol>
			<pre><code class="lang-javascript"><span class="hljs-keyword">const</span> client = Stitch.defaultAppClient;

<span class="hljs-built_in">console</span>.log(<span class="hljs-string">"logging in anonymously"</span>);
client.auth.loginWithCredential(<span class="hljs-keyword">new</span> AnonymousCredential()).then(<span class="hljs-function"><span class="hljs-params">user</span> =&gt;</span> {
  <span class="hljs-built_in">console</span>.log(<span class="hljs-string">`logged in anonymously as user <span class="hljs-subst">${user.id}</span>`</span>)
});
</code></pre>
			<ol start="2">
				<li>When running this code, you should see the following in your browser&#39;s debug console:</li>
			</ol>
			<pre><code>logging <span class="hljs-keyword">in</span> anonymously
logged <span class="hljs-keyword">in</span> anonymously as<span class="hljs-built_in"> user </span>58c5d6ebb9ede022a3d75050
</code></pre><h4 id="using-bson-and-extended-json">Using BSON and Extended JSON</h4>
			<p>This library depends on <a href="https://www.npmjs.com/package/mongodb-stitch-bson">mongodb-stitch-bson</a> and <a href="https://www.npmjs.com/package/mongodb-stitch-extjson">mongodb-stitch-extjson</a>. Usage of both can be see on the respective READMEs.</p>
			<h4 id="executing-a-function">Executing a function</h4>
			<ol>
				<li>Once logged in, executing a function happens via the <code>StitchAppClient</code>&#39;s <code>callFunction()</code> method</li>
			</ol>
			<pre><code class="lang-javascript">client.callFunction(<span class="hljs-string">"echoArg"</span>, [<span class="hljs-string">"Hello world!"</span>]).then(<span class="hljs-function"><span class="hljs-params">echoedResult</span> =&gt;</span> {
  <span class="hljs-built_in">console</span>.log(<span class="hljs-string">`Echoed result: <span class="hljs-subst">${echoedResult}</span>`</span>);
})
</code></pre>
			<ol start="2">
				<li>If you&#39;ve configured your Stitch application to have a function named &quot;echoArg&quot; that returns its argument, you should see a message like:</li>
			</ol>
			<pre><code>Echoed <span class="hljs-literal">result</span>: Hello world!
</code></pre><h4 id="getting-a-stitchappclient-without-stitch-getdefaultappclient">Getting a StitchAppClient without Stitch.getDefaultAppClient</h4>
			<p>In the case that you don&#39;t want a single default initialized <code>StitchAppClient</code>, you can use the following with as many client app IDs as you&#39;d like to initialize clients for multiple app IDs:</p>
			<pre><code class="lang-javascript"><span class="hljs-keyword">const</span> client = Stitch.initializeAppClient(<span class="hljs-string">"&lt;your-client-app-id&gt;"</span>);
</code></pre>
			<p>You can use the client returned there or anywhere else in your app by using the following:</p>
			<pre><code class="lang-javascript"><span class="hljs-keyword">const</span> client = Stitch.getAppClient(<span class="hljs-string">"&lt;your-client-app-id&gt;"</span>);
</code></pre>
		</div>
				...
				<div class="tsd-index-content">
					<section class="tsd-index-section tsd-is-external">
						...
						<ul class="tsd-index-list">
							<li class="tsd-kind-module tsd-is-external"><a href="modules/awss3serviceclient.html" class="tsd-kind-icon">Aws<wbr>S3Service<wbr>Client</a></li>
							<li class="tsd-kind-module tsd-is-external"><a href="modules/awsserviceclient.html" class="tsd-kind-icon">Aws<wbr>Service<wbr>Client</a></li>
							<li class="tsd-kind-module tsd-is-external"><a href="modules/awssesserviceclient.html" class="tsd-kind-icon">Aws<wbr>Ses<wbr>Service<wbr>Client</a></li>
							<li class="tsd-kind-module tsd-is-external"><a href="modules/httpserviceclient.html" class="tsd-kind-icon">Http<wbr>Service<wbr>Client</a></li>
							<li class="tsd-kind-module tsd-is-external"><a href="modules/remotemongoclient.html" class="tsd-kind-icon">Remote<wbr>Mongo<wbr>Client</a></li>
							<li class="tsd-kind-module tsd-is-external"><a href="modules/twilioserviceclient.html" class="tsd-kind-icon">Twilio<wbr>Service<wbr>Client</a></li>
							<li class="tsd-kind-module tsd-is-external"><a href="modules/userapikeyauthproviderclient.html" class="tsd-kind-icon">User<wbr>Api<wbr>Key<wbr>Auth<wbr>Provider<wbr>Client</a></li>
							<li class="tsd-kind-module tsd-is-external"><a href="modules/userpasswordauthproviderclient.html" class="tsd-kind-icon">User<wbr>Password<wbr>Auth<wbr>Provider<wbr>Client</a></li>
						</ul>
					</section>
					<section class="tsd-index-section tsd-is-external">
						<h3>Enumerations</h3>
						<ul class="tsd-index-list">
							<li class="tsd-kind-enum tsd-is-external"><a href="enums/httpmethod.html" class="tsd-kind-icon">Http<wbr>Method</a></li>
							<li class="tsd-kind-enum tsd-is-external"><a href="enums/operationtype.html" class="tsd-kind-icon">Operation<wbr>Type</a></li>
							<li class="tsd-kind-enum tsd-is-external"><a href="enums/stitchclienterrorcode.html" class="tsd-kind-icon">Stitch<wbr>Client<wbr>Error<wbr>Code</a></li>
							<li class="tsd-kind-enum tsd-is-external"><a href="enums/stitchrequesterrorcode.html" class="tsd-kind-icon">Stitch<wbr>Request<wbr>Error<wbr>Code</a></li>
							<li class="tsd-kind-enum tsd-is-external"><a href="enums/stitchserviceerrorcode.html" class="tsd-kind-icon">Stitch<wbr>Service<wbr>Error<wbr>Code</a></li>
						</ul>
					</section>
					<section class="tsd-index-section tsd-is-external">
						<h3>Classes</h3>
						<ul class="tsd-index-list">
							<li class="tsd-kind-class tsd-is-external"><a href="classes/anonymouscredential.html" class="tsd-kind-icon">Anonymous<wbr>Credential</a></li>
							<li class="tsd-kind-class tsd-is-external"><a href="classes/awsrequest.html" class="tsd-kind-icon">Aws<wbr>Request</a></li>
							<li class="tsd-kind-class tsd-is-external"><a href="classes/awss3putobjectresult.html" class="tsd-kind-icon">Aws<wbr>S3Put<wbr>Object<wbr>Result</a></li>
							<li class="tsd-kind-class tsd-is-external"><a href="classes/awss3signpolicyresult.html" class="tsd-kind-icon">Aws<wbr>S3Sign<wbr>Policy<wbr>Result</a></li>
							<li class="tsd-kind-class tsd-is-external"><a href="classes/awsserviceclientimpl.html" class="tsd-kind-icon">Aws<wbr>Service<wbr>Client<wbr>Impl</a></li>
							<li class="tsd-kind-class tsd-is-external"><a href="classes/awssessendresult.html" class="tsd-kind-icon">Aws<wbr>Ses<wbr>Send<wbr>Result</a></li>
							<li class="tsd-kind-class tsd-is-external"><a href="classes/coreawsserviceclient.html" class="tsd-kind-icon">Core<wbr>Aws<wbr>Service<wbr>Client</a></li>
							<li class="tsd-kind-class tsd-is-external"><a href="classes/customcredential.html" class="tsd-kind-icon">Custom<wbr>Credential</a></li>
							<li class="tsd-kind-class tsd-is-external"><a href="classes/eventsourceeventstream.html" class="tsd-kind-icon">Event<wbr>Source<wbr>Event<wbr>Stream</a></li>
							<li class="tsd-kind-class tsd-is-external"><a href="classes/facebookcredential.html" class="tsd-kind-icon">Facebook<wbr>Credential</a></li>
							<li class="tsd-kind-class tsd-is-external"><a href="classes/facebookredirectcredential.html" class="tsd-kind-icon">Facebook<wbr>Redirect<wbr>Credential</a></li>
							<li class="tsd-kind-class tsd-is-external"><a href="classes/googlecredential.html" class="tsd-kind-icon">Google<wbr>Credential</a></li>
							<li class="tsd-kind-class tsd-is-external"><a href="classes/googleredirectcredential.html" class="tsd-kind-icon">Google<wbr>Redirect<wbr>Credential</a></li>
							<li class="tsd-kind-class tsd-is-external"><a href="classes/httpcookie.html" class="tsd-kind-icon">Http<wbr>Cookie</a></li>
							<li class="tsd-kind-class tsd-is-external"><a href="classes/httprequest.html" class="tsd-kind-icon">Http<wbr>Request</a></li>
							<li class="tsd-kind-class tsd-is-external"><a href="classes/httpresponse.html" class="tsd-kind-icon">Http<wbr>Response</a></li>
							<li class="tsd-kind-class tsd-is-external"><a href="classes/providercapabilities.html" class="tsd-kind-icon">Provider<wbr>Capabilities</a></li>
							<li class="tsd-kind-class tsd-is-external"><a href="classes/remoteinsertmanyresult.html" class="tsd-kind-icon">Remote<wbr>Insert<wbr>Many<wbr>Result</a></li>
							<li class="tsd-kind-class tsd-has-type-parameter tsd-is-external"><a href="classes/remotemongocursor.html" class="tsd-kind-icon">Remote<wbr>Mongo<wbr>Cursor</a></li>
							<li class="tsd-kind-class tsd-has-type-parameter tsd-is-external"><a href="classes/remotemongoreadoperation.html" class="tsd-kind-icon">Remote<wbr>Mongo<wbr>Read<wbr>Operation</a></li>
							<li class="tsd-kind-class tsd-is-external"><a href="classes/serverapikeycredential.html" class="tsd-kind-icon">Server<wbr>Api<wbr>Key<wbr>Credential</a></li>
							<li class="tsd-kind-class tsd-is-external"><a href="classes/stitch.html" class="tsd-kind-icon">Stitch</a></li>
							<li class="tsd-kind-class tsd-is-external"><a href="classes/stitchappclientconfiguration.html" class="tsd-kind-icon">Stitch<wbr>App<wbr>Client<wbr>Configuration</a></li>
							<li class="tsd-kind-class tsd-is-external"><a href="classes/stitchauthresponsecredential.html" class="tsd-kind-icon">Stitch<wbr>Auth<wbr>Response<wbr>Credential</a></li>
							<li class="tsd-kind-class tsd-is-external"><a href="classes/stitchbrowserappauthroutes.html" class="tsd-kind-icon">Stitch<wbr>Browser<wbr>App<wbr>Auth<wbr>Routes</a></li>
							<li class="tsd-kind-class tsd-is-external"><a href="classes/stitchbrowserapproutes.html" class="tsd-kind-icon">Stitch<wbr>Browser<wbr>App<wbr>Routes</a></li>
							<li class="tsd-kind-class tsd-is-external"><a href="classes/stitchclienterror.html" class="tsd-kind-icon">Stitch<wbr>Client<wbr>Error</a></li>
							<li class="tsd-kind-class tsd-is-external"><a href="classes/stitcherror.html" class="tsd-kind-icon">Stitch<wbr>Error</a></li>
							<li class="tsd-kind-class tsd-is-external"><a href="classes/stitchredirecterror.html" class="tsd-kind-icon">Stitch<wbr>Redirect<wbr>Error</a></li>
							<li class="tsd-kind-class tsd-is-external"><a href="classes/stitchrequesterror.html" class="tsd-kind-icon">Stitch<wbr>Request<wbr>Error</a></li>
							<li class="tsd-kind-class tsd-is-external"><a href="classes/stitchserviceerror.html" class="tsd-kind-icon">Stitch<wbr>Service<wbr>Error</a></li>
							<li class="tsd-kind-class tsd-is-external"><a href="classes/stitchuseridentity.html" class="tsd-kind-icon">Stitch<wbr>User<wbr>Identity</a></li>
							<li class="tsd-kind-class tsd-is-external"><a href="classes/userapikey.html" class="tsd-kind-icon">User<wbr>Api<wbr>Key</a></li>
							<li class="tsd-kind-class tsd-is-external"><a href="classes/userapikeycredential.html" class="tsd-kind-icon">User<wbr>Api<wbr>Key<wbr>Credential</a></li>
							<li class="tsd-kind-class tsd-is-external"><a href="classes/userpasswordcredential.html" class="tsd-kind-icon">User<wbr>Password<wbr>Credential</a></li>
						</ul>
					</section>
					<section class="tsd-index-section tsd-is-external">
						<h3>Interfaces</h3>
						<ul class="tsd-index-list">
							<li class="tsd-kind-interface tsd-has-type-parameter tsd-is-external"><a href="interfaces/changeevent.html" class="tsd-kind-icon">Change<wbr>Event</a></li>
							<li class="tsd-kind-interface tsd-is-external"><a href="interfaces/mongonamespace.html" class="tsd-kind-icon">Mongo<wbr>Namespace</a></li>
							<li class="tsd-kind-interface tsd-has-type-parameter tsd-is-external"><a href="interfaces/namedserviceclientfactory.html" class="tsd-kind-icon">Named<wbr>Service<wbr>Client<wbr>Factory</a></li>
							<li class="tsd-kind-interface tsd-is-external"><a href="interfaces/remotecountoptions.html" class="tsd-kind-icon">Remote<wbr>Count<wbr>Options</a></li>
							<li class="tsd-kind-interface tsd-is-external"><a href="interfaces/remotedeleteresult.html" class="tsd-kind-icon">Remote<wbr>Delete<wbr>Result</a></li>
							<li class="tsd-kind-interface tsd-is-external"><a href="interfaces/remotefindoptions.html" class="tsd-kind-icon">Remote<wbr>Find<wbr>Options</a></li>
							<li class="tsd-kind-interface tsd-is-external"><a href="interfaces/remoteinsertoneresult.html" class="tsd-kind-icon">Remote<wbr>Insert<wbr>One<wbr>Result</a></li>
							<li class="tsd-kind-interface tsd-has-type-parameter tsd-is-external"><a href="interfaces/remotemongocollection.html" class="tsd-kind-icon">Remote<wbr>Mongo<wbr>Collection</a></li>
							<li class="tsd-kind-interface tsd-is-external"><a href="interfaces/remotemongodatabase.html" class="tsd-kind-icon">Remote<wbr>Mongo<wbr>Database</a></li>
							<li class="tsd-kind-interface tsd-is-external"><a href="interfaces/remoteupdateoptions.html" class="tsd-kind-icon">Remote<wbr>Update<wbr>Options</a></li>
							<li class="tsd-kind-interface tsd-is-external"><a href="interfaces/remoteupdateresult.html" class="tsd-kind-icon">Remote<wbr>Update<wbr>Result</a></li>
							<li class="tsd-kind-interface tsd-has-type-parameter tsd-is-external"><a href="interfaces/serviceclientfactory.html" class="tsd-kind-icon">Service<wbr>Client<wbr>Factory</a></li>
							<li class="tsd-kind-interface tsd-is-external"><a href="interfaces/stitchappclient.html" class="tsd-kind-icon">Stitch<wbr>App<wbr>Client</a></li>
							<li class="tsd-kind-interface tsd-is-external"><a href="interfaces/stitchauth.html" class="tsd-kind-icon">Stitch<wbr>Auth</a></li>
							<li class="tsd-kind-interface tsd-is-external"><a href="interfaces/stitchauthlistener.html" class="tsd-kind-icon">Stitch<wbr>Auth<wbr>Listener</a></li>
							<li class="tsd-kind-interface tsd-is-external"><a href="interfaces/stitchcredential.html" class="tsd-kind-icon">Stitch<wbr>Credential</a></li>
							<li class="tsd-kind-interface tsd-is-external"><a href="interfaces/stitchredirectcredential.html" class="tsd-kind-icon">Stitch<wbr>Redirect<wbr>Credential</a></li>
							<li class="tsd-kind-interface tsd-is-external"><a href="interfaces/stitchserviceclient.html" class="tsd-kind-icon">Stitch<wbr>Service<wbr>Client</a></li>
							<li class="tsd-kind-interface tsd-is-external"><a href="interfaces/stitchuser.html" class="tsd-kind-icon">Stitch<wbr>User</a></li>
							<li class="tsd-kind-interface tsd-is-external"><a href="interfaces/stitchuserprofile.html" class="tsd-kind-icon">Stitch<wbr>User<wbr>Profile</a></li>
							<li class="tsd-kind-interface tsd-is-external"><a href="interfaces/updatedescription.html" class="tsd-kind-icon">Update<wbr>Description</a></li>
						</ul>
					</section>
					<section class="tsd-index-section tsd-is-external">
						<h3>Functions</h3>
						<ul class="tsd-index-list">
							<li class="tsd-kind-function tsd-is-external"><a href="globals.html#operationtypefromremote" class="tsd-kind-icon">operation<wbr>Type<wbr>From<wbr>Remote</a></li>
							<li class="tsd-kind-function tsd-is-external"><a href="globals.html#utf8slice" class="tsd-kind-icon">utf8<wbr>Slice</a></li>
						</ul>
					</section>
				</div>
			</section>
		...
		<section class="tsd-panel-group tsd-member-group tsd-is-external">
			...
			<section class="tsd-panel tsd-member tsd-kind-function tsd-is-external">
				<a name="operationtypefromremote" class="tsd-anchor"></a>
				<h3>operation<wbr>Type<wbr>From<wbr>Remote</h3>
				<ul class="tsd-signatures tsd-kind-function tsd-is-external">
					<li class="tsd-signature tsd-kind-icon">operation<wbr>Type<wbr>From<wbr>Remote<span class="tsd-signature-symbol">(</span>type<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><a href="enums/operationtype.html" class="tsd-signature-type">OperationType</a></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/mongodb/stitch-js-sdk/blob/131d8fe/packages/core/services/mongodb-remote/src/OperationType.ts#L25">core/services/mongodb-remote/src/OperationType.ts:25</a></li>
							</ul>
						</aside>
						...
						<h4 class="tsd-returns-title">Returns <a href="enums/operationtype.html" class="tsd-signature-type">OperationType</a></h4>
					</li>
				</ul>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-function tsd-is-external">
				<a name="utf8slice" class="tsd-anchor"></a>
				<h3>utf8<wbr>Slice</h3>
				<ul class="tsd-signatures tsd-kind-function tsd-is-external">
					<li class="tsd-signature tsd-kind-icon">utf8<wbr>Slice<span class="tsd-signature-symbol">(</span>buf<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">Uint8Array</span>, start<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">number</span>, end<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">number</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/mongodb/stitch-js-sdk/blob/131d8fe/packages/core/sdk/src/internal/common/Base64.ts#L138">core/sdk/src/internal/common/Base64.ts:138</a></li>
							</ul>
						</aside>
						<h4 class="tsd-parameters-title">Parameters</h4>
						<ul class="tsd-parameters">
