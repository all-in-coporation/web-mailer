...
<head>
	...
	<title>FacebookRedirectCredential | MongoDB Stitch Browser SDK</title>
...
<nav class="tsd-navigation secondary">
	<ul>
		<li class="current tsd-kind-class tsd-is-external">
			<a href="facebookredirectcredential.html" class="tsd-kind-icon">Facebook<wbr>Redirect<wbr>Credential</a>
			<ul>
				<li class=" tsd-kind-constructor tsd-parent-kind-class tsd-is-external">
					<a href="facebookredirectcredential.html#constructor" class="tsd-kind-icon">constructor</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-class tsd-is-external">
					<a href="facebookredirectcredential.html#providername" class="tsd-kind-icon">provider<wbr>Name</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-class tsd-is-external">
					<a href="facebookredirectcredential.html#providertype" class="tsd-kind-icon">provider<wbr>Type</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-class tsd-is-external">
					<a href="facebookredirectcredential.html#redirecturl" class="tsd-kind-icon">redirect<wbr>Url</a>
				</li>
			</ul>
		</li>
	</ul>
	...
	<div class="content-wrap">
		<section class="tsd-panel tsd-comment">
			<div class="tsd-comment tsd-typography">
				<div class="lead">
					<p>A credential which can be used with <a href="../interfaces/stitchauth.html#loginwithredirect">StitchAuth.loginWithRedirect</a> to
					login to Stitch via Facebook OAuth.</p>
				</div>
			</div>
		</section>
		<section class="tsd-panel tsd-hierarchy">
			...
			<ul class="tsd-hierarchy">
				<li>
					<span class="target">FacebookRedirectCredential</span>
				</li>
			</ul>
		</section>
		<section class="tsd-panel">
			<h3>Implements</h3>
			<ul class="tsd-hierarchy">
				<li><a href="../interfaces/stitchredirectcredential.html" class="tsd-signature-type">StitchRedirectCredential</a></li>
			</ul>
		</section>
				...
				<div class="tsd-index-content">
					<section class="tsd-index-section tsd-is-external">
						...
						<ul class="tsd-index-list">
							<li class="tsd-kind-constructor tsd-parent-kind-class tsd-is-external"><a href="facebookredirectcredential.html#constructor" class="tsd-kind-icon">constructor</a></li>
						</ul>
					</section>
					<section class="tsd-index-section tsd-is-external">
						<h3>Properties</h3>
						<ul class="tsd-index-list">
							<li class="tsd-kind-property tsd-parent-kind-class tsd-is-external"><a href="facebookredirectcredential.html#providername" class="tsd-kind-icon">provider<wbr>Name</a></li>
							<li class="tsd-kind-property tsd-parent-kind-class tsd-is-external"><a href="facebookredirectcredential.html#providertype" class="tsd-kind-icon">provider<wbr>Type</a></li>
							<li class="tsd-kind-property tsd-parent-kind-class tsd-is-external"><a href="facebookredirectcredential.html#redirecturl" class="tsd-kind-icon">redirect<wbr>Url</a></li>
						</ul>
					</section>
				</div>
			</section>
		...
		<section class="tsd-panel-group tsd-member-group tsd-is-external">
			...
			<section class="tsd-panel tsd-member tsd-kind-constructor tsd-parent-kind-class tsd-is-external">
				...
				<ul class="tsd-signatures tsd-kind-constructor tsd-parent-kind-class tsd-is-external">
					<li class="tsd-signature tsd-kind-icon">new <wbr>Facebook<wbr>Redirect<wbr>Credential<span class="tsd-signature-symbol">(</span>redirectUrl<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">undefined</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">string</span>, providerName<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">string</span>, providerType<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">string</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><a href="facebookredirectcredential.html" class="tsd-signature-type">FacebookRedirectCredential</a></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/mongodb/stitch-js-sdk/blob/131d8fe/packages/browser/core/src/core/auth/providers/facebook/FacebookRedirectCredential.ts#L25">browser/core/src/core/auth/providers/facebook/FacebookRedirectCredential.ts:25</a></li>
							</ul>
						</aside>
						<h4 class="tsd-parameters-title">Parameters</h4>
						<ul class="tsd-parameters">
							<li>
								<h5><span class="tsd-flag ts-flagOptional">Optional</span> redirectUrl: <span class="tsd-signature-type">undefined</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">string</span></h5>
							</li>
							<li>
								<h5><span class="tsd-flag ts-flagDefault value">Default value</span> providerName: <span class="tsd-signature-type">string</span><span class="tsd-signature-symbol"> =&nbsp;FacebookAuthProvider.DEFAULT_NAME</span></h5>
							</li>
							<li>
								<h5><span class="tsd-flag ts-flagDefault value">Default value</span> providerType: <span class="tsd-signature-type">string</span><span class="tsd-signature-symbol"> =&nbsp;FacebookAuthProvider.TYPE</span></h5>
							</li>
						</ul>
						<h4 class="tsd-returns-title">Returns <a href="facebookredirectcredential.html" class="tsd-signature-type">FacebookRedirectCredential</a></h4>
					</li>
				</ul>
			</section>
		</section>
		<section class="tsd-panel-group tsd-member-group tsd-is-external">
			...
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-class tsd-is-external">
				...
				<aside class="tsd-sources">
					<p>Implementation of <a href="../interfaces/stitchredirectcredential.html">StitchRedirectCredential</a>.<a href="../interfaces/stitchredirectcredential.html#providername">providerName</a></p>
					<ul>
						<li>Defined in <a href="https://github.com/mongodb/stitch-js-sdk/blob/131d8fe/packages/browser/core/src/core/auth/providers/facebook/FacebookRedirectCredential.ts#L28">browser/core/src/core/auth/providers/facebook/FacebookRedirectCredential.ts:28</a></li>
					</ul>
				</aside>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-class tsd-is-external">
				...
				<aside class="tsd-sources">
					<p>Implementation of <a href="../interfaces/stitchredirectcredential.html">StitchRedirectCredential</a>.<a href="../interfaces/stitchredirectcredential.html#providertype">providerType</a></p>
					<ul>
						<li>Defined in <a href="https://github.com/mongodb/stitch-js-sdk/blob/131d8fe/packages/browser/core/src/core/auth/providers/facebook/FacebookRedirectCredential.ts#L29">browser/core/src/core/auth/providers/facebook/FacebookRedirectCredential.ts:29</a></li>
					</ul>
				</aside>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-class tsd-is-external">
				<a name="redirecturl" class="tsd-anchor"></a>
				<h3><span class="tsd-flag ts-flagOptional">Optional</span> redirect<wbr>Url</h3>
				<div class="tsd-signature tsd-kind-icon">redirect<wbr>Url<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">undefined</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">string</span></div>
				<aside class="tsd-sources">
					<p>Implementation of <a href="../interfaces/stitchredirectcredential.html">StitchRedirectCredential</a>.<a href="../interfaces/stitchredirectcredential.html#redirecturl">redirectUrl</a></p>
					<ul>
						<li>Defined in <a href="https://github.com/mongodb/stitch-js-sdk/blob/131d8fe/packages/browser/core/src/core/auth/providers/facebook/FacebookRedirectCredential.ts#L27">browser/core/src/core/auth/providers/facebook/FacebookRedirectCredential.ts:27</a></li>
					</ul>
				</aside>
			</section>
		</section>
