...
<head>
	...
	<title>StitchBrowserAppRoutes | MongoDB Stitch Browser SDK</title>
...
<nav class="tsd-navigation secondary">
	<ul>
		<li class="current tsd-kind-class tsd-is-external">
			<a href="stitchbrowserapproutes.html" class="tsd-kind-icon">Stitch<wbr>Browser<wbr>App<wbr>Routes</a>
			<ul>
				<li class=" tsd-kind-constructor tsd-parent-kind-class tsd-is-overwrite tsd-is-external">
					<a href="stitchbrowserapproutes.html#constructor" class="tsd-kind-icon">constructor</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-class tsd-is-overwrite tsd-is-external">
					<a href="stitchbrowserapproutes.html#authroutes" class="tsd-kind-icon">auth<wbr>Routes</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-class tsd-is-inherited tsd-is-external">
					<a href="stitchbrowserapproutes.html#functioncallroute" class="tsd-kind-icon">function<wbr>Call<wbr>Route</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-class tsd-is-inherited tsd-is-external">
					<a href="stitchbrowserapproutes.html#serviceroutes" class="tsd-kind-icon">service<wbr>Routes</a>
				</li>
			</ul>
		</li>
	</ul>
	...
	<div class="content-wrap">
		<section class="tsd-panel tsd-hierarchy">
			...
			<ul class="tsd-hierarchy">
				<li>
					<span class="tsd-signature-type">StitchAppRoutes</span>
					<ul class="tsd-hierarchy">
						<li>
							<span class="target">StitchBrowserAppRoutes</span>
						</li>
					</ul>
				</li>
			</ul>
				...
				<div class="tsd-index-content">
					<section class="tsd-index-section tsd-is-external">
						...
						<ul class="tsd-index-list">
							<li class="tsd-kind-constructor tsd-parent-kind-class tsd-is-overwrite tsd-is-external"><a href="stitchbrowserapproutes.html#constructor" class="tsd-kind-icon">constructor</a></li>
						</ul>
					</section>
					<section class="tsd-index-section tsd-is-external">
						<h3>Properties</h3>
						<ul class="tsd-index-list">
							<li class="tsd-kind-property tsd-parent-kind-class tsd-is-overwrite tsd-is-external"><a href="stitchbrowserapproutes.html#authroutes" class="tsd-kind-icon">auth<wbr>Routes</a></li>
							<li class="tsd-kind-property tsd-parent-kind-class tsd-is-inherited tsd-is-external"><a href="stitchbrowserapproutes.html#functioncallroute" class="tsd-kind-icon">function<wbr>Call<wbr>Route</a></li>
							<li class="tsd-kind-property tsd-parent-kind-class tsd-is-inherited tsd-is-external"><a href="stitchbrowserapproutes.html#serviceroutes" class="tsd-kind-icon">service<wbr>Routes</a></li>
						</ul>
					</section>
				</div>
			</section>
		...
		<section class="tsd-panel-group tsd-member-group tsd-is-external">
			...
			<section class="tsd-panel tsd-member tsd-kind-constructor tsd-parent-kind-class tsd-is-overwrite tsd-is-external">
				...
				<ul class="tsd-signatures tsd-kind-constructor tsd-parent-kind-class tsd-is-overwrite tsd-is-external">
					<li class="tsd-signature tsd-kind-icon">new <wbr>Stitch<wbr>Browser<wbr>App<wbr>Routes<span class="tsd-signature-symbol">(</span>clientAppId<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span>, baseUrl<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><a href="stitchbrowserapproutes.html" class="tsd-signature-type">StitchBrowserAppRoutes</a></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<p>Overrides StitchAppRoutes.__constructor</p>
							<ul>
								<li>Defined in <a href="https://github.com/mongodb/stitch-js-sdk/blob/131d8fe/packages/browser/core/src/core/auth/internal/StitchBrowserAppRoutes.ts#L21">browser/core/src/core/auth/internal/StitchBrowserAppRoutes.ts:21</a></li>
							</ul>
						</aside>
						...
						<h4 class="tsd-returns-title">Returns <a href="stitchbrowserapproutes.html" class="tsd-signature-type">StitchBrowserAppRoutes</a></h4>
					</li>
				</ul>
			</section>
		</section>
		<section class="tsd-panel-group tsd-member-group tsd-is-external">
			...
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-class tsd-is-overwrite tsd-is-external">
				<a name="authroutes" class="tsd-anchor"></a>
				<h3>auth<wbr>Routes</h3>
				<div class="tsd-signature tsd-kind-icon">auth<wbr>Routes<span class="tsd-signature-symbol">:</span> <a href="stitchbrowserappauthroutes.html" class="tsd-signature-type">StitchBrowserAppAuthRoutes</a></div>
				<aside class="tsd-sources">
					<p>Overrides StitchAppRoutes.authRoutes</p>
					<ul>
						<li>Defined in <a href="https://github.com/mongodb/stitch-js-sdk/blob/131d8fe/packages/browser/core/src/core/auth/internal/StitchBrowserAppRoutes.ts#L21">browser/core/src/core/auth/internal/StitchBrowserAppRoutes.ts:21</a></li>
					</ul>
				</aside>
			...
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-class tsd-is-inherited tsd-is-external">
				<a name="functioncallroute" class="tsd-anchor"></a>
				<h3>function<wbr>Call<wbr>Route</h3>
				<div class="tsd-signature tsd-kind-icon">function<wbr>Call<wbr>Route<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">string</span></div>
				<aside class="tsd-sources">
					<p>Inherited from StitchAppRoutes.functionCallRoute</p>
					<ul>
						<li>Defined in browser/core/node_modules/mongodb-stitch-core-sdk/dist/esm/internal/net/StitchAppRoutes.d.ts:6</li>
					</ul>
				</aside>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-class tsd-is-inherited tsd-is-external">
				<a name="serviceroutes" class="tsd-anchor"></a>
				<h3>service<wbr>Routes</h3>
				<div class="tsd-signature tsd-kind-icon">service<wbr>Routes<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">StitchServiceRoutes</span></div>
				<aside class="tsd-sources">
					<p>Inherited from StitchAppRoutes.serviceRoutes</p>
					<ul>
						<li>Defined in browser/core/node_modules/mongodb-stitch-core-sdk/dist/esm/internal/net/StitchAppRoutes.d.ts:5</li>
					</ul>
				</aside>
			</section>
		</section>
