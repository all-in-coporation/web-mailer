...
<head>
	...
	<title>EventSourceEventStream | MongoDB Stitch Browser SDK</title>
...
<nav class="tsd-navigation secondary">
	<ul>
		<li class="current tsd-kind-class tsd-is-external">
			<a href="eventsourceeventstream.html" class="tsd-kind-icon">Event<wbr>Source<wbr>Event<wbr>Stream</a>
			<ul>
				<li class=" tsd-kind-constructor tsd-parent-kind-class tsd-is-overwrite tsd-is-external">
					<a href="eventsourceeventstream.html#constructor" class="tsd-kind-icon">constructor</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-class tsd-is-inherited tsd-is-protected tsd-is-external">
					<a href="eventsourceeventstream.html#closed" class="tsd-kind-icon">closed</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-class tsd-is-inherited tsd-is-protected tsd-is-external">
					<a href="eventsourceeventstream.html#events" class="tsd-kind-icon">events</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-class tsd-is-private tsd-is-external">
					<a href="eventsourceeventstream.html#evtsrc" class="tsd-kind-icon">evt<wbr>Src</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-class tsd-is-inherited tsd-is-protected tsd-is-external">
					<a href="eventsourceeventstream.html#lasterr" class="tsd-kind-icon">last<wbr>Err</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-class tsd-is-inherited tsd-is-protected tsd-is-external">
					<a href="eventsourceeventstream.html#listeners" class="tsd-kind-icon">listeners</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-class tsd-is-private tsd-is-external">
					<a href="eventsourceeventstream.html#onopenerror" class="tsd-kind-icon">on<wbr>Open<wbr>Error</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-class tsd-is-private tsd-is-external">
					<a href="eventsourceeventstream.html#openedonce" class="tsd-kind-icon">opened<wbr>Once</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-class tsd-is-inherited tsd-is-protected tsd-is-static tsd-is-external">
					<a href="eventsourceeventstream.html#retry_timeout_millis" class="tsd-kind-icon">RETRY_<wbr>TIMEOUT_<wbr>MILLIS</a>
				</li>
				<li class=" tsd-kind-method tsd-parent-kind-class tsd-is-inherited tsd-is-external">
					<a href="eventsourceeventstream.html#addlistener" class="tsd-kind-icon">add<wbr>Listener</a>
				</li>
				<li class=" tsd-kind-method tsd-parent-kind-class tsd-is-overwrite tsd-is-external">
					<a href="eventsourceeventstream.html#afterclose" class="tsd-kind-icon">after<wbr>Close</a>
				</li>
				<li class=" tsd-kind-method tsd-parent-kind-class tsd-is-inherited tsd-is-external">
					<a href="eventsourceeventstream.html#close" class="tsd-kind-icon">close</a>
				</li>
				<li class=" tsd-kind-method tsd-parent-kind-class tsd-is-inherited tsd-is-external">
					<a href="eventsourceeventstream.html#nextevent" class="tsd-kind-icon">next<wbr>Event</a>
				</li>
				<li class=" tsd-kind-method tsd-parent-kind-class tsd-is-overwrite tsd-is-protected tsd-is-external">
					<a href="eventsourceeventstream.html#onreconnect" class="tsd-kind-icon">on<wbr>Reconnect</a>
				</li>
				<li class=" tsd-kind-method tsd-parent-kind-class tsd-is-overwrite tsd-is-external">
					<a href="eventsourceeventstream.html#open" class="tsd-kind-icon">open</a>
				</li>
				<li class=" tsd-kind-method tsd-parent-kind-class tsd-is-inherited tsd-is-protected tsd-is-external">
					<a href="eventsourceeventstream.html#poll" class="tsd-kind-icon">poll</a>
				</li>
				<li class=" tsd-kind-method tsd-parent-kind-class tsd-is-inherited tsd-is-protected tsd-is-external">
					<a href="eventsourceeventstream.html#reconnect" class="tsd-kind-icon">reconnect</a>
				</li>
				<li class=" tsd-kind-method tsd-parent-kind-class tsd-is-inherited tsd-is-external">
					<a href="eventsourceeventstream.html#removelistener" class="tsd-kind-icon">remove<wbr>Listener</a>
				</li>
				<li class=" tsd-kind-method tsd-parent-kind-class tsd-is-private tsd-is-external">
					<a href="eventsourceeventstream.html#reset" class="tsd-kind-icon">reset</a>
				</li>
			</ul>
		</li>
	</ul>
	...
	<div class="content-wrap">
		<section class="tsd-panel tsd-comment">
			<div class="tsd-comment tsd-typography">
				<div class="lead">
					<p>Any error against opening a stream for this class will have an error
					...
					initial request and avoids the double request in FetchStreamTransport.</p>
				</div>
			</div>
		</section>
		<section class="tsd-panel tsd-hierarchy">
			...
			<ul class="tsd-hierarchy">
				<li>
					<span class="tsd-signature-type">BaseEventStream</span><span class="tsd-signature-symbol">&lt;</span><a href="eventsourceeventstream.html" class="tsd-signature-type">EventSourceEventStream</a><span class="tsd-signature-symbol">&gt;</span>
					<ul class="tsd-hierarchy">
						<li>
							<span class="target">EventSourceEventStream</span>
						</li>
					</ul>
				</li>
			</ul>
		...
		<section class="tsd-panel">
			<h3>Implements</h3>
			<ul class="tsd-hierarchy">
				<li><span class="tsd-signature-type">EventStream</span></li>
			</ul>
		</section>
				...
				<div class="tsd-index-content">
					<section class="tsd-index-section tsd-is-external">
						...
						<ul class="tsd-index-list">
							<li class="tsd-kind-constructor tsd-parent-kind-class tsd-is-overwrite tsd-is-external"><a href="eventsourceeventstream.html#constructor" class="tsd-kind-icon">constructor</a></li>
						</ul>
					</section>
					<section class="tsd-index-section tsd-is-private-protected tsd-is-external">
						<h3>Properties</h3>
						<ul class="tsd-index-list">
							<li class="tsd-kind-property tsd-parent-kind-class tsd-is-inherited tsd-is-protected tsd-is-external"><a href="eventsourceeventstream.html#closed" class="tsd-kind-icon">closed</a></li>
							<li class="tsd-kind-property tsd-parent-kind-class tsd-is-inherited tsd-is-protected tsd-is-external"><a href="eventsourceeventstream.html#events" class="tsd-kind-icon">events</a></li>
							<li class="tsd-kind-property tsd-parent-kind-class tsd-is-private tsd-is-external"><a href="eventsourceeventstream.html#evtsrc" class="tsd-kind-icon">evt<wbr>Src</a></li>
							<li class="tsd-kind-property tsd-parent-kind-class tsd-is-inherited tsd-is-protected tsd-is-external"><a href="eventsourceeventstream.html#lasterr" class="tsd-kind-icon">last<wbr>Err</a></li>
							<li class="tsd-kind-property tsd-parent-kind-class tsd-is-inherited tsd-is-protected tsd-is-external"><a href="eventsourceeventstream.html#listeners" class="tsd-kind-icon">listeners</a></li>
							<li class="tsd-kind-property tsd-parent-kind-class tsd-is-private tsd-is-external"><a href="eventsourceeventstream.html#onopenerror" class="tsd-kind-icon">on<wbr>Open<wbr>Error</a></li>
							<li class="tsd-kind-property tsd-parent-kind-class tsd-is-private tsd-is-external"><a href="eventsourceeventstream.html#openedonce" class="tsd-kind-icon">opened<wbr>Once</a></li>
							<li class="tsd-kind-property tsd-parent-kind-class tsd-is-inherited tsd-is-protected tsd-is-static tsd-is-external"><a href="eventsourceeventstream.html#retry_timeout_millis" class="tsd-kind-icon">RETRY_<wbr>TIMEOUT_<wbr>MILLIS</a></li>
						</ul>
					</section>
					<section class="tsd-index-section tsd-is-external">
						<h3>Methods</h3>
						<ul class="tsd-index-list">
							<li class="tsd-kind-method tsd-parent-kind-class tsd-is-inherited tsd-is-external"><a href="eventsourceeventstream.html#addlistener" class="tsd-kind-icon">add<wbr>Listener</a></li>
							<li class="tsd-kind-method tsd-parent-kind-class tsd-is-overwrite tsd-is-external"><a href="eventsourceeventstream.html#afterclose" class="tsd-kind-icon">after<wbr>Close</a></li>
							<li class="tsd-kind-method tsd-parent-kind-class tsd-is-inherited tsd-is-external"><a href="eventsourceeventstream.html#close" class="tsd-kind-icon">close</a></li>
							<li class="tsd-kind-method tsd-parent-kind-class tsd-is-inherited tsd-is-external"><a href="eventsourceeventstream.html#nextevent" class="tsd-kind-icon">next<wbr>Event</a></li>
							<li class="tsd-kind-method tsd-parent-kind-class tsd-is-overwrite tsd-is-protected tsd-is-external"><a href="eventsourceeventstream.html#onreconnect" class="tsd-kind-icon">on<wbr>Reconnect</a></li>
							<li class="tsd-kind-method tsd-parent-kind-class tsd-is-overwrite tsd-is-external"><a href="eventsourceeventstream.html#open" class="tsd-kind-icon">open</a></li>
							<li class="tsd-kind-method tsd-parent-kind-class tsd-is-inherited tsd-is-protected tsd-is-external"><a href="eventsourceeventstream.html#poll" class="tsd-kind-icon">poll</a></li>
							<li class="tsd-kind-method tsd-parent-kind-class tsd-is-inherited tsd-is-protected tsd-is-external"><a href="eventsourceeventstream.html#reconnect" class="tsd-kind-icon">reconnect</a></li>
							<li class="tsd-kind-method tsd-parent-kind-class tsd-is-inherited tsd-is-external"><a href="eventsourceeventstream.html#removelistener" class="tsd-kind-icon">remove<wbr>Listener</a></li>
							<li class="tsd-kind-method tsd-parent-kind-class tsd-is-private tsd-is-external"><a href="eventsourceeventstream.html#reset" class="tsd-kind-icon">reset</a></li>
						</ul>
					</section>
				</div>
			</section>
		...
		<section class="tsd-panel-group tsd-member-group tsd-is-external">
			...
			<section class="tsd-panel tsd-member tsd-kind-constructor tsd-parent-kind-class tsd-is-overwrite tsd-is-external">
				...
				<ul class="tsd-signatures tsd-kind-constructor tsd-parent-kind-class tsd-is-overwrite tsd-is-external">
					<li class="tsd-signature tsd-kind-icon">new <wbr>Event<wbr>Source<wbr>Event<wbr>Stream<span class="tsd-signature-symbol">(</span>evtSrc<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">EventSource</span>, onOpen<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">function</span>, onOpenError<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">function</span>, reconnecter<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">undefined</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">function</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><a href="eventsourceeventstream.html" class="tsd-signature-type">EventSourceEventStream</a></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<p>Overrides BaseEventStream.__constructor</p>
							<ul>
								<li>Defined in <a href="https://github.com/mongodb/stitch-js-sdk/blob/131d8fe/packages/browser/core/src/core/internal/net/EventSourceEventStream.ts#L39">browser/core/src/core/internal/net/EventSourceEventStream.ts:39</a></li>
							</ul>
						</aside>
						<h4 class="tsd-parameters-title">Parameters</h4>
						<ul class="tsd-parameters">
							<li>
								<h5>evtSrc: <span class="tsd-signature-type">EventSource</span></h5>
							</li>
							<li>
								...
								<ul class="tsd-parameters">
									<li class="tsd-parameter-siganture">
										<ul class="tsd-signatures tsd-kind-type-literal tsd-is-not-exported">
											<li class="tsd-signature tsd-kind-icon"><span class="tsd-signature-symbol">(</span>stream<span class="tsd-signature-symbol">: </span><a href="eventsourceeventstream.html" class="tsd-signature-type">EventSourceEventStream</a><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">void</span></li>
										</ul>
										<ul class="tsd-descriptions">
											<li class="tsd-description">
												<h4 class="tsd-parameters-title">Parameters</h4>
												<ul class="tsd-parameters">
													<li>
														<h5>stream: <a href="eventsourceeventstream.html" class="tsd-signature-type">EventSourceEventStream</a></h5>
													</li>
												</ul>
							...
							<li>
								<h5>onOpenError: <span class="tsd-signature-type">function</span></h5>
								<ul class="tsd-parameters">
									<li class="tsd-parameter-siganture">
										<ul class="tsd-signatures tsd-kind-type-literal tsd-is-not-exported">
							...
							<li>
								<h5><span class="tsd-flag ts-flagOptional">Optional</span> reconnecter: <span class="tsd-signature-type">undefined</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">function</span></h5>
							</li>
						</ul>
						<h4 class="tsd-returns-title">Returns <a href="eventsourceeventstream.html" class="tsd-signature-type">EventSourceEventStream</a></h4>
					</li>
				</ul>
			</section>
		</section>
		<section class="tsd-panel-group tsd-member-group tsd-is-private-protected tsd-is-external">
			...
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-class tsd-is-inherited tsd-is-protected tsd-is-external">
				...
				<h3><span class="tsd-flag ts-flagProtected">Protected</span> closed</h3>
				...
				<aside class="tsd-sources">
					<p>Inherited from BaseEventStream.closed</p>
					<ul>
						<li>Defined in browser/core/node_modules/mongodb-stitch-core-sdk/dist/esm/internal/net/BaseEventStream.d.ts:7</li>
					</ul>
				</aside>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-class tsd-is-inherited tsd-is-protected tsd-is-external">
				<a name="events" class="tsd-anchor"></a>
				<h3><span class="tsd-flag ts-flagProtected">Protected</span> events</h3>
				<div class="tsd-signature tsd-kind-icon">events<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">Array</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">Event</span><span class="tsd-signature-symbol">&gt;</span></div>
				<aside class="tsd-sources">
					<p>Inherited from BaseEventStream.events</p>
					<ul>
						<li>Defined in browser/core/node_modules/mongodb-stitch-core-sdk/dist/esm/internal/net/BaseEventStream.d.ts:8</li>
					</ul>
				</aside>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-class tsd-is-private tsd-is-external">
				<a name="evtsrc" class="tsd-anchor"></a>
				<h3><span class="tsd-flag ts-flagPrivate">Private</span> evt<wbr>Src</h3>
				<div class="tsd-signature tsd-kind-icon">evt<wbr>Src<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">EventSource</span></div>
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/mongodb/stitch-js-sdk/blob/131d8fe/packages/browser/core/src/core/internal/net/EventSourceEventStream.ts#L37">browser/core/src/core/internal/net/EventSourceEventStream.ts:37</a></li>
					</ul>
				</aside>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-class tsd-is-inherited tsd-is-protected tsd-is-external">
				<a name="lasterr" class="tsd-anchor"></a>
				<h3><span class="tsd-flag ts-flagProtected">Protected</span> <span class="tsd-flag ts-flagOptional">Optional</span> last<wbr>Err</h3>
				<div class="tsd-signature tsd-kind-icon">last<wbr>Err<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">undefined</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">string</span></div>
				<aside class="tsd-sources">
					<p>Inherited from BaseEventStream.lastErr</p>
					<ul>
						<li>Defined in browser/core/node_modules/mongodb-stitch-core-sdk/dist/esm/internal/net/BaseEventStream.d.ts:10</li>
					</ul>
				</aside>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-class tsd-is-inherited tsd-is-protected tsd-is-external">
				...
				<div class="tsd-signature tsd-kind-icon">listeners<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">Array</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">EventListener</span><span class="tsd-signature-symbol">&gt;</span></div>
				<aside class="tsd-sources">
					<p>Inherited from BaseEventStream.listeners</p>
					<ul>
						<li>Defined in browser/core/node_modules/mongodb-stitch-core-sdk/dist/esm/internal/net/BaseEventStream.d.ts:9</li>
					</ul>
				</aside>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-class tsd-is-private tsd-is-external">
				<a name="onopenerror" class="tsd-anchor"></a>
				<h3><span class="tsd-flag ts-flagPrivate">Private</span> on<wbr>Open<wbr>Error</h3>
				<div class="tsd-signature tsd-kind-icon">on<wbr>Open<wbr>Error<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">function</span></div>
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/mongodb/stitch-js-sdk/blob/131d8fe/packages/browser/core/src/core/internal/net/EventSourceEventStream.ts#L38">browser/core/src/core/internal/net/EventSourceEventStream.ts:38</a></li>
					</ul>
				</aside>
			...
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-class tsd-is-private tsd-is-external">
				<a name="openedonce" class="tsd-anchor"></a>
				<h3><span class="tsd-flag ts-flagPrivate">Private</span> opened<wbr>Once</h3>
				<div class="tsd-signature tsd-kind-icon">opened<wbr>Once<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">boolean</span></div>
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/mongodb/stitch-js-sdk/blob/131d8fe/packages/browser/core/src/core/internal/net/EventSourceEventStream.ts#L39">browser/core/src/core/internal/net/EventSourceEventStream.ts:39</a></li>
					</ul>
			...
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-class tsd-is-inherited tsd-is-protected tsd-is-static tsd-is-external">
				<a name="retry_timeout_millis" class="tsd-anchor"></a>
				<h3><span class="tsd-flag ts-flagStatic">Static</span> <span class="tsd-flag ts-flagProtected">Protected</span> RETRY_<wbr>TIMEOUT_<wbr>MILLIS</h3>
				<div class="tsd-signature tsd-kind-icon">RETRY_<wbr>TIMEOUT_<wbr>MILLIS<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">number</span></div>
				<aside class="tsd-sources">
					<p>Inherited from BaseEventStream.RETRY_TIMEOUT_MILLIS</p>
					<ul>
						<li>Defined in browser/core/node_modules/mongodb-stitch-core-sdk/dist/esm/internal/net/BaseEventStream.d.ts:5</li>
					</ul>
				</aside>
			</section>
		</section>
		<section class="tsd-panel-group tsd-member-group tsd-is-external">
			...
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class tsd-is-inherited tsd-is-external">
				...
				<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-class tsd-is-inherited tsd-is-external">
					<li class="tsd-signature tsd-kind-icon">add<wbr>Listener<span class="tsd-signature-symbol">(</span>listener<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">EventListener</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">void</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<p>Inherited from BaseEventStream.addListener</p>
							<ul>
								<li>Defined in browser/core/node_modules/mongodb-stitch-core-sdk/dist/esm/internal/net/BaseEventStream.d.ts:17</li>
							</ul>
						</aside>
						<h4 class="tsd-parameters-title">Parameters</h4>
						<ul class="tsd-parameters">
							<li>
								<h5>listener: <span class="tsd-signature-type">EventListener</span></h5>
							</li>
						</ul>
						<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">void</span></h4>
					</li>
			...
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class tsd-is-overwrite tsd-is-external">
				<a name="afterclose" class="tsd-anchor"></a>
				<h3>after<wbr>Close</h3>
				...
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<p>Overrides BaseEventStream.afterClose</p>
							<ul>
								<li>Defined in <a href="https://github.com/mongodb/stitch-js-sdk/blob/131d8fe/packages/browser/core/src/core/internal/net/EventSourceEventStream.ts#L94">browser/core/src/core/internal/net/EventSourceEventStream.ts:94</a></li>
							</ul>
						</aside>
						<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">void</span></h4>
					</li>
			...
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class tsd-is-inherited tsd-is-external">
				...
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<p>Inherited from BaseEventStream.close</p>
							<ul>
								<li>Defined in browser/core/node_modules/mongodb-stitch-core-sdk/dist/esm/internal/net/BaseEventStream.d.ts:21</li>
							</ul>
						</aside>
						<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">void</span></h4>
					</li>
			...
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class tsd-is-inherited tsd-is-external">
				<a name="nextevent" class="tsd-anchor"></a>
				<h3>next<wbr>Event</h3>
				<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-class tsd-is-inherited tsd-is-external">
					<li class="tsd-signature tsd-kind-icon">next<wbr>Event<span class="tsd-signature-symbol">(</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">Promise</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">Event</span><span class="tsd-signature-symbol">&gt;</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<p>Inherited from BaseEventStream.nextEvent</p>
							<ul>
								<li>Defined in browser/core/node_modules/mongodb-stitch-core-sdk/dist/esm/internal/net/BaseEventStream.d.ts:20</li>
							</ul>
						</aside>
						<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">Promise</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">Event</span><span class="tsd-signature-symbol">&gt;</span></h4>
					</li>
				</ul>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class tsd-is-overwrite tsd-is-protected tsd-is-external">
				<a name="onreconnect" class="tsd-anchor"></a>
				<h3><span class="tsd-flag ts-flagProtected">Protected</span> on<wbr>Reconnect</h3>
				<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-class tsd-is-overwrite tsd-is-protected tsd-is-external">
					<li class="tsd-signature tsd-kind-icon">on<wbr>Reconnect<span class="tsd-signature-symbol">(</span>next<span class="tsd-signature-symbol">: </span><a href="eventsourceeventstream.html" class="tsd-signature-type">EventSourceEventStream</a><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">void</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<p>Overrides BaseEventStream.onReconnect</p>
							<ul>
								<li>Defined in <a href="https://github.com/mongodb/stitch-js-sdk/blob/131d8fe/packages/browser/core/src/core/internal/net/EventSourceEventStream.ts#L88">browser/core/src/core/internal/net/EventSourceEventStream.ts:88</a></li>
							</ul>
						</aside>
						<h4 class="tsd-parameters-title">Parameters</h4>
						<ul class="tsd-parameters">
							<li>
								<h5>next: <a href="eventsourceeventstream.html" class="tsd-signature-type">EventSourceEventStream</a></h5>
							</li>
						</ul>
						<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">void</span></h4>
					</li>
			...
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class tsd-is-overwrite tsd-is-external">
				...
				<h3>open</h3>
				<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-class tsd-is-overwrite tsd-is-external">
					<li class="tsd-signature tsd-kind-icon">open<span class="tsd-signature-symbol">(</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">void</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<p>Overrides BaseEventStream.open</p>
							<ul>
								<li>Defined in <a href="https://github.com/mongodb/stitch-js-sdk/blob/131d8fe/packages/browser/core/src/core/internal/net/EventSourceEventStream.ts#L59">browser/core/src/core/internal/net/EventSourceEventStream.ts:59</a></li>
							</ul>
						</aside>
						<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">void</span></h4>
					</li>
			...
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class tsd-is-inherited tsd-is-protected tsd-is-external">
				...
				<h3><span class="tsd-flag ts-flagProtected">Protected</span> poll</h3>
				<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-class tsd-is-inherited tsd-is-protected tsd-is-external">
					<li class="tsd-signature tsd-kind-icon">poll<span class="tsd-signature-symbol">(</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">void</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<p>Inherited from BaseEventStream.poll</p>
							<ul>
								<li>Defined in browser/core/node_modules/mongodb-stitch-core-sdk/dist/esm/internal/net/BaseEventStream.d.ts:16</li>
							</ul>
						</aside>
						<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">void</span></h4>
					</li>
			...
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class tsd-is-inherited tsd-is-protected tsd-is-external">
				...
				<h3><span class="tsd-flag ts-flagProtected">Protected</span> reconnect</h3>
				<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-class tsd-is-inherited tsd-is-protected tsd-is-external">
					<li class="tsd-signature tsd-kind-icon">reconnect<span class="tsd-signature-symbol">(</span>error<span class="tsd-signature-symbol">?: </span><a href="stitcherror.html#error" class="tsd-signature-type">Error</a><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">void</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<p>Inherited from BaseEventStream.reconnect</p>
							<ul>
								<li>Defined in browser/core/node_modules/mongodb-stitch-core-sdk/dist/esm/internal/net/BaseEventStream.d.ts:15</li>
							</ul>
						</aside>
						<h4 class="tsd-parameters-title">Parameters</h4>
						<ul class="tsd-parameters">
							<li>
								<h5><span class="tsd-flag ts-flagOptional">Optional</span> error: <a href="stitcherror.html#error" class="tsd-signature-type">Error</a></h5>
							</li>
						</ul>
						<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">void</span></h4>
					</li>
			...
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class tsd-is-inherited tsd-is-external">
				...
				<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-class tsd-is-inherited tsd-is-external">
					<li class="tsd-signature tsd-kind-icon">remove<wbr>Listener<span class="tsd-signature-symbol">(</span>listener<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">EventListener</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">void</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<p>Inherited from BaseEventStream.removeListener</p>
							<ul>
								<li>Defined in browser/core/node_modules/mongodb-stitch-core-sdk/dist/esm/internal/net/BaseEventStream.d.ts:18</li>
							</ul>
						</aside>
						<h4 class="tsd-parameters-title">Parameters</h4>
						<ul class="tsd-parameters">
			...
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class tsd-is-private tsd-is-external">
				...
				<h3><span class="tsd-flag ts-flagPrivate">Private</span> reset</h3>
				...
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/mongodb/stitch-js-sdk/blob/131d8fe/packages/browser/core/src/core/internal/net/EventSourceEventStream.ts#L65">browser/core/src/core/internal/net/EventSourceEventStream.ts:65</a></li>
							</ul>
						</aside>
						<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">void</span></h4>
					</li>
