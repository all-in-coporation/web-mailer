...
<head>
	...
	<title>Stitch | MongoDB Stitch React Native SDK</title>
...
<nav class="tsd-navigation secondary">
	<ul>
		<li class="current tsd-kind-class tsd-is-external">
			<a href="stitch.html" class="tsd-kind-icon">Stitch</a>
			<ul>
				<li class=" tsd-kind-property tsd-parent-kind-class tsd-is-private tsd-is-static tsd-is-external">
					<a href="stitch.html#defaultclientappid" class="tsd-kind-icon">default<wbr>Client<wbr>App<wbr>Id</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-class tsd-is-private tsd-is-static tsd-is-external">
					<a href="stitch.html#localappname" class="tsd-kind-icon">local<wbr>App<wbr>Name</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-class tsd-is-private tsd-is-static tsd-is-external">
					<a href="stitch.html#localappversion" class="tsd-kind-icon">local<wbr>App<wbr>Version</a>
				</li>
				<li class=" tsd-kind-get-signature tsd-parent-kind-class tsd-is-static tsd-is-external">
					<a href="stitch.html#defaultappclient" class="tsd-kind-icon">default<wbr>App<wbr>Client</a>
				</li>
				<li class=" tsd-kind-method tsd-parent-kind-class tsd-is-static tsd-is-external">
					<a href="stitch.html#getappclient" class="tsd-kind-icon">get<wbr>App<wbr>Client</a>
				</li>
				<li class=" tsd-kind-method tsd-parent-kind-class tsd-is-static tsd-is-external">
					<a href="stitch.html#hasappclient" class="tsd-kind-icon">has<wbr>App<wbr>Client</a>
				</li>
				<li class=" tsd-kind-method tsd-parent-kind-class tsd-is-static tsd-is-external">
					<a href="stitch.html#initializeappclient" class="tsd-kind-icon">initialize<wbr>App<wbr>Client</a>
				</li>
				<li class=" tsd-kind-method tsd-parent-kind-class tsd-is-static tsd-is-external">
					<a href="stitch.html#initializedefaultappclient" class="tsd-kind-icon">initialize<wbr>Default<wbr>App<wbr>Client</a>
				</li>
			</ul>
		</li>
	</ul>
	...
	<div class="content-wrap">
		<section class="tsd-panel tsd-comment">
			<div class="tsd-comment tsd-typography">
				<div class="lead">
					<p>Singleton class with static utility functions for initializing the MongoDB
					Stitch Browser SDK, and for retrieving a <a href="../interfaces/stitchappclient.html">StitchAppClient</a>.</p>
				</div>
			</div>
		</section>
				...
				<div class="tsd-index-content">
					<section class="tsd-index-section tsd-is-private tsd-is-private-protected tsd-is-external">
						...
						<ul class="tsd-index-list">
							<li class="tsd-kind-property tsd-parent-kind-class tsd-is-private tsd-is-static tsd-is-external"><a href="stitch.html#defaultclientappid" class="tsd-kind-icon">default<wbr>Client<wbr>App<wbr>Id</a></li>
							<li class="tsd-kind-property tsd-parent-kind-class tsd-is-private tsd-is-static tsd-is-external"><a href="stitch.html#localappname" class="tsd-kind-icon">local<wbr>App<wbr>Name</a></li>
							<li class="tsd-kind-property tsd-parent-kind-class tsd-is-private tsd-is-static tsd-is-external"><a href="stitch.html#localappversion" class="tsd-kind-icon">local<wbr>App<wbr>Version</a></li>
						</ul>
					</section>
					<section class="tsd-index-section tsd-is-external">
						<h3>Accessors</h3>
						<ul class="tsd-index-list">
							<li class="tsd-kind-get-signature tsd-parent-kind-class tsd-is-static tsd-is-external"><a href="stitch.html#defaultappclient" class="tsd-kind-icon">default<wbr>App<wbr>Client</a></li>
						</ul>
					</section>
					<section class="tsd-index-section tsd-is-external">
						<h3>Methods</h3>
						<ul class="tsd-index-list">
							<li class="tsd-kind-method tsd-parent-kind-class tsd-is-static tsd-is-external"><a href="stitch.html#getappclient" class="tsd-kind-icon">get<wbr>App<wbr>Client</a></li>
							<li class="tsd-kind-method tsd-parent-kind-class tsd-is-static tsd-is-external"><a href="stitch.html#hasappclient" class="tsd-kind-icon">has<wbr>App<wbr>Client</a></li>
							<li class="tsd-kind-method tsd-parent-kind-class tsd-is-static tsd-is-external"><a href="stitch.html#initializeappclient" class="tsd-kind-icon">initialize<wbr>App<wbr>Client</a></li>
							<li class="tsd-kind-method tsd-parent-kind-class tsd-is-static tsd-is-external"><a href="stitch.html#initializedefaultappclient" class="tsd-kind-icon">initialize<wbr>Default<wbr>App<wbr>Client</a></li>
						</ul>
					</section>
				</div>
			</section>
		...
		<section class="tsd-panel-group tsd-member-group tsd-is-private tsd-is-private-protected tsd-is-external">
			...
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-class tsd-is-private tsd-is-static tsd-is-external">
				<a name="defaultclientappid" class="tsd-anchor"></a>
				<h3><span class="tsd-flag ts-flagStatic">Static</span> <span class="tsd-flag ts-flagPrivate">Private</span> default<wbr>Client<wbr>App<wbr>Id</h3>
				<div class="tsd-signature tsd-kind-icon">default<wbr>Client<wbr>App<wbr>Id<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">string</span></div>
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/mongodb/stitch-js-sdk/blob/131d8fe/packages/react-native/core/src/core/Stitch.ts#L158">react-native/core/src/core/Stitch.ts:158</a></li>
					</ul>
				</aside>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-class tsd-is-private tsd-is-static tsd-is-external">
				<a name="localappname" class="tsd-anchor"></a>
				<h3><span class="tsd-flag ts-flagStatic">Static</span> <span class="tsd-flag ts-flagPrivate">Private</span> local<wbr>App<wbr>Name</h3>
				...
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/mongodb/stitch-js-sdk/blob/131d8fe/packages/react-native/core/src/core/Stitch.ts#L159">react-native/core/src/core/Stitch.ts:159</a></li>
					</ul>
				</aside>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-class tsd-is-private tsd-is-static tsd-is-external">
				<a name="localappversion" class="tsd-anchor"></a>
				<h3><span class="tsd-flag ts-flagStatic">Static</span> <span class="tsd-flag ts-flagPrivate">Private</span> local<wbr>App<wbr>Version</h3>
				...
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/mongodb/stitch-js-sdk/blob/131d8fe/packages/react-native/core/src/core/Stitch.ts#L157">react-native/core/src/core/Stitch.ts:157</a></li>
					</ul>
				</aside>
			</section>
		</section>
		<section class="tsd-panel-group tsd-member-group tsd-is-external">
			...
			<section class="tsd-panel tsd-member tsd-kind-get-signature tsd-parent-kind-class tsd-is-static tsd-is-external">
				<a name="defaultappclient" class="tsd-anchor"></a>
				<h3><span class="tsd-flag ts-flagStatic">Static</span> default<wbr>App<wbr>Client</h3>
				<div class="tsd-signature tsd-kind-icon">default<wbr>App<wbr>Client<span class="tsd-signature-symbol">:</span> </div>
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/mongodb/stitch-js-sdk/blob/131d8fe/packages/react-native/core/src/core/Stitch.ts#L37">react-native/core/src/core/Stitch.ts:37</a></li>
					</ul>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>Retrieves the default StitchAppClient associated with the application.</p>
					</div>
				</div>
			</section>
		</section>
		<section class="tsd-panel-group tsd-member-group tsd-is-external">
			...
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class tsd-is-static tsd-is-external">
				<a name="getappclient" class="tsd-anchor"></a>
				<h3><span class="tsd-flag ts-flagStatic">Static</span> get<wbr>App<wbr>Client</h3>
				<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-class tsd-is-static tsd-is-external">
					<li class="tsd-signature tsd-kind-icon">get<wbr>App<wbr>Client<span class="tsd-signature-symbol">(</span>clientAppId<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><a href="../interfaces/stitchappclient.html" class="tsd-signature-type">StitchAppClient</a></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/mongodb/stitch-js-sdk/blob/131d8fe/packages/react-native/core/src/core/Stitch.ts#L48">react-native/core/src/core/Stitch.ts:48</a></li>
							</ul>
						</aside>
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>Retrieves the StitchAppClient associated with the specified client app id.</p>
							</div>
						</div>
						...
						<ul class="tsd-parameters">
							<li>
								...
								<div class="tsd-comment tsd-typography">
									<p>The client app id of the desired app client.</p>
								</div>
							</li>
						</ul>
						<h4 class="tsd-returns-title">Returns <a href="../interfaces/stitchappclient.html" class="tsd-signature-type">StitchAppClient</a></h4>
					</li>
				</ul>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class tsd-is-static tsd-is-external">
				<a name="hasappclient" class="tsd-anchor"></a>
				<h3><span class="tsd-flag ts-flagStatic">Static</span> has<wbr>App<wbr>Client</h3>
				<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-class tsd-is-static tsd-is-external">
					<li class="tsd-signature tsd-kind-icon">has<wbr>App<wbr>Client<span class="tsd-signature-symbol">(</span>clientAppId<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">boolean</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/mongodb/stitch-js-sdk/blob/131d8fe/packages/react-native/core/src/core/Stitch.ts#L63">react-native/core/src/core/Stitch.ts:63</a></li>
							</ul>
						</aside>
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>Returns whether or not a StitchAppClient has been initialized for the
								specified clientAppId</p>
							</div>
						</div>
						<h4 class="tsd-parameters-title">Parameters</h4>
						<ul class="tsd-parameters">
							<li>
								<h5>clientAppId: <span class="tsd-signature-type">string</span></h5>
								<div class="tsd-comment tsd-typography">
									<p>The client app id to check for.</p>
								</div>
							</li>
						</ul>
			...
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class tsd-is-static tsd-is-external">
				<a name="initializeappclient" class="tsd-anchor"></a>
				<h3><span class="tsd-flag ts-flagStatic">Static</span> initialize<wbr>App<wbr>Client</h3>
				<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-class tsd-is-static tsd-is-external">
					<li class="tsd-signature tsd-kind-icon">initialize<wbr>App<wbr>Client<span class="tsd-signature-symbol">(</span>clientAppId<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span>, config<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">StitchAppClientConfiguration</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">Promise</span><span class="tsd-signature-symbol">&lt;</span><a href="../interfaces/stitchappclient.html" class="tsd-signature-type">StitchAppClient</a><span class="tsd-signature-symbol">&gt;</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/mongodb/stitch-js-sdk/blob/131d8fe/packages/react-native/core/src/core/Stitch.ts#L104">react-native/core/src/core/Stitch.ts:104</a></li>
							</ul>
						</aside>
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>Initializes a new, non-default StitchAppClient associated with the
								application.</p>
							</div>
						</div>
						<h4 class="tsd-parameters-title">Parameters</h4>
						<ul class="tsd-parameters">
							<li>
								<h5>clientAppId: <span class="tsd-signature-type">string</span></h5>
								<div class="tsd-comment tsd-typography">
									<p>The desired clientAppId for the client.</p>
								</div>
							</li>
							<li>
								<h5><span class="tsd-flag ts-flagDefault value">Default value</span> config: <span class="tsd-signature-type">StitchAppClientConfiguration</span><span class="tsd-signature-symbol"> =&nbsp;new StitchAppClientConfiguration.Builder().build()</span></h5>
								<div class="tsd-comment tsd-typography">
									<p>Additional configuration options (optional).</p>
								</div>
							</li>
						</ul>
						<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">Promise</span><span class="tsd-signature-symbol">&lt;</span><a href="../interfaces/stitchappclient.html" class="tsd-signature-type">StitchAppClient</a><span class="tsd-signature-symbol">&gt;</span></h4>
						<p>A Promise resolving to an initialized StitchAppClient.</p>
					</li>
				</ul>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class tsd-is-static tsd-is-external">
				<a name="initializedefaultappclient" class="tsd-anchor"></a>
				<h3><span class="tsd-flag ts-flagStatic">Static</span> initialize<wbr>Default<wbr>App<wbr>Client</h3>
				<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-class tsd-is-static tsd-is-external">
					<li class="tsd-signature tsd-kind-icon">initialize<wbr>Default<wbr>App<wbr>Client<span class="tsd-signature-symbol">(</span>clientAppId<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span>, config<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">StitchAppClientConfiguration</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">Promise</span><span class="tsd-signature-symbol">&lt;</span><a href="../interfaces/stitchappclient.html" class="tsd-signature-type">StitchAppClient</a><span class="tsd-signature-symbol">&gt;</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/mongodb/stitch-js-sdk/blob/131d8fe/packages/react-native/core/src/core/Stitch.ts#L74">react-native/core/src/core/Stitch.ts:74</a></li>
							</ul>
						</aside>
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>Initializes the default StitchAppClient associated with the application.</p>
							</div>
						</div>
						<h4 class="tsd-parameters-title">Parameters</h4>
						<ul class="tsd-parameters">
