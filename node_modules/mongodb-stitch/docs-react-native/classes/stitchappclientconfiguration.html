...
<head>
	...
	<title>StitchAppClientConfiguration | MongoDB Stitch React Native SDK</title>
	...
	<div class="content-wrap">
		<section class="tsd-panel tsd-comment">
			<div class="tsd-comment tsd-typography">
				<div class="lead">
					<p>Properties representing the configuration of a client that communicate with
					a particular MongoDB Stitch application.</p>
				</div>
			</div>
		</section>
		<section class="tsd-panel tsd-hierarchy">
			...
			<ul class="tsd-hierarchy">
				<li>
					<span class="tsd-signature-type">StitchClientConfiguration</span>
					<ul class="tsd-hierarchy">
						<li>
							<span class="target">StitchAppClientConfiguration</span>
						</li>
					</ul>
				</li>
			</ul>
				...
				<div class="tsd-index-content">
					<section class="tsd-index-section tsd-is-external">
						...
						<ul class="tsd-index-list">
							<li class="tsd-kind-class tsd-parent-kind-class tsd-is-external"><a href="stitchappclientconfiguration.builder.html" class="tsd-kind-icon">Builder</a></li>
						</ul>
					</section>
					<section class="tsd-index-section tsd-is-external">
						<h3>Constructors</h3>
						<ul class="tsd-index-list">
							<li class="tsd-kind-constructor tsd-parent-kind-class tsd-is-overwrite tsd-is-external"><a href="stitchappclientconfiguration.html#constructor" class="tsd-kind-icon">constructor</a></li>
						</ul>
					</section>
					<section class="tsd-index-section tsd-is-external">
						<h3>Properties</h3>
						<ul class="tsd-index-list">
							<li class="tsd-kind-property tsd-parent-kind-class tsd-is-inherited tsd-is-external"><a href="stitchappclientconfiguration.html#baseurl" class="tsd-kind-icon">base<wbr>Url</a></li>
							<li class="tsd-kind-property tsd-parent-kind-class tsd-is-inherited tsd-is-external"><a href="stitchappclientconfiguration.html#datadirectory" class="tsd-kind-icon">data<wbr>Directory</a></li>
							<li class="tsd-kind-property tsd-parent-kind-class tsd-is-external"><a href="stitchappclientconfiguration.html#localappname" class="tsd-kind-icon">local<wbr>App<wbr>Name</a></li>
							<li class="tsd-kind-property tsd-parent-kind-class tsd-is-external"><a href="stitchappclientconfiguration.html#localappversion" class="tsd-kind-icon">local<wbr>App<wbr>Version</a></li>
							<li class="tsd-kind-property tsd-parent-kind-class tsd-is-inherited tsd-is-external"><a href="stitchappclientconfiguration.html#storage" class="tsd-kind-icon">storage</a></li>
							<li class="tsd-kind-property tsd-parent-kind-class tsd-is-inherited tsd-is-external"><a href="stitchappclientconfiguration.html#transport" class="tsd-kind-icon">transport</a></li>
						</ul>
					</section>
					<section class="tsd-index-section tsd-is-external">
						<h3>Methods</h3>
						<ul class="tsd-index-list">
							<li class="tsd-kind-method tsd-parent-kind-class tsd-is-overwrite tsd-is-external"><a href="stitchappclientconfiguration.html#builder-1" class="tsd-kind-icon">builder</a></li>
						</ul>
					</section>
				</div>
			</section>
		...
		<section class="tsd-panel-group tsd-member-group tsd-is-external">
			...
			<section class="tsd-panel tsd-member tsd-kind-constructor tsd-parent-kind-class tsd-is-overwrite tsd-is-external">
				...
				<ul class="tsd-signatures tsd-kind-constructor tsd-parent-kind-class tsd-is-overwrite tsd-is-external">
					<li class="tsd-signature tsd-kind-icon">new <wbr>Stitch<wbr>App<wbr>Client<wbr>Configuration<span class="tsd-signature-symbol">(</span>config<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">StitchClientConfiguration</span>, localAppName<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span>, localAppVersion<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><a href="stitchappclientconfiguration.html" class="tsd-signature-type">StitchAppClientConfiguration</a></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<p>Overrides StitchClientConfiguration.__constructor</p>
							<ul>
								<li>Defined in <a href="https://github.com/mongodb/stitch-js-sdk/blob/131d8fe/packages/core/sdk/src/StitchAppClientConfiguration.ts#L33">core/sdk/src/StitchAppClientConfiguration.ts:33</a></li>
							</ul>
						</aside>
						<h4 class="tsd-parameters-title">Parameters</h4>
						<ul class="tsd-parameters">
							<li>
								<h5>config: <span class="tsd-signature-type">StitchClientConfiguration</span></h5>
							</li>
							<li>
		...
		<section class="tsd-panel-group tsd-member-group tsd-is-external">
			...
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-class tsd-is-inherited tsd-is-external">
				...
				<aside class="tsd-sources">
					<p>Inherited from StitchClientConfiguration.baseUrl</p>
					<ul>
						<li>Defined in <a href="https://github.com/mongodb/stitch-js-sdk/blob/131d8fe/packages/core/sdk/src/StitchClientConfiguration.ts#L26">core/sdk/src/StitchClientConfiguration.ts:26</a></li>
					</ul>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>The base URL of the Stitch server that the client will communicate with.</p>
					</div>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-class tsd-is-inherited tsd-is-external">
				...
				<aside class="tsd-sources">
					<p>Inherited from StitchClientConfiguration.dataDirectory</p>
					<ul>
						<li>Defined in <a href="https://github.com/mongodb/stitch-js-sdk/blob/131d8fe/packages/core/sdk/src/StitchClientConfiguration.ts#L36">core/sdk/src/StitchClientConfiguration.ts:36</a></li>
					</ul>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>The local directory in which Stitch can store any data (e.g. embedded MongoDB data directory).</p>
					</div>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-class tsd-is-external">
				...
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/mongodb/stitch-js-sdk/blob/131d8fe/packages/core/sdk/src/StitchAppClientConfiguration.ts#L28">core/sdk/src/StitchAppClientConfiguration.ts:28</a></li>
					</ul>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>The name of the local application.</p>
					</div>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-class tsd-is-external">
				...
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>The current version of the local application.</p>
					</div>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-class tsd-is-inherited tsd-is-external">
				...
				<aside class="tsd-sources">
					<p>Inherited from StitchClientConfiguration.storage</p>
					<ul>
						<li>Defined in <a href="https://github.com/mongodb/stitch-js-sdk/blob/131d8fe/packages/core/sdk/src/StitchClientConfiguration.ts#L31">core/sdk/src/StitchClientConfiguration.ts:31</a></li>
					</ul>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>The underlying storage for persisting authentication and app state.</p>
					</div>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-class tsd-is-inherited tsd-is-external">
				...
				<aside class="tsd-sources">
					<p>Inherited from StitchClientConfiguration.transport</p>
					<ul>
						<li>Defined in <a href="https://github.com/mongodb/stitch-js-sdk/blob/131d8fe/packages/core/sdk/src/StitchClientConfiguration.ts#L41">core/sdk/src/StitchClientConfiguration.ts:41</a></li>
					</ul>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>The <code>Transport</code> that the client will use to make HTTP round trips to the Stitch server.</p>
					</div>
				</div>
			</section>
		</section>
		<section class="tsd-panel-group tsd-member-group tsd-is-external">
			...
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class tsd-is-overwrite tsd-is-external">
				<a name="builder-1" class="tsd-anchor"></a>
				<h3>builder</h3>
				<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-class tsd-is-overwrite tsd-is-external">
					<li class="tsd-signature tsd-kind-icon">builder<span class="tsd-signature-symbol">(</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><a href="stitchappclientconfiguration.builder.html" class="tsd-signature-type">Builder</a></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<p>Overrides StitchClientConfiguration.builder</p>
							<ul>
								<li>Defined in <a href="https://github.com/mongodb/stitch-js-sdk/blob/131d8fe/packages/core/sdk/src/StitchAppClientConfiguration.ts#L50">core/sdk/src/StitchAppClientConfiguration.ts:50</a></li>
							</ul>
						</aside>
