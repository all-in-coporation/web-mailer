...
<head>
	...
	<title>StitchRequestError | MongoDB Stitch React Native SDK</title>
...
<nav class="tsd-navigation secondary">
	<ul>
		<li class="current tsd-kind-class tsd-is-external">
			<a href="stitchrequesterror.html" class="tsd-kind-icon">Stitch<wbr>Request<wbr>Error</a>
			<ul>
				<li class=" tsd-kind-constructor tsd-parent-kind-class tsd-is-external">
					<a href="stitchrequesterror.html#constructor" class="tsd-kind-icon">constructor</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-class tsd-is-external">
					<a href="stitchrequesterror.html#errorcode" class="tsd-kind-icon">error<wbr>Code</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-class tsd-is-external">
					<a href="stitchrequesterror.html#errorcodename" class="tsd-kind-icon">error<wbr>Code<wbr>Name</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-class tsd-is-external">
					<a href="stitchrequesterror.html#underlyingerror" class="tsd-kind-icon">underlying<wbr>Error</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-class tsd-is-inherited tsd-is-static tsd-is-external">
					<a href="stitchrequesterror.html#message" class="tsd-kind-icon">message</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-class tsd-is-inherited tsd-is-static tsd-is-external">
					<a href="stitchrequesterror.html#name" class="tsd-kind-icon">name</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-class tsd-is-overwrite tsd-is-inherited tsd-is-static tsd-is-external">
					<a href="stitchrequesterror.html#stack" class="tsd-kind-icon">stack</a>
				</li>
			</ul>
		</li>
	</ul>
	...
	<div class="content-wrap">
		<section class="tsd-panel tsd-comment">
			<div class="tsd-comment tsd-typography">
				<div class="lead">
					<p>Indicates that an error occurred while a request was being carried out. This could be due to (but
					...
					is typically an Error thrown internally by the Stitch SDK.</p>
				</div>
			</div>
		</section>
		<section class="tsd-panel tsd-hierarchy">
			...
			<ul class="tsd-hierarchy">
				<li>
					<a href="stitcherror.html" class="tsd-signature-type">StitchError</a>
					<ul class="tsd-hierarchy">
						<li>
							<span class="target">StitchRequestError</span>
						</li>
					</ul>
				</li>
			</ul>
				...
				<div class="tsd-index-content">
					<section class="tsd-index-section tsd-is-external">
						...
						<ul class="tsd-index-list">
							<li class="tsd-kind-constructor tsd-parent-kind-class tsd-is-external"><a href="stitchrequesterror.html#constructor" class="tsd-kind-icon">constructor</a></li>
						</ul>
					</section>
					<section class="tsd-index-section tsd-is-external">
						<h3>Properties</h3>
						<ul class="tsd-index-list">
							<li class="tsd-kind-property tsd-parent-kind-class tsd-is-external"><a href="stitchrequesterror.html#errorcode" class="tsd-kind-icon">error<wbr>Code</a></li>
							<li class="tsd-kind-property tsd-parent-kind-class tsd-is-external"><a href="stitchrequesterror.html#errorcodename" class="tsd-kind-icon">error<wbr>Code<wbr>Name</a></li>
							<li class="tsd-kind-property tsd-parent-kind-class tsd-is-external"><a href="stitchrequesterror.html#underlyingerror" class="tsd-kind-icon">underlying<wbr>Error</a></li>
							<li class="tsd-kind-property tsd-parent-kind-class tsd-is-inherited tsd-is-static tsd-is-external"><a href="stitchrequesterror.html#message" class="tsd-kind-icon">message</a></li>
							<li class="tsd-kind-property tsd-parent-kind-class tsd-is-inherited tsd-is-static tsd-is-external"><a href="stitchrequesterror.html#name" class="tsd-kind-icon">name</a></li>
							<li class="tsd-kind-property tsd-parent-kind-class tsd-is-overwrite tsd-is-inherited tsd-is-static tsd-is-external"><a href="stitchrequesterror.html#stack" class="tsd-kind-icon">stack</a></li>
						</ul>
					</section>
				</div>
			</section>
		...
		<section class="tsd-panel-group tsd-member-group tsd-is-external">
			...
			<section class="tsd-panel tsd-member tsd-kind-constructor tsd-parent-kind-class tsd-is-external">
				...
				<ul class="tsd-signatures tsd-kind-constructor tsd-parent-kind-class tsd-is-external">
					<li class="tsd-signature tsd-kind-icon">new <wbr>Stitch<wbr>Request<wbr>Error<span class="tsd-signature-symbol">(</span>underlyingError<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">Error</span>, errorCode<span class="tsd-signature-symbol">: </span><a href="../enums/stitchrequesterrorcode.html" class="tsd-signature-type">StitchRequestErrorCode</a><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><a href="stitchrequesterror.html" class="tsd-signature-type">StitchRequestError</a></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/mongodb/stitch-js-sdk/blob/131d8fe/packages/core/sdk/src/StitchRequestError.ts#L48">core/sdk/src/StitchRequestError.ts:48</a></li>
							</ul>
						</aside>
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>Constructs a request exception from the underlying exception and error code.</p>
							</div>
						</div>
						<h4 class="tsd-parameters-title">Parameters</h4>
						<ul class="tsd-parameters">
							<li>
								<h5>underlyingError: <span class="tsd-signature-type">Error</span></h5>
							</li>
							<li>
								<h5>errorCode: <a href="../enums/stitchrequesterrorcode.html" class="tsd-signature-type">StitchRequestErrorCode</a></h5>
							</li>
						</ul>
						<h4 class="tsd-returns-title">Returns <a href="stitchrequesterror.html" class="tsd-signature-type">StitchRequestError</a></h4>
					</li>
				</ul>
			</section>
		</section>
		<section class="tsd-panel-group tsd-member-group tsd-is-external">
			...
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-class tsd-is-external">
				...
				<div class="tsd-signature tsd-kind-icon">error<wbr>Code<span class="tsd-signature-symbol">:</span> <a href="../enums/stitchrequesterrorcode.html" class="tsd-signature-type">StitchRequestErrorCode</a></div>
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/mongodb/stitch-js-sdk/blob/131d8fe/packages/core/sdk/src/StitchRequestError.ts#L37">core/sdk/src/StitchRequestError.ts:37</a></li>
					</ul>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>The <a href="../enums/stitchrequesterrorcode.html">StitchRequestErrorCode</a> indicating the reason for this
						exception.</p>
					</div>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-class tsd-is-external">
				<a name="errorcodename" class="tsd-anchor"></a>
				<h3>error<wbr>Code<wbr>Name</h3>
				<div class="tsd-signature tsd-kind-icon">error<wbr>Code<wbr>Name<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">string</span></div>
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/mongodb/stitch-js-sdk/blob/131d8fe/packages/core/sdk/src/StitchRequestError.ts#L43">core/sdk/src/StitchRequestError.ts:43</a></li>
					</ul>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>The name of the <a href="../enums/stitchrequesterrorcode.html">StitchRequestErrorCode</a> indicating the reason for this
						exception.</p>
					</div>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-class tsd-is-external">
				<a name="underlyingerror" class="tsd-anchor"></a>
				<h3>underlying<wbr>Error</h3>
				<div class="tsd-signature tsd-kind-icon">underlying<wbr>Error<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">Error</span></div>
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/mongodb/stitch-js-sdk/blob/131d8fe/packages/core/sdk/src/StitchRequestError.ts#L48">core/sdk/src/StitchRequestError.ts:48</a></li>
					</ul>
				...
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>The underlying Error that caused this request exception.</p>
					</div>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-class tsd-is-inherited tsd-is-static tsd-is-external">
				...
				<aside class="tsd-sources">
					...
					<ul>
						<li>Defined in /Users/eric/stitch/stitch-js-sdk/node_modules/typedoc/node_modules/typescript/lib/lib.es5.d.ts:886</li>
					</ul>
				</aside>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-class tsd-is-inherited tsd-is-static tsd-is-external">
				...
				<aside class="tsd-sources">
					...
					<ul>
						<li>Defined in /Users/eric/stitch/stitch-js-sdk/node_modules/typedoc/node_modules/typescript/lib/lib.es5.d.ts:885</li>
					</ul>
				</aside>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-class tsd-is-overwrite tsd-is-inherited tsd-is-static tsd-is-external">
				...
				<aside class="tsd-sources">
					...
					<ul>
						<li>Defined in /Users/eric/stitch/stitch-js-sdk/node_modules/typedoc/node_modules/typescript/lib/lib.es5.d.ts:887</li>
					</ul>
				</aside>
			</section>
		</section>
