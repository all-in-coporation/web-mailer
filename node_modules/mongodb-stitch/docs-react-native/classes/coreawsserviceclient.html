...
<head>
	...
	<title>CoreAwsServiceClient | MongoDB Stitch React Native SDK</title>
...
<nav class="tsd-navigation secondary">
	<ul>
		<li class="current tsd-kind-class tsd-is-external">
			<a href="coreawsserviceclient.html" class="tsd-kind-icon">Core<wbr>Aws<wbr>Service<wbr>Client</a>
			<ul>
				<li class=" tsd-kind-constructor tsd-parent-kind-class tsd-is-external">
					<a href="coreawsserviceclient.html#constructor" class="tsd-kind-icon">constructor</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-class tsd-is-private tsd-is-external">
					<a href="coreawsserviceclient.html#service" class="tsd-kind-icon">service</a>
				</li>
				<li class=" tsd-kind-method tsd-parent-kind-class tsd-has-type-parameter tsd-is-external">
					<a href="coreawsserviceclient.html#execute" class="tsd-kind-icon">execute</a>
				</li>
				<li class=" tsd-kind-method tsd-parent-kind-class tsd-is-private tsd-is-external">
					<a href="coreawsserviceclient.html#getrequestargs" class="tsd-kind-icon">get<wbr>Request<wbr>Args</a>
				</li>
			</ul>
		</li>
	</ul>
	...
	<div class="content-wrap">
		<section class="tsd-panel tsd-hierarchy">
			...
			<ul class="tsd-hierarchy">
				<li>
					<span class="target">CoreAwsServiceClient</span>
				</li>
			</ul>
		</section>
				...
				<div class="tsd-index-content">
					<section class="tsd-index-section tsd-is-external">
						...
						<ul class="tsd-index-list">
							<li class="tsd-kind-constructor tsd-parent-kind-class tsd-is-external"><a href="coreawsserviceclient.html#constructor" class="tsd-kind-icon">constructor</a></li>
						</ul>
					</section>
					<section class="tsd-index-section tsd-is-private tsd-is-private-protected tsd-is-external">
						<h3>Properties</h3>
						<ul class="tsd-index-list">
							<li class="tsd-kind-property tsd-parent-kind-class tsd-is-private tsd-is-external"><a href="coreawsserviceclient.html#service" class="tsd-kind-icon">service</a></li>
						</ul>
					</section>
					<section class="tsd-index-section tsd-is-external">
						<h3>Methods</h3>
						<ul class="tsd-index-list">
							<li class="tsd-kind-method tsd-parent-kind-class tsd-has-type-parameter tsd-is-external"><a href="coreawsserviceclient.html#execute" class="tsd-kind-icon">execute</a></li>
							<li class="tsd-kind-method tsd-parent-kind-class tsd-is-private tsd-is-external"><a href="coreawsserviceclient.html#getrequestargs" class="tsd-kind-icon">get<wbr>Request<wbr>Args</a></li>
						</ul>
					</section>
				</div>
			</section>
		...
		<section class="tsd-panel-group tsd-member-group tsd-is-external">
			...
			<section class="tsd-panel tsd-member tsd-kind-constructor tsd-parent-kind-class tsd-is-external">
				...
				<ul class="tsd-signatures tsd-kind-constructor tsd-parent-kind-class tsd-is-external">
					<li class="tsd-signature tsd-kind-icon">new <wbr>Core<wbr>Aws<wbr>Service<wbr>Client<span class="tsd-signature-symbol">(</span>service<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">CoreStitchServiceClient</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><a href="coreawsserviceclient.html" class="tsd-signature-type">CoreAwsServiceClient</a></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/mongodb/stitch-js-sdk/blob/131d8fe/packages/core/services/aws/src/internal/CoreAwsServiceClient.ts#L28">core/services/aws/src/internal/CoreAwsServiceClient.ts:28</a></li>
							</ul>
						</aside>
						<h4 class="tsd-parameters-title">Parameters</h4>
						<ul class="tsd-parameters">
							<li>
								<h5>service: <span class="tsd-signature-type">CoreStitchServiceClient</span></h5>
							</li>
						</ul>
						<h4 class="tsd-returns-title">Returns <a href="coreawsserviceclient.html" class="tsd-signature-type">CoreAwsServiceClient</a></h4>
					</li>
				</ul>
			</section>
		</section>
		<section class="tsd-panel-group tsd-member-group tsd-is-private tsd-is-private-protected tsd-is-external">
			...
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-class tsd-is-private tsd-is-external">
				...
				<div class="tsd-signature tsd-kind-icon">service<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">CoreStitchServiceClient</span></div>
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/mongodb/stitch-js-sdk/blob/131d8fe/packages/core/services/aws/src/internal/CoreAwsServiceClient.ts#L29">core/services/aws/src/internal/CoreAwsServiceClient.ts:29</a></li>
					</ul>
				</aside>
			</section>
		</section>
		<section class="tsd-panel-group tsd-member-group tsd-is-external">
			...
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class tsd-has-type-parameter tsd-is-external">
				...
				<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-class tsd-has-type-parameter tsd-is-external">
					<li class="tsd-signature tsd-kind-icon">execute&lt;T&gt;<span class="tsd-signature-symbol">(</span>request<span class="tsd-signature-symbol">: </span><a href="awsrequest.html" class="tsd-signature-type">AwsRequest</a>, decoder<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">Decoder</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">T</span><span class="tsd-signature-symbol">&gt;</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">Promise</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">T</span><span class="tsd-signature-symbol">&gt;</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/mongodb/stitch-js-sdk/blob/131d8fe/packages/core/services/aws/src/internal/CoreAwsServiceClient.ts#L38">core/services/aws/src/internal/CoreAwsServiceClient.ts:38</a></li>
							</ul>
						</aside>
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>Executes the AWS request.</p>
							</div>
						</div>
						...
						<ul class="tsd-parameters">
							<li>
								<h5>request: <a href="awsrequest.html" class="tsd-signature-type">AwsRequest</a></h5>
								<div class="tsd-comment tsd-typography">
									<p>the AWS request to execute.</p>
								</div>
							</li>
							<li>
								<h5><span class="tsd-flag ts-flagOptional">Optional</span> decoder: <span class="tsd-signature-type">Decoder</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">T</span><span class="tsd-signature-symbol">&gt;</span></h5>
								<div class="tsd-comment tsd-typography">
									<p>the optional decoder to use to decode the result into a
									value</p>
								</div>
							</li>
						</ul>
			...
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class tsd-is-private tsd-is-external">
				<a name="getrequestargs" class="tsd-anchor"></a>
				<h3><span class="tsd-flag ts-flagPrivate">Private</span> get<wbr>Request<wbr>Args</h3>
				<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-class tsd-is-private tsd-is-external">
					<li class="tsd-signature tsd-kind-icon">get<wbr>Request<wbr>Args<span class="tsd-signature-symbol">(</span>request<span class="tsd-signature-symbol">: </span><a href="awsrequest.html" class="tsd-signature-type">AwsRequest</a><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">object</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/mongodb/stitch-js-sdk/blob/131d8fe/packages/core/services/aws/src/internal/CoreAwsServiceClient.ts#L46">core/services/aws/src/internal/CoreAwsServiceClient.ts:46</a></li>
							</ul>
						</aside>
						<h4 class="tsd-parameters-title">Parameters</h4>
						<ul class="tsd-parameters">
