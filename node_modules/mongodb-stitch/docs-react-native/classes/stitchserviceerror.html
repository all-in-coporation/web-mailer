...
<head>
	...
	<title>StitchServiceError | MongoDB Stitch React Native SDK</title>
...
<nav class="tsd-navigation secondary">
	<ul>
		<li class="current tsd-kind-class tsd-is-external">
			<a href="stitchserviceerror.html" class="tsd-kind-icon">Stitch<wbr>Service<wbr>Error</a>
			<ul>
				<li class=" tsd-kind-constructor tsd-parent-kind-class tsd-is-external">
					<a href="stitchserviceerror.html#constructor" class="tsd-kind-icon">constructor</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-class tsd-is-external">
					<a href="stitchserviceerror.html#errorcode" class="tsd-kind-icon">error<wbr>Code</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-class tsd-is-external">
					<a href="stitchserviceerror.html#errorcodename" class="tsd-kind-icon">error<wbr>Code<wbr>Name</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-class tsd-is-external">
					<a href="stitchserviceerror.html#message" class="tsd-kind-icon">message</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-class tsd-is-inherited tsd-is-static tsd-is-external">
					<a href="stitchserviceerror.html#message-1" class="tsd-kind-icon">message</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-class tsd-is-inherited tsd-is-static tsd-is-external">
					<a href="stitchserviceerror.html#name" class="tsd-kind-icon">name</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-class tsd-is-overwrite tsd-is-inherited tsd-is-static tsd-is-external">
					<a href="stitchserviceerror.html#stack" class="tsd-kind-icon">stack</a>
				</li>
			</ul>
		</li>
	</ul>
	...
	<div class="content-wrap">
		<section class="tsd-panel tsd-comment">
			<div class="tsd-comment tsd-typography">
				<div class="lead">
					<p>A StitchServiceError is an exception indicating that an error came from the Stitch server
						after a request was completed, with an error message and an error code defined in the
					<a href="../enums/stitchserviceerrorcode.html">StitchServiceErrorCode</a> enum.</p>
				</div>
				<p>It is possible that the error code will be
					<a href="../enums/stitchserviceerrorcode.html#unknown">StitchServiceErrorCode.Unknown</a>, which can mean one of several
				...
				response, or an empty string if the body is empty or not decodable as plain text.</p>
			</div>
		</section>
		<section class="tsd-panel tsd-hierarchy">
			...
			<ul class="tsd-hierarchy">
				<li>
					...
					<ul class="tsd-hierarchy">
						<li>
							<span class="target">StitchServiceError</span>
						</li>
					</ul>
				</li>
			</ul>
				...
				<div class="tsd-index-content">
					<section class="tsd-index-section tsd-is-external">
						...
						<ul class="tsd-index-list">
							<li class="tsd-kind-constructor tsd-parent-kind-class tsd-is-external"><a href="stitchserviceerror.html#constructor" class="tsd-kind-icon">constructor</a></li>
						</ul>
					</section>
					<section class="tsd-index-section tsd-is-external">
						<h3>Properties</h3>
						<ul class="tsd-index-list">
							<li class="tsd-kind-property tsd-parent-kind-class tsd-is-external"><a href="stitchserviceerror.html#errorcode" class="tsd-kind-icon">error<wbr>Code</a></li>
							<li class="tsd-kind-property tsd-parent-kind-class tsd-is-external"><a href="stitchserviceerror.html#errorcodename" class="tsd-kind-icon">error<wbr>Code<wbr>Name</a></li>
							<li class="tsd-kind-property tsd-parent-kind-class tsd-is-external"><a href="stitchserviceerror.html#message" class="tsd-kind-icon">message</a></li>
							<li class="tsd-kind-property tsd-parent-kind-class tsd-is-inherited tsd-is-static tsd-is-external"><a href="stitchserviceerror.html#message-1" class="tsd-kind-icon">message</a></li>
							<li class="tsd-kind-property tsd-parent-kind-class tsd-is-inherited tsd-is-static tsd-is-external"><a href="stitchserviceerror.html#name" class="tsd-kind-icon">name</a></li>
							<li class="tsd-kind-property tsd-parent-kind-class tsd-is-overwrite tsd-is-inherited tsd-is-static tsd-is-external"><a href="stitchserviceerror.html#stack" class="tsd-kind-icon">stack</a></li>
						</ul>
					</section>
				</div>
			</section>
		...
		<section class="tsd-panel-group tsd-member-group tsd-is-external">
			...
			<section class="tsd-panel tsd-member tsd-kind-constructor tsd-parent-kind-class tsd-is-external">
				...
				<ul class="tsd-signatures tsd-kind-constructor tsd-parent-kind-class tsd-is-external">
					<li class="tsd-signature tsd-kind-icon">new <wbr>Stitch<wbr>Service<wbr>Error<span class="tsd-signature-symbol">(</span>message<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span>, errorCode<span class="tsd-signature-symbol">?: </span><a href="../enums/stitchserviceerrorcode.html" class="tsd-signature-type">StitchServiceErrorCode</a><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><a href="stitchserviceerror.html" class="tsd-signature-type">StitchServiceError</a></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/mongodb/stitch-js-sdk/blob/131d8fe/packages/core/sdk/src/StitchServiceError.ts#L46">core/sdk/src/StitchServiceError.ts:46</a></li>
							</ul>
						</aside>
						...
						<ul class="tsd-parameters">
							...
							<li>
								<h5><span class="tsd-flag ts-flagDefault value">Default value</span> errorCode: <a href="../enums/stitchserviceerrorcode.html" class="tsd-signature-type">StitchServiceErrorCode</a><span class="tsd-signature-symbol"> =&nbsp;StitchServiceErrorCode.Unknown</span></h5>
							</li>
						</ul>
						<h4 class="tsd-returns-title">Returns <a href="stitchserviceerror.html" class="tsd-signature-type">StitchServiceError</a></h4>
					</li>
				</ul>
			</section>
		</section>
		<section class="tsd-panel-group tsd-member-group tsd-is-external">
			...
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-class tsd-is-external">
				...
				<div class="tsd-signature tsd-kind-icon">error<wbr>Code<span class="tsd-signature-symbol">:</span> <a href="../enums/stitchserviceerrorcode.html" class="tsd-signature-type">StitchServiceErrorCode</a></div>
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/mongodb/stitch-js-sdk/blob/131d8fe/packages/core/sdk/src/StitchServiceError.ts#L36">core/sdk/src/StitchServiceError.ts:36</a></li>
					</ul>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>The <a href="../enums/stitchserviceerrorcode.html">StitchServiceErrorCode</a> indicating the reason for this exception.</p>
					</div>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-class tsd-is-external">
				...
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/mongodb/stitch-js-sdk/blob/131d8fe/packages/core/sdk/src/StitchServiceError.ts#L41">core/sdk/src/StitchServiceError.ts:41</a></li>
					</ul>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>The name of the <a href="../enums/stitchserviceerrorcode.html">StitchServiceErrorCode</a> indicating the reason for this exception.</p>
					</div>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-class tsd-is-external">
				...
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>A string describing the reason for the error.</p>
					</div>
				</div>
			</section>
