...
<head>
	...
	<title>ProviderCapabilities | MongoDB Stitch React Native SDK</title>
...
<nav class="tsd-navigation secondary">
	<ul>
		<li class="current tsd-kind-class tsd-is-external">
			<a href="providercapabilities.html" class="tsd-kind-icon">Provider<wbr>Capabilities</a>
			<ul>
				<li class=" tsd-kind-constructor tsd-parent-kind-class tsd-is-external">
					<a href="providercapabilities.html#constructor" class="tsd-kind-icon">constructor</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-class tsd-is-external">
					<a href="providercapabilities.html#reusesexistingsession" class="tsd-kind-icon">reuses<wbr>Existing<wbr>Session</a>
				</li>
			</ul>
		</li>
	</ul>
	...
	<div class="content-wrap">
		<section class="tsd-panel tsd-comment">
			<div class="tsd-comment tsd-typography">
				<div class="lead">
					<p>Defines the behavior of a credential based on its authentication provider.</p>
				</div>
			</div>
		</section>
		<section class="tsd-panel tsd-hierarchy">
			...
			<ul class="tsd-hierarchy">
				<li>
					<span class="target">ProviderCapabilities</span>
				</li>
			</ul>
		</section>
				...
				<div class="tsd-index-content">
					<section class="tsd-index-section tsd-is-external">
						...
						<ul class="tsd-index-list">
							<li class="tsd-kind-constructor tsd-parent-kind-class tsd-is-external"><a href="providercapabilities.html#constructor" class="tsd-kind-icon">constructor</a></li>
						</ul>
					</section>
					<section class="tsd-index-section tsd-is-external">
						<h3>Properties</h3>
						<ul class="tsd-index-list">
							<li class="tsd-kind-property tsd-parent-kind-class tsd-is-external"><a href="providercapabilities.html#reusesexistingsession" class="tsd-kind-icon">reuses<wbr>Existing<wbr>Session</a></li>
						</ul>
					</section>
				</div>
			</section>
		...
		<section class="tsd-panel-group tsd-member-group tsd-is-external">
			...
			<section class="tsd-panel tsd-member tsd-kind-constructor tsd-parent-kind-class tsd-is-external">
				...
				<ul class="tsd-signatures tsd-kind-constructor tsd-parent-kind-class tsd-is-external">
					<li class="tsd-signature tsd-kind-icon">new <wbr>Provider<wbr>Capabilities<span class="tsd-signature-symbol">(</span>reusesExistingSession<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">boolean</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><a href="providercapabilities.html" class="tsd-signature-type">ProviderCapabilities</a></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/mongodb/stitch-js-sdk/blob/131d8fe/packages/core/sdk/src/auth/ProviderCapabilities.ts#L27">core/sdk/src/auth/ProviderCapabilities.ts:27</a></li>
							</ul>
						</aside>
						<h4 class="tsd-parameters-title">Parameters</h4>
						<ul class="tsd-parameters">
							<li>
								<h5><span class="tsd-flag ts-flagDefault value">Default value</span> reusesExistingSession: <span class="tsd-signature-type">boolean</span><span class="tsd-signature-symbol"> =&nbsp;false</span></h5>
							</li>
						</ul>
						<h4 class="tsd-returns-title">Returns <a href="providercapabilities.html" class="tsd-signature-type">ProviderCapabilities</a></h4>
					</li>
				</ul>
			</section>
		</section>
		<section class="tsd-panel-group tsd-member-group tsd-is-external">
			...
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-class tsd-is-external">
				<a name="reusesexistingsession" class="tsd-anchor"></a>
				<h3>reuses<wbr>Existing<wbr>Session</h3>
				<div class="tsd-signature tsd-kind-icon">reuses<wbr>Existing<wbr>Session<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">boolean</span></div>
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/mongodb/stitch-js-sdk/blob/131d8fe/packages/core/sdk/src/auth/ProviderCapabilities.ts#L27">core/sdk/src/auth/ProviderCapabilities.ts:27</a></li>
					</ul>
				...
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>A bool indicating whether or not logging in with this credential will re-use the existing authenticated session
						...
						its existing session if it is already logged in.</p>
					</div>
				</div>
			</section>
		</section>
