...
<head>
	...
	<title>GoogleCredential | MongoDB Stitch React Native SDK</title>
...
<nav class="tsd-navigation secondary">
	<ul>
		<li class="current tsd-kind-class tsd-is-external">
			<a href="googlecredential.html" class="tsd-kind-icon">Google<wbr>Credential</a>
			<ul>
				<li class=" tsd-kind-constructor tsd-parent-kind-class tsd-is-external">
					<a href="googlecredential.html#constructor" class="tsd-kind-icon">constructor</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-class tsd-is-private tsd-is-external">
					<a href="googlecredential.html#authcode" class="tsd-kind-icon">auth<wbr>Code</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-class tsd-is-external">
					<a href="googlecredential.html#material" class="tsd-kind-icon">material</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-class tsd-is-external">
					<a href="googlecredential.html#providercapabilities" class="tsd-kind-icon">provider<wbr>Capabilities</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-class tsd-is-external">
					<a href="googlecredential.html#providername" class="tsd-kind-icon">provider<wbr>Name</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-class tsd-is-external">
					<a href="googlecredential.html#providertype" class="tsd-kind-icon">provider<wbr>Type</a>
				</li>
			</ul>
		</li>
	</ul>
	...
	<div class="content-wrap">
		<section class="tsd-panel tsd-comment">
			<div class="tsd-comment tsd-typography">
				<div class="lead">
					<p>A credential which can be used to log in as a Stitch user
					using the Google authentication provider.</p>
				</div>
			</div>
		</section>
		<section class="tsd-panel tsd-hierarchy">
			...
			<ul class="tsd-hierarchy">
				<li>
					<span class="target">GoogleCredential</span>
				</li>
			</ul>
		</section>
				...
				<div class="tsd-index-content">
					<section class="tsd-index-section tsd-is-external">
						...
						<ul class="tsd-index-list">
							<li class="tsd-kind-constructor tsd-parent-kind-class tsd-is-external"><a href="googlecredential.html#constructor" class="tsd-kind-icon">constructor</a></li>
						</ul>
					</section>
					<section class="tsd-index-section tsd-is-external">
						<h3>Properties</h3>
						<ul class="tsd-index-list">
							<li class="tsd-kind-property tsd-parent-kind-class tsd-is-private tsd-is-external"><a href="googlecredential.html#authcode" class="tsd-kind-icon">auth<wbr>Code</a></li>
							<li class="tsd-kind-property tsd-parent-kind-class tsd-is-external"><a href="googlecredential.html#material" class="tsd-kind-icon">material</a></li>
							<li class="tsd-kind-property tsd-parent-kind-class tsd-is-external"><a href="googlecredential.html#providercapabilities" class="tsd-kind-icon">provider<wbr>Capabilities</a></li>
							<li class="tsd-kind-property tsd-parent-kind-class tsd-is-external"><a href="googlecredential.html#providername" class="tsd-kind-icon">provider<wbr>Name</a></li>
							<li class="tsd-kind-property tsd-parent-kind-class tsd-is-external"><a href="googlecredential.html#providertype" class="tsd-kind-icon">provider<wbr>Type</a></li>
						</ul>
					</section>
				</div>
			</section>
		...
		<section class="tsd-panel-group tsd-member-group tsd-is-external">
			...
			<section class="tsd-panel tsd-member tsd-kind-constructor tsd-parent-kind-class tsd-is-external">
				...
				<ul class="tsd-signatures tsd-kind-constructor tsd-parent-kind-class tsd-is-external">
					<li class="tsd-signature tsd-kind-icon">new <wbr>Google<wbr>Credential<span class="tsd-signature-symbol">(</span>authCode<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span>, providerName<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">string</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><a href="googlecredential.html" class="tsd-signature-type">GoogleCredential</a></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/mongodb/stitch-js-sdk/blob/131d8fe/packages/core/sdk/src/auth/providers/google/GoogleCredential.ts#L52">core/sdk/src/auth/providers/google/GoogleCredential.ts:52</a></li>
							</ul>
						</aside>
						...
						<ul class="tsd-parameters">
							...
							<li>
								<h5><span class="tsd-flag ts-flagDefault value">Default value</span> providerName: <span class="tsd-signature-type">string</span><span class="tsd-signature-symbol"> =&nbsp;GoogleAuthProvider.DEFAULT_NAME</span></h5>
							</li>
						</ul>
						<h4 class="tsd-returns-title">Returns <a href="googlecredential.html" class="tsd-signature-type">GoogleCredential</a></h4>
					</li>
				</ul>
			</section>
		</section>
		<section class="tsd-panel-group tsd-member-group tsd-is-external">
			...
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-class tsd-is-private tsd-is-external">
				<a name="authcode" class="tsd-anchor"></a>
				<h3><span class="tsd-flag ts-flagPrivate">Private</span> auth<wbr>Code</h3>
				<div class="tsd-signature tsd-kind-icon">auth<wbr>Code<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">string</span></div>
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/mongodb/stitch-js-sdk/blob/131d8fe/packages/core/sdk/src/auth/providers/google/GoogleCredential.ts#L52">core/sdk/src/auth/providers/google/GoogleCredential.ts:52</a></li>
					</ul>
				...
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>The Google OAuth2 authentication code contained within this credential.</p>
					</div>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-class tsd-is-external">
				...
				<aside class="tsd-sources">
					...
					<ul>
						<li>Defined in <a href="https://github.com/mongodb/stitch-js-sdk/blob/131d8fe/packages/core/sdk/src/auth/providers/google/GoogleCredential.ts#L42">core/sdk/src/auth/providers/google/GoogleCredential.ts:42</a></li>
					</ul>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
			...
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-class tsd-is-external">
				...
				<aside class="tsd-sources">
					...
					<ul>
						<li>Defined in <a href="https://github.com/mongodb/stitch-js-sdk/blob/131d8fe/packages/core/sdk/src/auth/providers/google/GoogleCredential.ts#L47">core/sdk/src/auth/providers/google/GoogleCredential.ts:47</a></li>
					</ul>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>The behavior of this credential when logging in.</p>
					</div>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-class tsd-is-external">
				...
				<aside class="tsd-sources">
					...
					<ul>
						<li>Defined in <a href="https://github.com/mongodb/stitch-js-sdk/blob/131d8fe/packages/core/sdk/src/auth/providers/google/GoogleCredential.ts#L33">core/sdk/src/auth/providers/google/GoogleCredential.ts:33</a></li>
					</ul>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>The name of the provider for this credential.</p>
					</div>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-class tsd-is-external">
				...
				<div class="tsd-signature tsd-kind-icon">provider<wbr>Type<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">string</span><span class="tsd-signature-symbol"> =&nbsp;GoogleAuthProvider.TYPE</span></div>
				<aside class="tsd-sources">
					...
					<ul>
						<li>Defined in <a href="https://github.com/mongodb/stitch-js-sdk/blob/131d8fe/packages/core/sdk/src/auth/providers/google/GoogleCredential.ts#L37">core/sdk/src/auth/providers/google/GoogleCredential.ts:37</a></li>
					</ul>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>The type of the provider for this credential.</p>
					</div>
				</div>
			</section>
		</section>
