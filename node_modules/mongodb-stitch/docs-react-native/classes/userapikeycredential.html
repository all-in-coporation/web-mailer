...
<head>
	...
	<title>UserApiKeyCredential | MongoDB Stitch React Native SDK</title>
...
<nav class="tsd-navigation secondary">
	<ul>
		<li class="current tsd-kind-class tsd-is-external">
			<a href="userapikeycredential.html" class="tsd-kind-icon">User<wbr>Api<wbr>Key<wbr>Credential</a>
			<ul>
				<li class=" tsd-kind-constructor tsd-parent-kind-class tsd-is-external">
					<a href="userapikeycredential.html#constructor" class="tsd-kind-icon">constructor</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-class tsd-is-external">
					<a href="userapikeycredential.html#key" class="tsd-kind-icon">key</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-class tsd-is-external">
					<a href="userapikeycredential.html#material" class="tsd-kind-icon">material</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-class tsd-is-external">
					<a href="userapikeycredential.html#providercapabilities" class="tsd-kind-icon">provider<wbr>Capabilities</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-class tsd-is-external">
					<a href="userapikeycredential.html#providername" class="tsd-kind-icon">provider<wbr>Name</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-class tsd-is-external">
					<a href="userapikeycredential.html#providertype" class="tsd-kind-icon">provider<wbr>Type</a>
				</li>
			</ul>
		</li>
	</ul>
	...
	<div class="content-wrap">
		<section class="tsd-panel tsd-comment">
			<div class="tsd-comment tsd-typography">
				<div class="lead">
					...
					using the User API Key authentication provider.</p>
				</div>
			</div>
		</section>
		<section class="tsd-panel tsd-hierarchy">
			...
			<ul class="tsd-hierarchy">
				<li>
					<span class="target">UserApiKeyCredential</span>
				</li>
			</ul>
		</section>
				...
				<div class="tsd-index-content">
					<section class="tsd-index-section tsd-is-external">
						...
						<ul class="tsd-index-list">
							<li class="tsd-kind-constructor tsd-parent-kind-class tsd-is-external"><a href="userapikeycredential.html#constructor" class="tsd-kind-icon">constructor</a></li>
						</ul>
					</section>
					<section class="tsd-index-section tsd-is-external">
						<h3>Properties</h3>
						<ul class="tsd-index-list">
							<li class="tsd-kind-property tsd-parent-kind-class tsd-is-external"><a href="userapikeycredential.html#key" class="tsd-kind-icon">key</a></li>
							<li class="tsd-kind-property tsd-parent-kind-class tsd-is-external"><a href="userapikeycredential.html#material" class="tsd-kind-icon">material</a></li>
							<li class="tsd-kind-property tsd-parent-kind-class tsd-is-external"><a href="userapikeycredential.html#providercapabilities" class="tsd-kind-icon">provider<wbr>Capabilities</a></li>
							<li class="tsd-kind-property tsd-parent-kind-class tsd-is-external"><a href="userapikeycredential.html#providername" class="tsd-kind-icon">provider<wbr>Name</a></li>
							<li class="tsd-kind-property tsd-parent-kind-class tsd-is-external"><a href="userapikeycredential.html#providertype" class="tsd-kind-icon">provider<wbr>Type</a></li>
						</ul>
					</section>
				</div>
			</section>
		...
		<section class="tsd-panel-group tsd-member-group tsd-is-external">
			...
			<section class="tsd-panel tsd-member tsd-kind-constructor tsd-parent-kind-class tsd-is-external">
				...
				<ul class="tsd-signatures tsd-kind-constructor tsd-parent-kind-class tsd-is-external">
					<li class="tsd-signature tsd-kind-icon">new <wbr>User<wbr>Api<wbr>Key<wbr>Credential<span class="tsd-signature-symbol">(</span>key<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span>, providerName<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">string</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><a href="userapikeycredential.html" class="tsd-signature-type">UserApiKeyCredential</a></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/mongodb/stitch-js-sdk/blob/131d8fe/packages/core/sdk/src/auth/providers/userapikey/UserApiKeyCredential.ts#L49">core/sdk/src/auth/providers/userapikey/UserApiKeyCredential.ts:49</a></li>
							</ul>
						</aside>
						...
						<ul class="tsd-parameters">
							...
							<li>
								<h5><span class="tsd-flag ts-flagDefault value">Default value</span> providerName: <span class="tsd-signature-type">string</span><span class="tsd-signature-symbol"> =&nbsp;UserApiKeyAuthProvider.DEFAULT_NAME</span></h5>
							</li>
						</ul>
						<h4 class="tsd-returns-title">Returns <a href="userapikeycredential.html" class="tsd-signature-type">UserApiKeyCredential</a></h4>
					</li>
				</ul>
			</section>
		</section>
		<section class="tsd-panel-group tsd-member-group tsd-is-external">
			...
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-class tsd-is-external">
				...
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/mongodb/stitch-js-sdk/blob/131d8fe/packages/core/sdk/src/auth/providers/userapikey/UserApiKeyCredential.ts#L37">core/sdk/src/auth/providers/userapikey/UserApiKeyCredential.ts:37</a></li>
					</ul>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>The user API key contained within this credential.</p>
					</div>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-class tsd-is-external">
				...
				<aside class="tsd-sources">
					...
					<ul>
						<li>Defined in <a href="https://github.com/mongodb/stitch-js-sdk/blob/131d8fe/packages/core/sdk/src/auth/providers/userapikey/UserApiKeyCredential.ts#L45">core/sdk/src/auth/providers/userapikey/UserApiKeyCredential.ts:45</a></li>
					</ul>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
			...
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-class tsd-is-external">
				...
				<aside class="tsd-sources">
					...
					<ul>
						<li>Defined in <a href="https://github.com/mongodb/stitch-js-sdk/blob/131d8fe/packages/core/sdk/src/auth/providers/userapikey/UserApiKeyCredential.ts#L33">core/sdk/src/auth/providers/userapikey/UserApiKeyCredential.ts:33</a></li>
					</ul>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
			...
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-class tsd-is-external">
				...
				<div class="tsd-signature tsd-kind-icon">provider<wbr>Type<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">string</span><span class="tsd-signature-symbol"> =&nbsp;UserApiKeyAuthProvider.TYPE</span></div>
				<aside class="tsd-sources">
					...
					<ul>
						<li>Defined in <a href="https://github.com/mongodb/stitch-js-sdk/blob/131d8fe/packages/core/sdk/src/auth/providers/userapikey/UserApiKeyCredential.ts#L41">core/sdk/src/auth/providers/userapikey/UserApiKeyCredential.ts:41</a></li>
					</ul>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
