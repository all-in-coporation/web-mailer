...
<head>
	...
	<title>StitchClientError | MongoDB Stitch React Native SDK</title>
...
<nav class="tsd-navigation secondary">
	<ul>
		<li class="current tsd-kind-class tsd-is-external">
			<a href="stitchclienterror.html" class="tsd-kind-icon">Stitch<wbr>Client<wbr>Error</a>
			<ul>
				<li class=" tsd-kind-constructor tsd-parent-kind-class tsd-is-external">
					<a href="stitchclienterror.html#constructor" class="tsd-kind-icon">constructor</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-class tsd-is-external">
					<a href="stitchclienterror.html#errorcode" class="tsd-kind-icon">error<wbr>Code</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-class tsd-is-external">
					<a href="stitchclienterror.html#errorcodename" class="tsd-kind-icon">error<wbr>Code<wbr>Name</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-class tsd-is-inherited tsd-is-static tsd-is-external">
					<a href="stitchclienterror.html#message" class="tsd-kind-icon">message</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-class tsd-is-inherited tsd-is-static tsd-is-external">
					<a href="stitchclienterror.html#name" class="tsd-kind-icon">name</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-class tsd-is-overwrite tsd-is-inherited tsd-is-static tsd-is-external">
					<a href="stitchclienterror.html#stack" class="tsd-kind-icon">stack</a>
				</li>
			</ul>
		</li>
	</ul>
	...
	<div class="content-wrap">
		<section class="tsd-panel tsd-comment">
			<div class="tsd-comment tsd-typography">
				<div class="lead">
					<p>An exception indicating that an error occurred when using the Stitch client, typically before the
					client performed a request. An error code indicating the reason for the error is included.</p>
				</div>
			</div>
		</section>
		<section class="tsd-panel tsd-hierarchy">
			...
			<ul class="tsd-hierarchy">
				<li>
					...
					<ul class="tsd-hierarchy">
						<li>
							<span class="target">StitchClientError</span>
						</li>
					</ul>
				</li>
			</ul>
				...
				<div class="tsd-index-content">
					<section class="tsd-index-section tsd-is-external">
						...
						<ul class="tsd-index-list">
							<li class="tsd-kind-constructor tsd-parent-kind-class tsd-is-external"><a href="stitchclienterror.html#constructor" class="tsd-kind-icon">constructor</a></li>
						</ul>
					</section>
					<section class="tsd-index-section tsd-is-external">
						<h3>Properties</h3>
						<ul class="tsd-index-list">
							<li class="tsd-kind-property tsd-parent-kind-class tsd-is-external"><a href="stitchclienterror.html#errorcode" class="tsd-kind-icon">error<wbr>Code</a></li>
							<li class="tsd-kind-property tsd-parent-kind-class tsd-is-external"><a href="stitchclienterror.html#errorcodename" class="tsd-kind-icon">error<wbr>Code<wbr>Name</a></li>
							<li class="tsd-kind-property tsd-parent-kind-class tsd-is-inherited tsd-is-static tsd-is-external"><a href="stitchclienterror.html#message" class="tsd-kind-icon">message</a></li>
							<li class="tsd-kind-property tsd-parent-kind-class tsd-is-inherited tsd-is-static tsd-is-external"><a href="stitchclienterror.html#name" class="tsd-kind-icon">name</a></li>
							<li class="tsd-kind-property tsd-parent-kind-class tsd-is-overwrite tsd-is-inherited tsd-is-static tsd-is-external"><a href="stitchclienterror.html#stack" class="tsd-kind-icon">stack</a></li>
						</ul>
					</section>
				</div>
			</section>
		...
		<section class="tsd-panel-group tsd-member-group tsd-is-external">
			...
			<section class="tsd-panel tsd-member tsd-kind-constructor tsd-parent-kind-class tsd-is-external">
				...
				<ul class="tsd-signatures tsd-kind-constructor tsd-parent-kind-class tsd-is-external">
					<li class="tsd-signature tsd-kind-icon">new <wbr>Stitch<wbr>Client<wbr>Error<span class="tsd-signature-symbol">(</span>errorCode<span class="tsd-signature-symbol">: </span><a href="../enums/stitchclienterrorcode.html" class="tsd-signature-type">StitchClientErrorCode</a><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><a href="stitchclienterror.html" class="tsd-signature-type">StitchClientError</a></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/mongodb/stitch-js-sdk/blob/131d8fe/packages/core/sdk/src/StitchClientError.ts#L36">core/sdk/src/StitchClientError.ts:36</a></li>
							</ul>
						</aside>
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>Constructs a client exception with the given error code.</p>
							</div>
						</div>
						<h4 class="tsd-parameters-title">Parameters</h4>
						<ul class="tsd-parameters">
							<li>
								<h5>errorCode: <a href="../enums/stitchclienterrorcode.html" class="tsd-signature-type">StitchClientErrorCode</a></h5>
							</li>
						</ul>
						<h4 class="tsd-returns-title">Returns <a href="stitchclienterror.html" class="tsd-signature-type">StitchClientError</a></h4>
					</li>
				</ul>
			</section>
		</section>
		<section class="tsd-panel-group tsd-member-group tsd-is-external">
			...
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-class tsd-is-external">
				...
				<div class="tsd-signature tsd-kind-icon">error<wbr>Code<span class="tsd-signature-symbol">:</span> <a href="../enums/stitchclienterrorcode.html" class="tsd-signature-type">StitchClientErrorCode</a></div>
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/mongodb/stitch-js-sdk/blob/131d8fe/packages/core/sdk/src/StitchClientError.ts#L31">core/sdk/src/StitchClientError.ts:31</a></li>
					</ul>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>The <a href="../enums/stitchclienterrorcode.html">StitchClientErrorCode</a> associated with the request.</p>
					</div>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-class tsd-is-external">
				...
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>The name of the <a href="../enums/stitchclienterrorcode.html">StitchClientErrorCode</a> associated with the request.</p>
					</div>
				</div>
			</section>
