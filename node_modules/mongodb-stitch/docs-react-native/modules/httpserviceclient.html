...
<head>
	...
	<title>HttpServiceClient | MongoDB Stitch React Native SDK</title>
...
<nav class="tsd-navigation secondary">
	<ul>
		<li class=" tsd-kind-variable tsd-parent-kind-module tsd-is-external">
			<a href="httpserviceclient.html#factory" class="tsd-kind-icon">factory</a>
		</li>
		<li class=" tsd-kind-method tsd-parent-kind-module tsd-is-external">
			<a href="httpserviceclient.html#execute" class="tsd-kind-icon">execute</a>
		</li>
	</ul>
</nav>
	...
	<div class="content-wrap">
				...
				<div class="tsd-index-content">
					<section class="tsd-index-section tsd-is-external">
						...
						<ul class="tsd-index-list">
							<li class="tsd-kind-variable tsd-parent-kind-module tsd-is-external"><a href="httpserviceclient.html#factory" class="tsd-kind-icon">factory</a></li>
						</ul>
					</section>
					<section class="tsd-index-section tsd-is-external">
						<h3>Methods</h3>
						<ul class="tsd-index-list">
							<li class="tsd-kind-method tsd-parent-kind-module tsd-is-external"><a href="httpserviceclient.html#execute" class="tsd-kind-icon">execute</a></li>
						</ul>
					</section>
				</div>
			</section>
		...
		<section class="tsd-panel-group tsd-member-group tsd-is-external">
			...
			<section class="tsd-panel tsd-member tsd-kind-variable tsd-parent-kind-module tsd-is-external">
				...
				<div class="tsd-signature tsd-kind-icon">factory<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">NamedServiceClientFactory</span><span class="tsd-signature-symbol">&lt;</span><a href="httpserviceclient.html" class="tsd-signature-type">HttpServiceClient</a><span class="tsd-signature-symbol">&gt;</span><span class="tsd-signature-symbol"> =&nbsp;new classimplements NamedServiceClientFactory&lt;HttpServiceClient&gt; {public getNamedClient(service: CoreStitchServiceClient,client: StitchAppClientInfo): HttpServiceClient {return new HttpServiceClientImpl(new CoreHttpServiceClient(service));}}()</span></div>
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/mongodb/stitch-js-sdk/blob/131d8fe/packages/react-native/services/http/src/HttpServiceClient.ts#L45">react-native/services/http/src/HttpServiceClient.ts:45</a></li>
					</ul>
				</aside>
			</section>
		</section>
		<section class="tsd-panel-group tsd-member-group tsd-is-external">
			...
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-module tsd-is-external">
				...
				<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-module tsd-is-external">
					<li class="tsd-signature tsd-kind-icon">execute<span class="tsd-signature-symbol">(</span>request<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">HttpRequest</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">Promise</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">HttpResponse</span><span class="tsd-signature-symbol">&gt;</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/mongodb/stitch-js-sdk/blob/131d8fe/packages/react-native/services/http/src/HttpServiceClient.ts#L41">react-native/services/http/src/HttpServiceClient.ts:41</a></li>
							</ul>
						</aside>
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>Executes the given <a href="../classes/httprequest.html">HttpRequest</a>.</p>
							</div>
						</div>
						<h4 class="tsd-parameters-title">Parameters</h4>
						<ul class="tsd-parameters">
							<li>
								<h5>request: <span class="tsd-signature-type">HttpRequest</span></h5>
								<div class="tsd-comment tsd-typography">
									<p>the request to execute.</p>
								</div>
							</li>
						</ul>
						<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">Promise</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">HttpResponse</span><span class="tsd-signature-symbol">&gt;</span></h4>
						<p>a Promise containing the response to executing the request.</p>
					</li>
				</ul>
			</section>
		</section>
