...
<head>
	...
	<title>UserApiKeyAuthProviderClient | MongoDB Stitch React Native SDK</title>
...
<nav class="tsd-navigation secondary">
	<ul>
		<li class=" tsd-kind-variable tsd-parent-kind-module tsd-is-external">
			<a href="userapikeyauthproviderclient.html#factory" class="tsd-kind-icon">factory</a>
		</li>
		<li class=" tsd-kind-method tsd-parent-kind-module tsd-is-external">
			<a href="userapikeyauthproviderclient.html#createapikey" class="tsd-kind-icon">create<wbr>Api<wbr>Key</a>
		</li>
		<li class=" tsd-kind-method tsd-parent-kind-module tsd-is-external">
			<a href="userapikeyauthproviderclient.html#deleteapikey" class="tsd-kind-icon">delete<wbr>Api<wbr>Key</a>
		</li>
		<li class=" tsd-kind-method tsd-parent-kind-module tsd-is-external">
			<a href="userapikeyauthproviderclient.html#disableapikey" class="tsd-kind-icon">disable<wbr>Api<wbr>Key</a>
		</li>
		<li class=" tsd-kind-method tsd-parent-kind-module tsd-is-external">
			<a href="userapikeyauthproviderclient.html#enableapikey" class="tsd-kind-icon">enable<wbr>Api<wbr>Key</a>
		</li>
		<li class=" tsd-kind-method tsd-parent-kind-module tsd-is-external">
			<a href="userapikeyauthproviderclient.html#fetchapikey" class="tsd-kind-icon">fetch<wbr>Api<wbr>Key</a>
		</li>
		<li class=" tsd-kind-method tsd-parent-kind-module tsd-is-external">
			<a href="userapikeyauthproviderclient.html#fetchapikeys" class="tsd-kind-icon">fetch<wbr>Api<wbr>Keys</a>
		</li>
	</ul>
</nav>
	...
	<div class="content-wrap">
		<section class="tsd-panel tsd-comment">
			<div class="tsd-comment tsd-typography">
				<div class="lead">
					<p>A client for creating, updating, and deleting the API keys of a Stitch user.</p>
				</div>
			</div>
		</section>
				...
				<div class="tsd-index-content">
					<section class="tsd-index-section tsd-is-external">
						...
						<ul class="tsd-index-list">
							<li class="tsd-kind-variable tsd-parent-kind-module tsd-is-external"><a href="userapikeyauthproviderclient.html#factory" class="tsd-kind-icon">factory</a></li>
						</ul>
					</section>
					<section class="tsd-index-section tsd-is-external">
						<h3>Methods</h3>
						<ul class="tsd-index-list">
							<li class="tsd-kind-method tsd-parent-kind-module tsd-is-external"><a href="userapikeyauthproviderclient.html#createapikey" class="tsd-kind-icon">create<wbr>Api<wbr>Key</a></li>
							<li class="tsd-kind-method tsd-parent-kind-module tsd-is-external"><a href="userapikeyauthproviderclient.html#deleteapikey" class="tsd-kind-icon">delete<wbr>Api<wbr>Key</a></li>
							<li class="tsd-kind-method tsd-parent-kind-module tsd-is-external"><a href="userapikeyauthproviderclient.html#disableapikey" class="tsd-kind-icon">disable<wbr>Api<wbr>Key</a></li>
							<li class="tsd-kind-method tsd-parent-kind-module tsd-is-external"><a href="userapikeyauthproviderclient.html#enableapikey" class="tsd-kind-icon">enable<wbr>Api<wbr>Key</a></li>
							<li class="tsd-kind-method tsd-parent-kind-module tsd-is-external"><a href="userapikeyauthproviderclient.html#fetchapikey" class="tsd-kind-icon">fetch<wbr>Api<wbr>Key</a></li>
							<li class="tsd-kind-method tsd-parent-kind-module tsd-is-external"><a href="userapikeyauthproviderclient.html#fetchapikeys" class="tsd-kind-icon">fetch<wbr>Api<wbr>Keys</a></li>
						</ul>
					</section>
				</div>
			</section>
		...
		<section class="tsd-panel-group tsd-member-group tsd-is-external">
			...
			<section class="tsd-panel tsd-member tsd-kind-variable tsd-parent-kind-module tsd-is-external">
				...
				<h3><span class="tsd-flag ts-flagConst">Const</span> factory</h3>
				<div class="tsd-signature tsd-kind-icon">factory<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">AuthProviderClientFactory</span><span class="tsd-signature-symbol">&lt;</span><a href="userapikeyauthproviderclient.html" class="tsd-signature-type">UserApiKeyAuthProviderClient</a><span class="tsd-signature-symbol">&gt;</span><span class="tsd-signature-symbol"> =&nbsp;new classimplements AuthProviderClientFactory&lt;UserApiKeyAuthProviderClient&gt; {public getClient(authRequestClient: StitchAuthRequestClient,requestClient: StitchRequestClient, // this arg is ignoredroutes: StitchAuthRoutes): UserApiKeyAuthProviderClient {return new UserApiKeyAuthProviderClientImpl(authRequestClient, routes);}}()</span></div>
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/mongodb/stitch-js-sdk/blob/131d8fe/packages/react-native/core/src/core/auth/providers/userapikey/UserApiKeyAuthProviderClient.ts#L73">react-native/core/src/core/auth/providers/userapikey/UserApiKeyAuthProviderClient.ts:73</a></li>
					</ul>
				</aside>
			</section>
		</section>
		<section class="tsd-panel-group tsd-member-group tsd-is-external">
			...
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-module tsd-is-external">
				<a name="createapikey" class="tsd-anchor"></a>
				<h3>create<wbr>Api<wbr>Key</h3>
				<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-module tsd-is-external">
					<li class="tsd-signature tsd-kind-icon">create<wbr>Api<wbr>Key<span class="tsd-signature-symbol">(</span>name<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">Promise</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">UserApiKey</span><span class="tsd-signature-symbol">&gt;</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/mongodb/stitch-js-sdk/blob/131d8fe/packages/react-native/core/src/core/auth/providers/userapikey/UserApiKeyAuthProviderClient.ts#L36">react-native/core/src/core/auth/providers/userapikey/UserApiKeyAuthProviderClient.ts:36</a></li>
							</ul>
						</aside>
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>Creates a user API key that can be used to authenticate as the current user.</p>
							</div>
						</div>
						...
						<ul class="tsd-parameters">
							<li>
								...
								<div class="tsd-comment tsd-typography">
									<p>the name of the API key to be created.</p>
								</div>
							</li>
						</ul>
						<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">Promise</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">UserApiKey</span><span class="tsd-signature-symbol">&gt;</span></h4>
					</li>
				</ul>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-module tsd-is-external">
				<a name="deleteapikey" class="tsd-anchor"></a>
				<h3>delete<wbr>Api<wbr>Key</h3>
				<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-module tsd-is-external">
					<li class="tsd-signature tsd-kind-icon">delete<wbr>Api<wbr>Key<span class="tsd-signature-symbol">(</span>keyId<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">ObjectID</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">Promise</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">void</span><span class="tsd-signature-symbol">&gt;</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/mongodb/stitch-js-sdk/blob/131d8fe/packages/react-native/core/src/core/auth/providers/userapikey/UserApiKeyAuthProviderClient.ts#L55">react-native/core/src/core/auth/providers/userapikey/UserApiKeyAuthProviderClient.ts:55</a></li>
							</ul>
						</aside>
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>Deletes a user API key associated with the current user.</p>
							</div>
						</div>
						<h4 class="tsd-parameters-title">Parameters</h4>
						<ul class="tsd-parameters">
							<li>
								<h5>keyId: <span class="tsd-signature-type">ObjectID</span></h5>
								<div class="tsd-comment tsd-typography">
			...
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-module tsd-is-external">
				<a name="disableapikey" class="tsd-anchor"></a>
				<h3>disable<wbr>Api<wbr>Key</h3>
				<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-module tsd-is-external">
					<li class="tsd-signature tsd-kind-icon">disable<wbr>Api<wbr>Key<span class="tsd-signature-symbol">(</span>keyId<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">ObjectID</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">Promise</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">void</span><span class="tsd-signature-symbol">&gt;</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/mongodb/stitch-js-sdk/blob/131d8fe/packages/react-native/core/src/core/auth/providers/userapikey/UserApiKeyAuthProviderClient.ts#L69">react-native/core/src/core/auth/providers/userapikey/UserApiKeyAuthProviderClient.ts:69</a></li>
							</ul>
						</aside>
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>Disables a user API key associated with the current user.</p>
							</div>
						</div>
						<h4 class="tsd-parameters-title">Parameters</h4>
						<ul class="tsd-parameters">
							<li>
								<h5>keyId: <span class="tsd-signature-type">ObjectID</span></h5>
								<div class="tsd-comment tsd-typography">
									<p>the id of the API key to disable</p>
								</div>
							</li>
						</ul>
						<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">Promise</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">void</span><span class="tsd-signature-symbol">&gt;</span></h4>
			...
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-module tsd-is-external">
				<a name="enableapikey" class="tsd-anchor"></a>
				<h3>enable<wbr>Api<wbr>Key</h3>
				<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-module tsd-is-external">
					<li class="tsd-signature tsd-kind-icon">enable<wbr>Api<wbr>Key<span class="tsd-signature-symbol">(</span>keyId<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">ObjectID</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">Promise</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">void</span><span class="tsd-signature-symbol">&gt;</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/mongodb/stitch-js-sdk/blob/131d8fe/packages/react-native/core/src/core/auth/providers/userapikey/UserApiKeyAuthProviderClient.ts#L62">react-native/core/src/core/auth/providers/userapikey/UserApiKeyAuthProviderClient.ts:62</a></li>
							</ul>
						</aside>
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>Enables a user API key associated with the current user.</p>
							</div>
						</div>
						<h4 class="tsd-parameters-title">Parameters</h4>
						<ul class="tsd-parameters">
							<li>
								<h5>keyId: <span class="tsd-signature-type">ObjectID</span></h5>
								<div class="tsd-comment tsd-typography">
									<p>the id of the API key to enable</p>
								</div>
							</li>
						</ul>
						<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">Promise</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">void</span><span class="tsd-signature-symbol">&gt;</span></h4>
			...
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-module tsd-is-external">
				<a name="fetchapikey" class="tsd-anchor"></a>
				<h3>fetch<wbr>Api<wbr>Key</h3>
				<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-module tsd-is-external">
					<li class="tsd-signature tsd-kind-icon">fetch<wbr>Api<wbr>Key<span class="tsd-signature-symbol">(</span>keyId<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">ObjectID</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">Promise</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">UserApiKey</span><span class="tsd-signature-symbol">&gt;</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/mongodb/stitch-js-sdk/blob/131d8fe/packages/react-native/core/src/core/auth/providers/userapikey/UserApiKeyAuthProviderClient.ts#L43">react-native/core/src/core/auth/providers/userapikey/UserApiKeyAuthProviderClient.ts:43</a></li>
							</ul>
						</aside>
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>Fetches a user API key associated with the current user.</p>
							</div>
						</div>
						<h4 class="tsd-parameters-title">Parameters</h4>
						<ul class="tsd-parameters">
							<li>
								<h5>keyId: <span class="tsd-signature-type">ObjectID</span></h5>
								<div class="tsd-comment tsd-typography">
									<p>the id of the API key to fetch.</p>
								</div>
							</li>
						</ul>
						<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">Promise</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">UserApiKey</span><span class="tsd-signature-symbol">&gt;</span></h4>
			...
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-module tsd-is-external">
				<a name="fetchapikeys" class="tsd-anchor"></a>
				<h3>fetch<wbr>Api<wbr>Keys</h3>
				<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-module tsd-is-external">
					<li class="tsd-signature tsd-kind-icon">fetch<wbr>Api<wbr>Keys<span class="tsd-signature-symbol">(</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">Promise</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">UserApiKey</span><span class="tsd-signature-symbol">[]</span><span class="tsd-signature-symbol">&gt;</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/mongodb/stitch-js-sdk/blob/131d8fe/packages/react-native/core/src/core/auth/providers/userapikey/UserApiKeyAuthProviderClient.ts#L48">react-native/core/src/core/auth/providers/userapikey/UserApiKeyAuthProviderClient.ts:48</a></li>
							</ul>
						</aside>
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>Fetches the user API keys associated with the current user.</p>
							</div>
						</div>
						<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">Promise</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">UserApiKey</span><span class="tsd-signature-symbol">[]</span><span class="tsd-signature-symbol">&gt;</span></h4>
					</li>
				</ul>
			</section>
		</section>
