...
<head>
	...
	<title>AwsSesServiceClient | MongoDB Stitch React Native SDK</title>
...
<nav class="tsd-navigation secondary">
	<ul>
		<li class=" tsd-kind-variable tsd-parent-kind-module tsd-is-external">
			<a href="awssesserviceclient.html#factory" class="tsd-kind-icon">factory</a>
		</li>
		<li class=" tsd-kind-method tsd-parent-kind-module tsd-is-external">
			<a href="awssesserviceclient.html#sendemail" class="tsd-kind-icon">send<wbr>Email</a>
		</li>
	</ul>
</nav>
	...
	<div class="content-wrap">
		<section class="tsd-panel tsd-comment">
			<div class="tsd-comment tsd-typography">
				<div class="lead">
					<p>The AWS SES service client.</p>
				</div>
				...
				<div class="tsd-index-content">
					<section class="tsd-index-section tsd-is-external">
						...
						<ul class="tsd-index-list">
							<li class="tsd-kind-variable tsd-parent-kind-module tsd-is-external"><a href="awssesserviceclient.html#factory" class="tsd-kind-icon">factory</a></li>
						</ul>
					</section>
					<section class="tsd-index-section tsd-is-external">
						<h3>Methods</h3>
						<ul class="tsd-index-list">
							<li class="tsd-kind-method tsd-parent-kind-module tsd-is-external"><a href="awssesserviceclient.html#sendemail" class="tsd-kind-icon">send<wbr>Email</a></li>
						</ul>
					</section>
				</div>
			</section>
		...
		<section class="tsd-panel-group tsd-member-group tsd-is-external">
			...
			<section class="tsd-panel tsd-member tsd-kind-variable tsd-parent-kind-module tsd-is-external">
				...
				<div class="tsd-signature tsd-kind-icon">factory<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">NamedServiceClientFactory</span><span class="tsd-signature-symbol">&lt;</span><a href="awssesserviceclient.html" class="tsd-signature-type">AwsSesServiceClient</a><span class="tsd-signature-symbol">&gt;</span><span class="tsd-signature-symbol"> =&nbsp;new class implements NamedServiceClientFactory&lt;AwsSesServiceClient&gt; {public getNamedClient(service: CoreStitchServiceClient,client: StitchAppClientInfo): AwsSesServiceClient {return new AwsSesServiceClientImpl(new CoreAwsSesServiceClient(service));}}()</span></div>
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/mongodb/stitch-js-sdk/blob/131d8fe/packages/react-native/services/aws-ses/src/AwsSesServiceClient.ts#L54">react-native/services/aws-ses/src/AwsSesServiceClient.ts:54</a></li>
					</ul>
				</aside>
			</section>
		</section>
		<section class="tsd-panel-group tsd-member-group tsd-is-external">
			...
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-module tsd-is-external">
				<a name="sendemail" class="tsd-anchor"></a>
				<h3>send<wbr>Email</h3>
				<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-module tsd-is-external">
					<li class="tsd-signature tsd-kind-icon">send<wbr>Email<span class="tsd-signature-symbol">(</span>to<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span>, from<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span>, subject<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span>, body<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">Promise</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">AwsSesSendResult</span><span class="tsd-signature-symbol">&gt;</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/mongodb/stitch-js-sdk/blob/131d8fe/packages/react-native/services/aws-ses/src/AwsSesServiceClient.ts#L45">react-native/services/aws-ses/src/AwsSesServiceClient.ts:45</a></li>
							</ul>
						</aside>
						<div class="tsd-comment tsd-typography">
							<div class="lead">
						...
						<ul class="tsd-parameters">
							...
							<li>
								...
								<div class="tsd-comment tsd-typography">
									<p>the email address to send the email from.</p>
								</div>
							</li>
							<li>
							...
							<li>
								...
								<div class="tsd-comment tsd-typography">
									<p>the body text of the email.</p>
								</div>
							</li>
						</ul>
						<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">Promise</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">AwsSesSendResult</span><span class="tsd-signature-symbol">&gt;</span></h4>
						<p>a Promise containing the result of the send that completes when the send is done.</p>
					</li>
				</ul>
			</section>
		</section>
