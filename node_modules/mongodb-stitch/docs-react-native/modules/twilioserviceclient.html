...
<head>
	...
	<title>TwilioServiceClient | MongoDB Stitch React Native SDK</title>
...
<nav class="tsd-navigation secondary">
	<ul>
		<li class=" tsd-kind-variable tsd-parent-kind-module tsd-is-external">
			<a href="twilioserviceclient.html#factory" class="tsd-kind-icon">factory</a>
		</li>
		<li class=" tsd-kind-method tsd-parent-kind-module tsd-is-external">
			<a href="twilioserviceclient.html#sendmessage" class="tsd-kind-icon">send<wbr>Message</a>
		</li>
	</ul>
</nav>
	...
	<div class="content-wrap">
				...
				<div class="tsd-index-content">
					<section class="tsd-index-section tsd-is-external">
						...
						<ul class="tsd-index-list">
							<li class="tsd-kind-variable tsd-parent-kind-module tsd-is-external"><a href="twilioserviceclient.html#factory" class="tsd-kind-icon">factory</a></li>
						</ul>
					</section>
					<section class="tsd-index-section tsd-is-external">
						<h3>Methods</h3>
						<ul class="tsd-index-list">
							<li class="tsd-kind-method tsd-parent-kind-module tsd-is-external"><a href="twilioserviceclient.html#sendmessage" class="tsd-kind-icon">send<wbr>Message</a></li>
						</ul>
					</section>
				</div>
			</section>
		...
		<section class="tsd-panel-group tsd-member-group tsd-is-external">
			...
			<section class="tsd-panel tsd-member tsd-kind-variable tsd-parent-kind-module tsd-is-external">
				...
				<div class="tsd-signature tsd-kind-icon">factory<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">NamedServiceClientFactory</span><span class="tsd-signature-symbol">&lt;</span><a href="twilioserviceclient.html" class="tsd-signature-type">TwilioServiceClient</a><span class="tsd-signature-symbol">&gt;</span><span class="tsd-signature-symbol"> =&nbsp;new class implements NamedServiceClientFactory&lt;TwilioServiceClient&gt; {public getNamedClient(service: CoreStitchServiceClient,client: StitchAppClientInfo): TwilioServiceClient {return new TwilioServiceClientImpl(new CoreTwilioServiceClient(service));}}()</span></div>
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/mongodb/stitch-js-sdk/blob/131d8fe/packages/react-native/services/twilio/src/TwilioServiceClient.ts#L49">react-native/services/twilio/src/TwilioServiceClient.ts:49</a></li>
					</ul>
				</aside>
			</section>
		</section>
		<section class="tsd-panel-group tsd-member-group tsd-is-external">
			...
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-module tsd-is-external">
				...
				<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-module tsd-is-external">
					<li class="tsd-signature tsd-kind-icon">send<wbr>Message<span class="tsd-signature-symbol">(</span>to<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span>, from<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span>, body<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span>, mediaUrl<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">undefined</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">string</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">Promise</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">void</span><span class="tsd-signature-symbol">&gt;</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/mongodb/stitch-js-sdk/blob/131d8fe/packages/react-native/services/twilio/src/TwilioServiceClient.ts#L40">react-native/services/twilio/src/TwilioServiceClient.ts:40</a></li>
							</ul>
						</aside>
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>Sends an SMS/MMS message.</p>
							</div>
						</div>
						...
						<ul class="tsd-parameters">
							<li>
								...
								<div class="tsd-comment tsd-typography">
									<p>the number to send the message to.</p>
								</div>
							</li>
							<li>
								<h5>from: <span class="tsd-signature-type">string</span></h5>
								<div class="tsd-comment tsd-typography">
									<p>the number that the message is from.</p>
								</div>
							</li>
							<li>
								<h5>body: <span class="tsd-signature-type">string</span></h5>
								<div class="tsd-comment tsd-typography">
									<p>the body text of the message.</p>
								</div>
							</li>
							<li>
								<h5><span class="tsd-flag ts-flagOptional">Optional</span> mediaUrl: <span class="tsd-signature-type">undefined</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">string</span></h5>
								<div class="tsd-comment tsd-typography">
									<p>the Url of the media to send in an MMS.</p>
								</div>
							</li>
						</ul>
						<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">Promise</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">void</span><span class="tsd-signature-symbol">&gt;</span></h4>
						<p>a Promise that resolves when the send is done.</p>
					</li>
				</ul>
			</section>
		</section>
