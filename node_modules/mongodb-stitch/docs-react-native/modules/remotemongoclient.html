...
<head>
	...
	<title>RemoteMongoClient | MongoDB Stitch React Native SDK</title>
...
<nav class="tsd-navigation secondary">
	<ul>
		<li class=" tsd-kind-variable tsd-parent-kind-module tsd-is-external">
			<a href="remotemongoclient.html#factory" class="tsd-kind-icon">factory</a>
		</li>
		<li class=" tsd-kind-method tsd-parent-kind-module tsd-is-external">
			<a href="remotemongoclient.html#db" class="tsd-kind-icon">db</a>
		</li>
	</ul>
</nav>
	...
	<div class="content-wrap">
		<section class="tsd-panel tsd-comment">
			<div class="tsd-comment tsd-typography">
				<div class="lead">
					<p>A client which can be used to get database and collection objects which can
					be used to interact with MongoDB data via the Stitch MongoDB service.</p>
				</div>
			</div>
		</section>
				...
				<div class="tsd-index-content">
					<section class="tsd-index-section tsd-is-external">
						...
						<ul class="tsd-index-list">
							<li class="tsd-kind-variable tsd-parent-kind-module tsd-is-external"><a href="remotemongoclient.html#factory" class="tsd-kind-icon">factory</a></li>
						</ul>
					</section>
					<section class="tsd-index-section tsd-is-external">
						<h3>Methods</h3>
						<ul class="tsd-index-list">
							<li class="tsd-kind-method tsd-parent-kind-module tsd-is-external"><a href="remotemongoclient.html#db" class="tsd-kind-icon">db</a></li>
						</ul>
					</section>
				</div>
			</section>
		...
		<section class="tsd-panel-group tsd-member-group tsd-is-external">
			...
			<section class="tsd-panel tsd-member tsd-kind-variable tsd-parent-kind-module tsd-is-external">
				...
				<div class="tsd-signature tsd-kind-icon">factory<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">NamedServiceClientFactory</span><span class="tsd-signature-symbol">&lt;</span><a href="remotemongoclient.html" class="tsd-signature-type">RemoteMongoClient</a><span class="tsd-signature-symbol">&gt;</span><span class="tsd-signature-symbol"> =&nbsp;new classimplements NamedServiceClientFactory&lt;RemoteMongoClient&gt; {public getNamedClient(service: CoreStitchServiceClient,client: StitchAppClientInfo): RemoteMongoClient {return new RemoteMongoClientImpl(new CoreRemoteMongoClientImpl(service));}}()</span></div>
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/mongodb/stitch-js-sdk/blob/131d8fe/packages/react-native/services/mongodb-remote/src/RemoteMongoClient.ts#L43">react-native/services/mongodb-remote/src/RemoteMongoClient.ts:43</a></li>
					</ul>
				</aside>
			</section>
		</section>
		<section class="tsd-panel-group tsd-member-group tsd-is-external">
			...
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-module tsd-is-external">
				...
				<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-module tsd-is-external">
					<li class="tsd-signature tsd-kind-icon">db<span class="tsd-signature-symbol">(</span>name<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><a href="../interfaces/remotemongodatabase.html" class="tsd-signature-type">RemoteMongoDatabase</a></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/mongodb/stitch-js-sdk/blob/131d8fe/packages/react-native/services/mongodb-remote/src/RemoteMongoClient.ts#L39">react-native/services/mongodb-remote/src/RemoteMongoClient.ts:39</a></li>
							</ul>
						</aside>
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>Gets a <a href="../interfaces/remotemongodatabase.html">RemoteMongoDatabase</a> instance for the given database name.</p>
							</div>
						</div>
						...
						<h4 class="tsd-returns-title">Returns <a href="../interfaces/remotemongodatabase.html" class="tsd-signature-type">RemoteMongoDatabase</a></h4>
						<p>a {@code RemoteMongoDatabase} representing the specified database</p>
					</li>
				</ul>
			</section>
		</section>
