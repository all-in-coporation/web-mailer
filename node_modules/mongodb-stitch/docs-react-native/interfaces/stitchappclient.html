...
<head>
	...
	<title>StitchAppClient | MongoDB Stitch React Native SDK</title>
...
<nav class="tsd-navigation secondary">
	<ul>
		<li class="current tsd-kind-interface tsd-is-external">
			<a href="stitchappclient.html" class="tsd-kind-icon">Stitch<wbr>App<wbr>Client</a>
			<ul>
				<li class=" tsd-kind-property tsd-parent-kind-interface tsd-is-external">
					<a href="stitchappclient.html#auth" class="tsd-kind-icon">auth</a>
				</li>
				<li class=" tsd-kind-method tsd-parent-kind-interface tsd-is-external">
					<a href="stitchappclient.html#callfunction" class="tsd-kind-icon">call<wbr>Function</a>
				</li>
				<li class=" tsd-kind-method tsd-parent-kind-interface tsd-is-external">
					<a href="stitchappclient.html#close" class="tsd-kind-icon">close</a>
				</li>
				<li class=" tsd-kind-method tsd-parent-kind-interface tsd-is-external">
					<a href="stitchappclient.html#getgeneralserviceclient" class="tsd-kind-icon">get<wbr>General<wbr>Service<wbr>Client</a>
				</li>
				<li class=" tsd-kind-method tsd-parent-kind-interface tsd-has-type-parameter tsd-is-external">
					<a href="stitchappclient.html#getserviceclient" class="tsd-kind-icon">get<wbr>Service<wbr>Client</a>
				</li>
			</ul>
		</li>
	</ul>
	...
	<div class="content-wrap">
		<section class="tsd-panel tsd-comment">
			<div class="tsd-comment tsd-typography">
				<div class="lead">
					<p>The fundamental set of methods for communicating with a MongoDB Stitch
						application. Contains methods for executing Stitch functions and retrieving
						clients for Stitch services, and contains a <code>StitchAuth</code> object to manage
						the authentication state of the client. An implementation can be
					instantiated using the <code>Stitch</code> utility class.</p>
				</div>
			</div>
		</section>
		<section class="tsd-panel tsd-hierarchy">
			...
			<ul class="tsd-hierarchy">
				<li>
					<span class="target">StitchAppClient</span>
				</li>
			</ul>
		</section>
				...
				<div class="tsd-index-content">
					<section class="tsd-index-section tsd-is-external">
						...
						<ul class="tsd-index-list">
							<li class="tsd-kind-property tsd-parent-kind-interface tsd-is-external"><a href="stitchappclient.html#auth" class="tsd-kind-icon">auth</a></li>
						</ul>
					</section>
					<section class="tsd-index-section tsd-is-external">
						<h3>Methods</h3>
						<ul class="tsd-index-list">
							<li class="tsd-kind-method tsd-parent-kind-interface tsd-is-external"><a href="stitchappclient.html#callfunction" class="tsd-kind-icon">call<wbr>Function</a></li>
							<li class="tsd-kind-method tsd-parent-kind-interface tsd-is-external"><a href="stitchappclient.html#close" class="tsd-kind-icon">close</a></li>
							<li class="tsd-kind-method tsd-parent-kind-interface tsd-is-external"><a href="stitchappclient.html#getgeneralserviceclient" class="tsd-kind-icon">get<wbr>General<wbr>Service<wbr>Client</a></li>
							<li class="tsd-kind-method tsd-parent-kind-interface tsd-has-type-parameter tsd-is-external"><a href="stitchappclient.html#getserviceclient" class="tsd-kind-icon">get<wbr>Service<wbr>Client</a></li>
						</ul>
					</section>
				</div>
			</section>
		...
		<section class="tsd-panel-group tsd-member-group tsd-is-external">
			...
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface tsd-is-external">
				...
				<h3>auth</h3>
				<div class="tsd-signature tsd-kind-icon">auth<span class="tsd-signature-symbol">:</span> <a href="stitchauth.html" class="tsd-signature-type">StitchAuth</a></div>
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/mongodb/stitch-js-sdk/blob/131d8fe/packages/react-native/core/src/core/StitchAppClient.ts#L38">react-native/core/src/core/StitchAppClient.ts:38</a></li>
					</ul>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>The <a href="stitchauth.html">StitchAuth</a> object representing the authentication state of
						this client. Includes methods for logging in and logging out.</p>
					</div>
					<p>Authentication state can be persisted beyond the lifetime of a browser
						session. A StitchAppClient retrieved from the <code>Stitch</code> singleton may or
					may not be already authenticated when first initialized.</p>
				</div>
			</section>
		</section>
		<section class="tsd-panel-group tsd-member-group tsd-is-external">
			...
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-interface tsd-is-external">
				<a name="callfunction" class="tsd-anchor"></a>
				<h3>call<wbr>Function</h3>
				<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-interface tsd-is-external">
					<li class="tsd-signature tsd-kind-icon">call<wbr>Function<span class="tsd-signature-symbol">(</span>name<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span>, args<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">any</span><span class="tsd-signature-symbol">[]</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">Promise</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">any</span><span class="tsd-signature-symbol">&gt;</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/mongodb/stitch-js-sdk/blob/131d8fe/packages/react-native/core/src/core/StitchAppClient.ts#L76">react-native/core/src/core/StitchAppClient.ts:76</a></li>
							</ul>
						</aside>
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>Calls the MongoDB Stitch function with the provided name and arguments,
								and returns the result as decoded extended JSON.</p>
							</div>
						</div>
			...
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-interface tsd-is-external">
				...
				<h3>close</h3>
				<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-interface tsd-is-external">
					<li class="tsd-signature tsd-kind-icon">close<span class="tsd-signature-symbol">(</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">any</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/mongodb/stitch-js-sdk/blob/131d8fe/packages/react-native/core/src/core/StitchAppClient.ts#L82">react-native/core/src/core/StitchAppClient.ts:82</a></li>
							</ul>
						</aside>
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>Close stops any background processes maintained by the client. This
			...
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-interface tsd-is-external">
				<a name="getgeneralserviceclient" class="tsd-anchor"></a>
				<h3>get<wbr>General<wbr>Service<wbr>Client</h3>
				<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-interface tsd-is-external">
					<li class="tsd-signature tsd-kind-icon">get<wbr>General<wbr>Service<wbr>Client<span class="tsd-signature-symbol">(</span>serviceName<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><a href="stitchserviceclient.html" class="tsd-signature-type">StitchServiceClient</a></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/mongodb/stitch-js-sdk/blob/131d8fe/packages/react-native/core/src/core/StitchAppClient.ts#L67">react-native/core/src/core/StitchAppClient.ts:67</a></li>
							</ul>
						</aside>
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>Retrieves a general-purpose service client for the Stitch service
									associated with the specified name. Use this for services which do not
								have a well-defined interface in the SDK.</p>
							</div>
						</div>
						<h4 class="tsd-parameters-title">Parameters</h4>
						<ul class="tsd-parameters">
							<li>
								...
								<div class="tsd-comment tsd-typography">
									<p>The name of the desired service in MongoDB Stitch.</p>
								</div>
							</li>
						</ul>
						<h4 class="tsd-returns-title">Returns <a href="stitchserviceclient.html" class="tsd-signature-type">StitchServiceClient</a></h4>
					</li>
				</ul>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-interface tsd-has-type-parameter tsd-is-external">
				<a name="getserviceclient" class="tsd-anchor"></a>
				<h3>get<wbr>Service<wbr>Client</h3>
				<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-interface tsd-has-type-parameter tsd-is-external">
					<li class="tsd-signature tsd-kind-icon">get<wbr>Service<wbr>Client&lt;T&gt;<span class="tsd-signature-symbol">(</span>factory<span class="tsd-signature-symbol">: </span><a href="namedserviceclientfactory.html" class="tsd-signature-type">NamedServiceClientFactory</a><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">T</span><span class="tsd-signature-symbol">&gt;</span>, serviceName<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">T</span></li>
					<li class="tsd-signature tsd-kind-icon">get<wbr>Service<wbr>Client&lt;T&gt;<span class="tsd-signature-symbol">(</span>factory<span class="tsd-signature-symbol">: </span><a href="serviceclientfactory.html" class="tsd-signature-type">ServiceClientFactory</a><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">T</span><span class="tsd-signature-symbol">&gt;</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">T</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/mongodb/stitch-js-sdk/blob/131d8fe/packages/react-native/core/src/core/StitchAppClient.ts#L47">react-native/core/src/core/StitchAppClient.ts:47</a></li>
							</ul>
						</aside>
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>Retrieves the service client for the Stitch service associated with the
								specified name and factory.</p>
							</div>
						</div>
						...
						<ul class="tsd-parameters">
							<li>
								<h5>factory: <a href="namedserviceclientfactory.html" class="tsd-signature-type">NamedServiceClientFactory</a><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">T</span><span class="tsd-signature-symbol">&gt;</span></h5>
								<div class="tsd-comment tsd-typography">
									<p>The factory that produces the desired service client.</p>
								</div>
							</li>
							<li>
								<h5>serviceName: <span class="tsd-signature-type">string</span></h5>
					...
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/mongodb/stitch-js-sdk/blob/131d8fe/packages/react-native/core/src/core/StitchAppClient.ts#L58">react-native/core/src/core/StitchAppClient.ts:58</a></li>
							</ul>
						</aside>
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>Retrieves the service client for the Stitch service associated with the
								specificed factory.</p>
							</div>
						</div>
						<h4 class="tsd-type-parameters-title">Type parameters</h4>
						<ul class="tsd-type-parameters">
						...
						<ul class="tsd-parameters">
							<li>
								<h5>factory: <a href="serviceclientfactory.html" class="tsd-signature-type">ServiceClientFactory</a><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">T</span><span class="tsd-signature-symbol">&gt;</span></h5>
								<div class="tsd-comment tsd-typography">
									<p>The factory that produces the desired service client.</p>
								</div>
							</li>
