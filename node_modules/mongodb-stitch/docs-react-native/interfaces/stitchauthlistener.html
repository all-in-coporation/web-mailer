...
<head>
	...
	<title>StitchAuthListener | MongoDB Stitch React Native SDK</title>
...
<nav class="tsd-navigation secondary">
	<ul>
		<li class="current tsd-kind-interface tsd-is-external">
			<a href="stitchauthlistener.html" class="tsd-kind-icon">Stitch<wbr>Auth<wbr>Listener</a>
			<ul>
				<li class=" tsd-kind-method tsd-parent-kind-interface tsd-is-external">
					<a href="stitchauthlistener.html#onauthevent" class="tsd-kind-icon">on<wbr>Auth<wbr>Event</a>
				</li>
			</ul>
		</li>
	</ul>
	...
	<div class="content-wrap">
		<section class="tsd-panel tsd-comment">
			<div class="tsd-comment tsd-typography">
				<div class="lead">
					<p>An interface to be inherited by classes that need to take action whenever a
						particular <a href="stitchappclient.html">StitchAppClient</a> performs an authentication event. An
						instance of a <a href="stitchauthlistener.html">StitchAuthListener</a> must be registered with a
					<a href="stitchauth.html">StitchAuth</a> for this to work correctly.</p>
				</div>
			</div>
		</section>
		<section class="tsd-panel tsd-hierarchy">
			...
			<ul class="tsd-hierarchy">
				<li>
					<span class="target">StitchAuthListener</span>
				</li>
			</ul>
		</section>
				...
				<div class="tsd-index-content">
					<section class="tsd-index-section tsd-is-external">
						...
						<ul class="tsd-index-list">
							<li class="tsd-kind-method tsd-parent-kind-interface tsd-is-external"><a href="stitchauthlistener.html#onauthevent" class="tsd-kind-icon">on<wbr>Auth<wbr>Event</a></li>
						</ul>
					</section>
				</div>
			</section>
		...
		<section class="tsd-panel-group tsd-member-group tsd-is-external">
			...
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-interface tsd-is-external">
				<a name="onauthevent" class="tsd-anchor"></a>
				<h3>on<wbr>Auth<wbr>Event</h3>
				<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-interface tsd-is-external">
					<li class="tsd-signature tsd-kind-icon">on<wbr>Auth<wbr>Event<span class="tsd-signature-symbol">(</span>auth<span class="tsd-signature-symbol">: </span><a href="stitchauth.html" class="tsd-signature-type">StitchAuth</a><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">any</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/mongodb/stitch-js-sdk/blob/131d8fe/packages/react-native/core/src/core/auth/StitchAuthListener.ts#L35">react-native/core/src/core/auth/StitchAuthListener.ts:35</a></li>
							</ul>
						</aside>
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>onAuthEvent is called any time a notable event regarding authentication happens. These events are:</p>
								<ul>
									<li>When a user logs in.</li>
									<li>When a user logs out.</li>
									<li>When a user is linked to another identity.</li>
									<li>When a listener is registered. This is to handle the case where during registration an event happens that the registerer would otherwise miss out on.</li>
								</ul>
							</div>
						</div>
						...
						<ul class="tsd-parameters">
							<li>
								<h5>auth: <a href="stitchauth.html" class="tsd-signature-type">StitchAuth</a></h5>
								<div class="tsd-comment tsd-typography">
									<p>The instance of StitchAuth where the event happened. It should be used to infer the current state of authentication.</p>
								</div>
							</li>
						</ul>
