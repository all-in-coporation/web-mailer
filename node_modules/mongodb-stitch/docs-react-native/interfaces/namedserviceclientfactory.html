...
<head>
	...
	<title>NamedServiceClientFactory | MongoDB Stitch React Native SDK</title>
...
<nav class="tsd-navigation secondary">
	<ul>
		<li class="current tsd-kind-interface tsd-has-type-parameter tsd-is-external">
			<a href="namedserviceclientfactory.html" class="tsd-kind-icon">Named<wbr>Service<wbr>Client<wbr>Factory</a>
			<ul>
				<li class=" tsd-kind-method tsd-parent-kind-interface tsd-is-external">
					<a href="namedserviceclientfactory.html#getnamedclient" class="tsd-kind-icon">get<wbr>Named<wbr>Client</a>
				</li>
			</ul>
		</li>
	</ul>
	...
	<div class="content-wrap">
		<section class="tsd-panel tsd-comment">
			<div class="tsd-comment tsd-typography">
				<div class="lead">
					<p>An interface describing a class that can provide clients for a particular
					named Stitch service.</p>
				</div>
			</div>
		</section>
		...
		<section class="tsd-panel tsd-hierarchy">
			...
			<ul class="tsd-hierarchy">
				<li>
					<span class="target">NamedServiceClientFactory</span>
				</li>
			</ul>
		</section>
				...
				<div class="tsd-index-content">
					<section class="tsd-index-section tsd-is-external">
						...
						<ul class="tsd-index-list">
							<li class="tsd-kind-method tsd-parent-kind-interface tsd-is-external"><a href="namedserviceclientfactory.html#getnamedclient" class="tsd-kind-icon">get<wbr>Named<wbr>Client</a></li>
						</ul>
					</section>
				</div>
			</section>
		...
		<section class="tsd-panel-group tsd-member-group tsd-is-external">
			...
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-interface tsd-is-external">
				<a name="getnamedclient" class="tsd-anchor"></a>
				<h3>get<wbr>Named<wbr>Client</h3>
				<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-interface tsd-is-external">
					<li class="tsd-signature tsd-kind-icon">get<wbr>Named<wbr>Client<span class="tsd-signature-symbol">(</span>service<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">CoreStitchServiceClient</span>, client<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">StitchAppClientInfo</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">T</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/mongodb/stitch-js-sdk/blob/131d8fe/packages/react-native/core/src/services/internal/NamedServiceClientFactory.ts#L27">react-native/core/src/services/internal/NamedServiceClientFactory.ts:27</a></li>
							</ul>
						</aside>
						...
						<ul class="tsd-parameters">
							...
							<li>
								<h5>client: <span class="tsd-signature-type">StitchAppClientInfo</span></h5>
							</li>
						</ul>
